...
{
    event_token token {};
    check_hresult(shim()->add_SourceAdded(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_SourceAdded(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_SourceRemoved(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_SourceRemoved(token));
}
...
template <typename D> Windows::Devices::Perception::PerceptionColorFrameSource impl_IPerceptionColorFrameSourceAddedEventArgs<D>::FrameSource() const
{
    ...
    check_hresult(shim()->get_FrameSource(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_PhysicalDeviceIds(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_DeviceModelVersion(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_SupportedVideoProfiles(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_AvailableVideoProfiles(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_IsMirrored(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_AutoExposureEnabled(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_ActiveIlluminationEnabled(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_AmbientSubtractionEnabled(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_StructureLightPatternEnabled(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_InterleavedIlluminationEnabled(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_MinDepth(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_MaxDepth(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_BitmapPixelFormat(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_BitmapAlphaMode(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_Width(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_FrameDuration(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_FocalLength(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_PrincipalPoint(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_RadialDistortion(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_TangentialDistortion(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_Key(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::Devices::Perception::PerceptionInfraredFrameSource>> impl_IPerceptionInfraredFrameSourceStatics<D>::FindAllAsync() const
{
    ...
    check_hresult(shim()->abi_FindAllAsync(put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Devices::Perception::PerceptionInfraredFrameSource> impl_IPerceptionInfraredFrameSourceStatics<D>::FromIdAsync(hstring_ref id) const
{
    ...
    check_hresult(shim()->abi_FromIdAsync(get(id), put(result)));
    return result;
}
...
{
    event_token token {};
    check_hresult(shim()->add_AvailableChanged(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_AvailableChanged(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_ActiveChanged(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_ActiveChanged(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_PropertiesChanged(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_PropertiesChanged(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_VideoProfileChanged(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_VideoProfileChanged(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_CameraIntrinsicsChanged(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_CameraIntrinsicsChanged(token));
}
...
{
    bool value {};
    check_hresult(shim()->get_Active(&value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_IsControlled(&value));
    return value;
}
...
template <typename D> Windows::Devices::Perception::PerceptionControlSession impl_IPerceptionColorFrameSource<D>::AcquireControlSession() const
{
    ...
    check_hresult(shim()->abi_AcquireControlSession(put(value)));
    return value;
}
...
{
    bool result {};
    check_hresult(shim()->abi_CanControlIndependentlyFrom(get(targetId), &result));
    return result;
}
...
{
    bool result {};
    check_hresult(shim()->abi_IsCorrelatedWith(get(targetId), &result));
    return result;
}
...
{
    bool hasResult {};
    check_hresult(shim()->abi_TryGetTransformTo(get(targetId), put(result), &hasResult));
    return hasResult;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Devices::Perception::PerceptionDepthCorrelatedCameraIntrinsics> impl_IPerceptionColorFrameSource<D>::TryGetDepthCorrelatedCameraIntrinsicsAsync(const Windows::Devices::Perception::PerceptionDepthFrameSource & correlatedDepthFrameSource) const
{
    ...
    check_hresult(shim()->abi_TryGetDepthCorrelatedCameraIntrinsicsAsync(get(correlatedDepthFrameSource), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Devices::Perception::PerceptionDepthCorrelatedCoordinateMapper> impl_IPerceptionColorFrameSource<D>::TryGetDepthCorrelatedCoordinateMapperAsync(hstring_ref targetSourceId, const Windows::Devices::Perception::PerceptionDepthFrameSource & correlatedDepthFrameSource) const
{
    ...
    check_hresult(shim()->abi_TryGetDepthCorrelatedCoordinateMapperAsync(get(targetSourceId), get(correlatedDepthFrameSource), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Devices::Perception::PerceptionFrameSourcePropertyChangeResult> impl_IPerceptionColorFrameSource<D>::TrySetVideoProfileAsync(const Windows::Devices::Perception::PerceptionControlSession & controlSession, const Windows::Devices::Perception::PerceptionVideoProfile & profile) const
{
    ...
    check_hresult(shim()->abi_TrySetVideoProfileAsync(get(controlSession), get(profile), put(result)));
    return result;
}
...
template <typename D> Windows::Devices::Perception::PerceptionColorFrameReader impl_IPerceptionColorFrameSource<D>::OpenReader() const
{
    ...
    check_hresult(shim()->abi_OpenReader(put(result)));
    return result;
}
...
template <typename D> Windows::Devices::Perception::PerceptionControlSession impl_IPerceptionDepthFrameSource<D>::AcquireControlSession() const
{
    ...
    check_hresult(shim()->abi_AcquireControlSession(put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Devices::Perception::PerceptionDepthCorrelatedCameraIntrinsics> result;
    check_hresult(shim()->abi_TryGetDepthCorrelatedCameraIntrinsicsAsync(get(target), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Devices::Perception::PerceptionDepthCorrelatedCoordinateMapper> result;
    check_hresult(shim()->abi_TryGetDepthCorrelatedCoordinateMapperAsync(get(targetId), get(depthFrameSourceToMapWith), put(result)));
    return result;
}
...
{
    bool result {};
    check_hresult(shim()->abi_IsEqual(get(other), &result));
    return result;
}
...
template <typename D> Windows::Devices::Perception::PerceptionColorFrame impl_IPerceptionColorFrameArrivedEventArgs<D>::TryOpenFrame() const
{
    ...
    check_hresult(shim()->abi_TryOpenFrame(put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::Numerics::float3 impl_IPerceptionDepthCorrelatedCameraIntrinsics<D>::UnprojectPixelAtCorrelatedDepth(const Windows::Foundation::Point & pixelCoordinate, const Windows::Devices::Perception::PerceptionDepthFrame & depthFrame) const
{
    ...
    check_hresult(shim()->abi_UnprojectPixelAtCorrelatedDepth(get(pixelCoordinate), get(depthFrame), put(result)));
    return result;
}
...
{
    check_hresult(shim()->abi_UnprojectPixelsAtCorrelatedDepth(sourceCoordinates.size(), get(sourceCoordinates), get(depthFrame), results.size(), get(results)));
}
...
template <typename D> Windows::Foundation::IAsyncAction impl_IPerceptionDepthCorrelatedCameraIntrinsics<D>::UnprojectRegionPixelsAtCorrelatedDepthAsync(const Windows::Foundation::Rect & region, const Windows::Devices::Perception::PerceptionDepthFrame & depthFrame, array_ref<Windows::Foundation::Numerics::float3> results) const
{
    ...
    check_hresult(shim()->abi_UnprojectRegionPixelsAtCorrelatedDepthAsync(get(region), get(depthFrame), results.size(), get(results), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncAction result;
    check_hresult(shim()->abi_UnprojectAllPixelsAtCorrelatedDepthAsync(get(depthFrame), results.size(), get(results), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::Point impl_IPerceptionDepthCorrelatedCoordinateMapper<D>::MapPixelToTarget(const Windows::Foundation::Point & sourcePixelCoordinate, const Windows::Devices::Perception::PerceptionDepthFrame & depthFrame) const
{
    ...
    check_hresult(shim()->abi_MapPixelToTarget(get(sourcePixelCoordinate), get(depthFrame), put(result)));
    return result;
}
...
{
    check_hresult(shim()->abi_MapPixelsToTarget(sourceCoordinates.size(), get(sourceCoordinates), get(depthFrame), results.size(), get(results)));
}
...
{
    Windows::Foundation::IAsyncAction result;
    check_hresult(shim()->abi_MapRegionOfPixelsToTargetAsync(get(region), get(depthFrame), targetCoordinates.size(), get(targetCoordinates), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncAction result;
    check_hresult(shim()->abi_MapAllPixelsToTargetAsync(get(depthFrame), targetCoordinates.size(), get(targetCoordinates), put(result)));
    return result;
}
...
{
    event_token token {};
    check_hresult(shim()->add_ControlLost(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_ControlLost(token));
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Devices::Perception::PerceptionFrameSourcePropertyChangeResult> result;
    check_hresult(shim()->abi_TrySetPropertyAsync(get(name), get(value), put(result)));
    return result;
}
...
{
    Windows::Devices::Perception::PerceptionColorFrame result { nullptr };
    check_hresult(shim()->abi_TryReadLatestFrame(put(result)));
    return result;
}
...
template <typename D> Windows::Media::VideoFrame impl_IPerceptionColorFrame<D>::VideoFrame() const
{
    ...
    check_hresult(shim()->get_VideoFrame(put(value)));
    return value;
}
