...
struct __declspec(uuid("555ffbd3-45b7-49f3-bbd7-302db6084646")) __declspec(novtable) IDialApp : Windows::IInspectable
{
...
struct __declspec(uuid("ddc4a4a1-f5de-400d-bea4-8c8466bb2961")) __declspec(novtable) IDialAppStateDetails : Windows::IInspectable
{
...
struct __declspec(uuid("fff0edaf-759f-41d2-a20a-7f29ce0b3784")) __declspec(novtable) IDialDevice : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Id(hstring * value) = 0;
    virtual HRESULT __stdcall abi_GetDialApp(hstring appName, Windows::Media::DialProtocol::IDialApp ** value) = 0;
};

struct __declspec(uuid("bab7f3d5-5bfb-4eba-8b32-b57c5c5ee5c9")) __declspec(novtable) IDialDevice2 : Windows::IInspectable
{
...
struct __declspec(uuid("ba7e520a-ff59-4f4b-bdac-d89f495ad6e1")) __declspec(novtable) IDialDevicePicker : Windows::IInspectable
{
    ...
    virtual HRESULT __stdcall add_DialDevicePickerDismissed(Windows::Foundation::TypedEventHandler<Windows::Media::DialProtocol::DialDevicePicker, Windows::IInspectable> * handler, event_token * token) = 0;
...
struct __declspec(uuid("c17c93ba-86c0-485d-b8d6-0f9a8f641590")) __declspec(novtable) IDialDevicePickerFilter : Windows::IInspectable
{
    virtual HRESULT __stdcall get_SupportedAppNames(Windows::Foundation::Collections::IVector<hstring> ** value) = 0;
};

struct __declspec(uuid("480b92ad-ac76-47eb-9c06-a19304da0247")) __declspec(novtable) IDialDeviceSelectedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_SelectedDialDevice(Windows::Media::DialProtocol::IDialDevice ** value) = 0;
};

struct __declspec(uuid("aa69cc95-01f8-4758-8461-2bbd1cdc3cf3")) __declspec(novtable) IDialDeviceStatics : Windows::IInspectable
{
...
struct __declspec(uuid("52765152-9c81-4e55-adc2-0ebe99cde3b6")) __declspec(novtable) IDialDisconnectButtonClickedEventArgs : Windows::IInspectable
{
