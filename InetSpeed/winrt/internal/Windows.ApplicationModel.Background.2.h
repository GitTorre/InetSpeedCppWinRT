...
template <typename D>
class WINRT_EBO impl_IAlarmApplicationManagerStatics
{
    auto shim() const { return impl::shim<D, IAlarmApplicationManagerStatics>(this); }
...
template <typename D>
class WINRT_EBO impl_IPhoneTrigger
{
    auto shim() const { return impl::shim<D, IPhoneTrigger>(this); }
...
template <typename D>
class WINRT_EBO impl_IPhoneTriggerFactory
{
    auto shim() const { return impl::shim<D, IPhoneTriggerFactory>(this); }
