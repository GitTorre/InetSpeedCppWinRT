...
{
    virtual HRESULT __stdcall abi_Invoke(Windows::IInspectable * sender, Windows::UI::Xaml::Media::Imaging::IDownloadProgressEventArgs * e) = 0;
};

struct __declspec(uuid("31af3271-e3b4-442d-a341-4c0226b2725b")) __declspec(novtable) IBitmapImage : Windows::IInspectable
{
...
struct __declspec(uuid("1069c1b6-8c9b-4762-be3d-759f5698f2b3")) __declspec(novtable) IBitmapImage2 : Windows::IInspectable
{
...
struct __declspec(uuid("f1de6f26-3c73-453f-a7ba-9b85c18b3733")) __declspec(novtable) IBitmapImage3 : Windows::IInspectable
{
...
struct __declspec(uuid("c9132978-4810-4e5e-8087-03671ee60d85")) __declspec(novtable) IBitmapImageFactory : Windows::IInspectable
{
...
struct __declspec(uuid("9e282143-70e8-437c-9fa4-2cbf295cff84")) __declspec(novtable) IBitmapImageStatics : Windows::IInspectable
{
...
struct __declspec(uuid("c5f5576a-75af-41a4-b893-8fe91fee2882")) __declspec(novtable) IBitmapImageStatics2 : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DecodePixelTypeProperty(Windows::UI::Xaml::IDependencyProperty ** value) = 0;
};

struct __declspec(uuid("2b44e30d-f6d5-4411-a8cd-bf7603c4faa0")) __declspec(novtable) IBitmapImageStatics3 : Windows::IInspectable
{
...
struct __declspec(uuid("23d86411-202f-41b2-8c5b-a8a3b333800b")) __declspec(novtable) IBitmapSource : Windows::IInspectable
{
...
struct __declspec(uuid("e240420e-d4a7-49a4-a0b4-a59fdd77e508")) __declspec(novtable) IBitmapSourceFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstance(Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Media::Imaging::IBitmapSource ** instance) = 0;
};

struct __declspec(uuid("9a9c9981-827b-4e51-891b-8a15b511842d")) __declspec(novtable) IBitmapSourceStatics : Windows::IInspectable
{
...
struct __declspec(uuid("7311e0d4-fe94-4e70-9b90-cdd47ac23afb")) __declspec(novtable) IDownloadProgressEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Progress(int32_t * value) = 0;
    virtual HRESULT __stdcall put_Progress(int32_t value) = 0;
};

struct __declspec(uuid("500dee81-893c-4c0a-8fec-4678ac717589")) __declspec(novtable) IRenderTargetBitmap : Windows::IInspectable
{
    virtual HRESULT __stdcall get_PixelWidth(int32_t * value) = 0;
    virtual HRESULT __stdcall get_PixelHeight(int32_t * value) = 0;
...
struct __declspec(uuid("f0a1efee-c131-4d40-9c47-f7d7cf2b077f")) __declspec(novtable) IRenderTargetBitmapStatics : Windows::IInspectable
{
    virtual HRESULT __stdcall get_PixelWidthProperty(Windows::UI::Xaml::IDependencyProperty ** value) = 0;
    virtual HRESULT __stdcall get_PixelHeightProperty(Windows::UI::Xaml::IDependencyProperty ** value) = 0;
};

struct __declspec(uuid("d2dd9ed0-d3c5-4056-91b5-b7c1d1e8130e")) __declspec(novtable) ISoftwareBitmapSource : Windows::IInspectable
{
...
struct __declspec(uuid("62f7d416-c714-4c4c-8273-f839bc58135c")) __declspec(novtable) ISurfaceImageSource : Windows::IInspectable
{
};

struct __declspec(uuid("3ab2212a-ef65-4a5f-bfac-73993e8c12c9")) __declspec(novtable) ISurfaceImageSourceFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithDimensions(int32_t pixelWidth, int32_t pixelHeight, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Media::Imaging::ISurfaceImageSource ** instance) = 0;
    virtual HRESULT __stdcall abi_CreateInstanceWithDimensionsAndOpacity(int32_t pixelWidth, int32_t pixelHeight, bool isOpaque, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Media::Imaging::ISurfaceImageSource ** instance) = 0;
};

struct __declspec(uuid("4a711fea-bfac-11e0-a06a-9de44724019b")) __declspec(novtable) IVirtualSurfaceImageSource : Windows::IInspectable
{
};

struct __declspec(uuid("3ab2212a-bfac-11e0-8a92-69e44724019b")) __declspec(novtable) IVirtualSurfaceImageSourceFactory : Windows::IInspectable
{
...
struct __declspec(uuid("bf0b7e6f-df7c-4a85-8413-a1216285835c")) __declspec(novtable) IWriteableBitmap : Windows::IInspectable
{
...
struct __declspec(uuid("5563ebb1-3ef2-42c5-9c6d-1cf5dcc041ff")) __declspec(novtable) IWriteableBitmapFactory : Windows::IInspectable
{
...
struct __declspec(uuid("5d5fe9aa-533e-44b8-a975-fc5f1e3bff52")) __declspec(novtable) IXamlRenderingBackgroundTask : Windows::IInspectable
{
};

struct __declspec(uuid("a3d1bb63-38f8-4da3-9fca-fd8128a2cbf9")) __declspec(novtable) IXamlRenderingBackgroundTaskFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstance(Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Media::Imaging::IXamlRenderingBackgroundTask ** instance) = 0;
};

struct __declspec(uuid("9c2a6997-a908-4711-b4b2-a960db3d8e5a")) __declspec(novtable) IXamlRenderingBackgroundTaskOverrides : Windows::IInspectable
{
