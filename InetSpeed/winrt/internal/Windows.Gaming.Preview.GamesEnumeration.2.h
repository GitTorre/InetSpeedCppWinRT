...
template <typename D>
class WINRT_EBO impl_IGameListEntry
{
    auto shim() const { return impl::shim<D, IGameListEntry>(this); }
...
template <typename D>
class WINRT_EBO impl_IGameListStatics
{
    auto shim() const { return impl::shim<D, IGameListStatics>(this); }
