...
template <typename T> class impl_IAlarmApplicationManagerStatics;
...
template <typename T> class impl_IPhoneTrigger;
template <typename T> class impl_IPhoneTriggerFactory;
