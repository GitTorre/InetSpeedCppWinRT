...
template <typename T> class impl_IHotspotAuthenticationContext;
template <typename T> class impl_IHotspotAuthenticationContext2;
template <typename T> class impl_IHotspotAuthenticationContextStatics;
template <typename T> class impl_IHotspotAuthenticationEventDetails;
template <typename T> class impl_IHotspotCredentialsAuthenticationResult;
template <typename T> class impl_IKnownCSimFilePathsStatics;
template <typename T> class impl_IKnownRuimFilePathsStatics;
template <typename T> class impl_IKnownSimFilePathsStatics;
template <typename T> class impl_IKnownUSimFilePathsStatics;
template <typename T> class impl_IMobileBroadbandAccount;
template <typename T> class impl_IMobileBroadbandAccount2;
template <typename T> class impl_IMobileBroadbandAccountEventArgs;
template <typename T> class impl_IMobileBroadbandAccountStatics;
template <typename T> class impl_IMobileBroadbandAccountUpdatedEventArgs;
template <typename T> class impl_IMobileBroadbandAccountWatcher;
template <typename T> class impl_IMobileBroadbandDeviceInformation;
template <typename T> class impl_IMobileBroadbandDeviceInformation2;
template <typename T> class impl_IMobileBroadbandDeviceService;
template <typename T> class impl_IMobileBroadbandDeviceServiceCommandResult;
template <typename T> class impl_IMobileBroadbandDeviceServiceCommandSession;
template <typename T> class impl_IMobileBroadbandDeviceServiceDataReceivedEventArgs;
template <typename T> class impl_IMobileBroadbandDeviceServiceDataSession;
template <typename T> class impl_IMobileBroadbandDeviceServiceInformation;
template <typename T> class impl_IMobileBroadbandDeviceServiceTriggerDetails;
template <typename T> class impl_IMobileBroadbandModem;
template <typename T> class impl_IMobileBroadbandModemConfiguration;
template <typename T> class impl_IMobileBroadbandModemStatics;
template <typename T> class impl_IMobileBroadbandNetwork;
template <typename T> class impl_IMobileBroadbandNetwork2;
template <typename T> class impl_IMobileBroadbandNetworkRegistrationStateChange;
template <typename T> class impl_IMobileBroadbandNetworkRegistrationStateChangeTriggerDetails;
template <typename T> class impl_IMobileBroadbandPin;
template <typename T> class impl_IMobileBroadbandPinLockStateChange;
template <typename T> class impl_IMobileBroadbandPinLockStateChangeTriggerDetails;
template <typename T> class impl_IMobileBroadbandPinManager;
template <typename T> class impl_IMobileBroadbandPinOperationResult;
template <typename T> class impl_IMobileBroadbandRadioStateChange;
template <typename T> class impl_IMobileBroadbandRadioStateChangeTriggerDetails;
template <typename T> class impl_IMobileBroadbandUicc;
template <typename T> class impl_IMobileBroadbandUiccApp;
template <typename T> class impl_IMobileBroadbandUiccAppReadRecordResult;
template <typename T> class impl_IMobileBroadbandUiccAppRecordDetailsResult;
template <typename T> class impl_IMobileBroadbandUiccAppsResult;
template <typename T> class impl_INetworkOperatorNotificationEventDetails;
template <typename T> class impl_INetworkOperatorTetheringAccessPointConfiguration;
template <typename T> class impl_INetworkOperatorTetheringClient;
template <typename T> class impl_INetworkOperatorTetheringClientManager;
template <typename T> class impl_INetworkOperatorTetheringEntitlementCheck;
template <typename T> class impl_INetworkOperatorTetheringManager;
template <typename T> class impl_INetworkOperatorTetheringManagerStatics;
template <typename T> class impl_INetworkOperatorTetheringManagerStatics2;
template <typename T> class impl_INetworkOperatorTetheringManagerStatics3;
template <typename T> class impl_INetworkOperatorTetheringOperationResult;
template <typename T> class impl_IProvisionFromXmlDocumentResults;
template <typename T> class impl_IProvisionedProfile;
template <typename T> class impl_IProvisioningAgent;
template <typename T> class impl_IProvisioningAgentStaticMethods;
template <typename T> class impl_IUssdMessage;
template <typename T> class impl_IUssdMessageFactory;
template <typename T> class impl_IUssdReply;
template <typename T> class impl_IUssdSession;
template <typename T> class impl_IUssdSessionStatics;
...
template <> struct traits<Windows::Networking::NetworkOperators::NetworkOperatorNotificationEventDetails>
{
    ...
    using default_interface = Windows::Networking::NetworkOperators::INetworkOperatorNotificationEventDetails;
