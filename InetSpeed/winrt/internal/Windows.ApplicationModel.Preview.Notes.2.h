...
template <typename D>
class WINRT_EBO impl_INotePlacementChangedPreviewEventArgs
{
    auto shim() const { return impl::shim<D, INotePlacementChangedPreviewEventArgs>(this); }
...
template <typename D>
class WINRT_EBO impl_INoteVisibilityChangedPreviewEventArgs
{
    auto shim() const { return impl::shim<D, INoteVisibilityChangedPreviewEventArgs>(this); }
...
template <typename D>
class WINRT_EBO impl_INotesWindowManagerPreview
{
    auto shim() const { return impl::shim<D, INotesWindowManagerPreview>(this); }
...
template <typename D>
class WINRT_EBO impl_INotesWindowManagerPreviewStatics
{
    auto shim() const { return impl::shim<D, INotesWindowManagerPreviewStatics>(this); }
