...
template <typename T> class impl_ICrossSlidingEventArgs;
template <typename T> class impl_IDraggingEventArgs;
template <typename T> class impl_IEdgeGesture;
template <typename T> class impl_IEdgeGestureEventArgs;
template <typename T> class impl_IEdgeGestureStatics;
template <typename T> class impl_IGestureRecognizer;
template <typename T> class impl_IHoldingEventArgs;
template <typename T> class impl_IKeyboardDeliveryInterceptor;
template <typename T> class impl_IKeyboardDeliveryInterceptorStatics;
template <typename T> class impl_IManipulationCompletedEventArgs;
template <typename T> class impl_IManipulationInertiaStartingEventArgs;
template <typename T> class impl_IManipulationStartedEventArgs;
template <typename T> class impl_IManipulationUpdatedEventArgs;
template <typename T> class impl_IMouseWheelParameters;
template <typename T> class impl_IPointerPoint;
template <typename T> class impl_IPointerPointProperties;
template <typename T> class impl_IPointerPointProperties2;
template <typename T> class impl_IPointerPointStatics;
template <typename T> class impl_IPointerPointTransform;
template <typename T> class impl_IPointerVisualizationSettings;
template <typename T> class impl_IPointerVisualizationSettingsStatics;
template <typename T> class impl_IRadialController;
template <typename T> class impl_IRadialControllerButtonClickedEventArgs;
template <typename T> class impl_IRadialControllerConfiguration;
template <typename T> class impl_IRadialControllerConfigurationStatics;
template <typename T> class impl_IRadialControllerControlAcquiredEventArgs;
template <typename T> class impl_IRadialControllerMenu;
template <typename T> class impl_IRadialControllerMenuItem;
template <typename T> class impl_IRadialControllerMenuItemStatics;
template <typename T> class impl_IRadialControllerRotationChangedEventArgs;
template <typename T> class impl_IRadialControllerScreenContact;
template <typename T> class impl_IRadialControllerScreenContactContinuedEventArgs;
template <typename T> class impl_IRadialControllerScreenContactStartedEventArgs;
template <typename T> class impl_IRadialControllerStatics;
template <typename T> class impl_IRightTappedEventArgs;
template <typename T> class impl_ITappedEventArgs;
