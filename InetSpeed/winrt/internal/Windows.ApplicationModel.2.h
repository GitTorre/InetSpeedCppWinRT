...
template <typename D>
class WINRT_EBO impl_IFullTrustProcessLauncherStatics
{
    auto shim() const { return impl::shim<D, IFullTrustProcessLauncherStatics>(this); }
...
template <typename D>
class WINRT_EBO impl_IStartupTask
{
    auto shim() const { return impl::shim<D, IStartupTask>(this); }
...
template <typename D>
class WINRT_EBO impl_IStartupTaskStatics
{
    auto shim() const { return impl::shim<D, IStartupTaskStatics>(this); }
