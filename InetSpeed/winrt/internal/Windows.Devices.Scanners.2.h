...
template <typename D>
class WINRT_EBO impl_IImageScanner
{
    auto shim() const { return impl::shim<D, IImageScanner>(this); }
...
template <typename D>
class WINRT_EBO impl_IImageScannerFeederConfiguration
{
    auto shim() const { return impl::shim<D, IImageScannerFeederConfiguration>(this); }
...
template <typename D>
class WINRT_EBO impl_IImageScannerFormatConfiguration
{
    auto shim() const { return impl::shim<D, IImageScannerFormatConfiguration>(this); }
...
template <typename D>
class WINRT_EBO impl_IImageScannerPreviewResult
{
    auto shim() const { return impl::shim<D, IImageScannerPreviewResult>(this); }
...
template <typename D>
class WINRT_EBO impl_IImageScannerScanResult
{
    auto shim() const { return impl::shim<D, IImageScannerScanResult>(this); }
...
template <typename D>
class WINRT_EBO impl_IImageScannerSourceConfiguration
{
    auto shim() const { return impl::shim<D, IImageScannerSourceConfiguration>(this); }
...
template <typename D>
class WINRT_EBO impl_IImageScannerStatics
{
    auto shim() const { return impl::shim<D, IImageScannerStatics>(this); }
