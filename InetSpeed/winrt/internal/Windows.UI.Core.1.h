...
template <typename T> class impl_ICoreWindowDialog;
template <typename T> class impl_ICoreWindowDialogFactory;
template <typename T> class impl_ICoreWindowEventArgs;
template <typename T> class impl_ICoreWindowFlyout;
template <typename T> class impl_ICoreWindowFlyoutFactory;
template <typename T> class impl_ICoreWindowPopupShowingEventArgs;
