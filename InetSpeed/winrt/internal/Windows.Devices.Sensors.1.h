...
struct __declspec(uuid("df184548-2711-4da7-8098-4b82205d3c7d")) __declspec(novtable) IAccelerometer : Windows::IInspectable
{
...
struct __declspec(uuid("e8f092ee-4964-401a-b602-220d7153c60a")) __declspec(novtable) IAccelerometer2 : Windows::IInspectable
{
...
struct __declspec(uuid("87e0022a-ed80-49eb-bf8a-a4ea31e5cd84")) __declspec(novtable) IAccelerometer3 : Windows::IInspectable
{
...
struct __declspec(uuid("1d373c4f-42d3-45b2-8144-ab7fb665eb59")) __declspec(novtable) IAccelerometer4 : Windows::IInspectable
{
    virtual HRESULT __stdcall get_ReadingType(winrt::Windows::Devices::Sensors::AccelerometerReadingType * type) = 0;
};

struct __declspec(uuid("7eac64a9-97d5-446d-ab5a-917df9b96a2c")) __declspec(novtable) IAccelerometerDeviceId : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(hstring * value) = 0;
};

struct __declspec(uuid("b9fe7acb-d351-40af-8bb6-7aa9ae641fb7")) __declspec(novtable) IAccelerometerReading : Windows::IInspectable
{
...
struct __declspec(uuid("0095c65b-b6ac-475a-9f44-8b32d35a3f25")) __declspec(novtable) IAccelerometerReadingChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::IAccelerometerReading ** value) = 0;
};

struct __declspec(uuid("95ff01d1-4a28-4f35-98e8-8178aae4084a")) __declspec(novtable) IAccelerometerShakenEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
};

struct __declspec(uuid("a5e28b74-5a87-4a2d-becc-0f906ea061dd")) __declspec(novtable) IAccelerometerStatics : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetDefault(Windows::Devices::Sensors::IAccelerometer ** result) = 0;
};

struct __declspec(uuid("c4c4842f-d86b-4685-b2d7-3396f798d57b")) __declspec(novtable) IAccelerometerStatics2 : Windows::IInspectable
{
...
struct __declspec(uuid("cd7a630c-fb5f-48eb-b09b-a2708d1c61ef")) __declspec(novtable) IActivitySensor : Windows::IInspectable
{
...
struct __declspec(uuid("85125a96-1472-40a2-b2ae-e1ef29226c78")) __declspec(novtable) IActivitySensorReading : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
...
struct __declspec(uuid("4f3c2915-d93b-47bd-960a-f20fb2f322b9")) __declspec(novtable) IActivitySensorReadingChangeReport : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::IActivitySensorReading ** value) = 0;
};

struct __declspec(uuid("de386717-aeb6-4ec7-946a-d9cc19b951ec")) __declspec(novtable) IActivitySensorReadingChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::IActivitySensorReading ** value) = 0;
};

struct __declspec(uuid("a71e0e9d-ee8b-45d1-b25b-08cc0df92ab6")) __declspec(novtable) IActivitySensorStatics : Windows::IInspectable
{
...
struct __declspec(uuid("2c9e6612-b9ca-4677-b263-243297f79d3a")) __declspec(novtable) IActivitySensorTriggerDetails : Windows::IInspectable
{
...
struct __declspec(uuid("72f057fd-8f04-49f1-b4a7-f4e363b701a2")) __declspec(novtable) IAltimeter : Windows::IInspectable
{
...
struct __declspec(uuid("fbe8ef73-7f5e-48c8-aa1a-f1f3befc1144")) __declspec(novtable) IAltimeterReading : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
    virtual HRESULT __stdcall get_AltitudeChangeInMeters(double * value) = 0;
};

struct __declspec(uuid("7069d077-446d-47f7-998c-ebc23b45e4a2")) __declspec(novtable) IAltimeterReadingChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::IAltimeterReading ** value) = 0;
};

struct __declspec(uuid("9eb4d7c3-e5ac-47ce-8eef-d3718168c01f")) __declspec(novtable) IAltimeterStatics : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetDefault(Windows::Devices::Sensors::IAltimeter ** result) = 0;
};

struct __declspec(uuid("934475a8-78bf-452f-b017-f0209ce6dab4")) __declspec(novtable) IBarometer : Windows::IInspectable
{
...
struct __declspec(uuid("f5b9d2e6-1df6-4a1a-a7ad-321d4f5db247")) __declspec(novtable) IBarometerReading : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
    virtual HRESULT __stdcall get_StationPressureInHectopascals(double * value) = 0;
};

struct __declspec(uuid("3d84945f-037b-404f-9bbb-6232d69543c3")) __declspec(novtable) IBarometerReadingChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::IBarometerReading ** value) = 0;
};

struct __declspec(uuid("286b270a-02e3-4f86-84fc-fdd892b5940f")) __declspec(novtable) IBarometerStatics : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetDefault(Windows::Devices::Sensors::IBarometer ** result) = 0;
};

struct __declspec(uuid("292ffa94-1b45-403c-ba06-b106dba69a64")) __declspec(novtable) ICompass : Windows::IInspectable
{
...
struct __declspec(uuid("36f26d09-c7d7-434f-b461-979ddfc2322f")) __declspec(novtable) ICompass2 : Windows::IInspectable
{
    virtual HRESULT __stdcall put_ReadingTransform(winrt::Windows::Graphics::Display::DisplayOrientations value) = 0;
    virtual HRESULT __stdcall get_ReadingTransform(winrt::Windows::Graphics::Display::DisplayOrientations * value) = 0;
};

struct __declspec(uuid("d181ca29-b085-4b1d-870a-4ff57ba74fd4")) __declspec(novtable) ICompassDeviceId : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(hstring * value) = 0;
};

struct __declspec(uuid("82911128-513d-4dc9-b781-5eedfbf02d0c")) __declspec(novtable) ICompassReading : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
...
struct __declspec(uuid("8f1549b0-e8bc-4c7e-b009-4e41df137072")) __declspec(novtable) ICompassReadingChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::ICompassReading ** value) = 0;
};

struct __declspec(uuid("e761354e-8911-40f7-9e16-6ecc7daec5de")) __declspec(novtable) ICompassReadingHeadingAccuracy : Windows::IInspectable
{
    virtual HRESULT __stdcall get_HeadingAccuracy(winrt::Windows::Devices::Sensors::MagnetometerAccuracy * value) = 0;
};

struct __declspec(uuid("9abc97df-56ec-4c25-b54d-40a68bb5b269")) __declspec(novtable) ICompassStatics : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetDefault(Windows::Devices::Sensors::ICompass ** result) = 0;
};

struct __declspec(uuid("fdb9a9c4-84b1-4ca2-9763-9b589506c70c")) __declspec(novtable) IGyrometer : Windows::IInspectable
{
...
struct __declspec(uuid("63df2443-8ce8-41c3-ac44-8698810b557f")) __declspec(novtable) IGyrometer2 : Windows::IInspectable
{
    virtual HRESULT __stdcall put_ReadingTransform(winrt::Windows::Graphics::Display::DisplayOrientations value) = 0;
    virtual HRESULT __stdcall get_ReadingTransform(winrt::Windows::Graphics::Display::DisplayOrientations * value) = 0;
};

struct __declspec(uuid("1ee5e978-89a2-4275-9e95-7126f4708760")) __declspec(novtable) IGyrometerDeviceId : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(hstring * value) = 0;
};

struct __declspec(uuid("b3d6de5c-1ee4-456f-9de7-e2493b5c8e03")) __declspec(novtable) IGyrometerReading : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
...
struct __declspec(uuid("0fdf1895-6f9e-42ce-8d58-388c0ab8356d")) __declspec(novtable) IGyrometerReadingChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::IGyrometerReading ** value) = 0;
};

struct __declspec(uuid("83b6e7c9-e49d-4b39-86e6-cd554be4c5c1")) __declspec(novtable) IGyrometerStatics : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetDefault(Windows::Devices::Sensors::IGyrometer ** result) = 0;
};

struct __declspec(uuid("2648ca6f-2286-406f-9161-f0c4bd806ebf")) __declspec(novtable) IInclinometer : Windows::IInspectable
{
...
struct __declspec(uuid("029f3393-28b2-45f8-bb16-61e86a7fae6e")) __declspec(novtable) IInclinometer2 : Windows::IInspectable
{
    virtual HRESULT __stdcall put_ReadingTransform(winrt::Windows::Graphics::Display::DisplayOrientations value) = 0;
    virtual HRESULT __stdcall get_ReadingTransform(winrt::Windows::Graphics::Display::DisplayOrientations * value) = 0;
...
struct __declspec(uuid("01e91982-41ff-4406-ae83-62210ff16fe3")) __declspec(novtable) IInclinometerDeviceId : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(hstring * value) = 0;
};

struct __declspec(uuid("9f44f055-b6f6-497f-b127-1a775e501458")) __declspec(novtable) IInclinometerReading : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
...
struct __declspec(uuid("4ae91dc1-e7eb-4938-8511-ae0d6b440438")) __declspec(novtable) IInclinometerReadingChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::IInclinometerReading ** value) = 0;
};

struct __declspec(uuid("b453e880-1fe3-4986-a257-e6ece2723949")) __declspec(novtable) IInclinometerReadingYawAccuracy : Windows::IInspectable
{
    virtual HRESULT __stdcall get_YawAccuracy(winrt::Windows::Devices::Sensors::MagnetometerAccuracy * value) = 0;
};

struct __declspec(uuid("f22ec551-9c30-453a-8b49-3c3eeb33cb61")) __declspec(novtable) IInclinometerStatics : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetDefault(Windows::Devices::Sensors::IInclinometer ** result) = 0;
};

struct __declspec(uuid("043f9775-6a1e-499c-86e0-638c1a864b00")) __declspec(novtable) IInclinometerStatics2 : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetDefaultForRelativeReadings(Windows::Devices::Sensors::IInclinometer ** result) = 0;
};

struct __declspec(uuid("bd9a4280-b91a-4829-9392-abc0b6bdf2b4")) __declspec(novtable) IInclinometerStatics3 : Windows::IInspectable
{
...
struct __declspec(uuid("f84c0718-0c54-47ae-922e-789f57fb03a0")) __declspec(novtable) ILightSensor : Windows::IInspectable
{
...
struct __declspec(uuid("7fee49f8-0afb-4f51-87f0-6c26375ce94f")) __declspec(novtable) ILightSensorDeviceId : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(hstring * value) = 0;
};

struct __declspec(uuid("ffdf6300-227c-4d2b-b302-fc0142485c68")) __declspec(novtable) ILightSensorReading : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
    virtual HRESULT __stdcall get_IlluminanceInLux(float * value) = 0;
};

struct __declspec(uuid("a3a2f4cf-258b-420c-b8ab-8edd601ecf50")) __declspec(novtable) ILightSensorReadingChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::ILightSensorReading ** value) = 0;
};

struct __declspec(uuid("45db8c84-c3a8-471e-9a53-6457fad87c0e")) __declspec(novtable) ILightSensorStatics : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetDefault(Windows::Devices::Sensors::ILightSensor ** result) = 0;
};

struct __declspec(uuid("484f626e-d3c9-4111-b3f6-2cf1faa418d5")) __declspec(novtable) IMagnetometer : Windows::IInspectable
{
...
struct __declspec(uuid("b4656c85-26f6-444b-a9e2-a23f966cd368")) __declspec(novtable) IMagnetometer2 : Windows::IInspectable
{
    virtual HRESULT __stdcall put_ReadingTransform(winrt::Windows::Graphics::Display::DisplayOrientations value) = 0;
    virtual HRESULT __stdcall get_ReadingTransform(winrt::Windows::Graphics::Display::DisplayOrientations * value) = 0;
};

struct __declspec(uuid("58b498c2-7e4b-404c-9fc5-5de8b40ebae3")) __declspec(novtable) IMagnetometerDeviceId : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(hstring * value) = 0;
};

struct __declspec(uuid("0c2cc40d-ebfd-4e5c-bb11-afc29b3cae61")) __declspec(novtable) IMagnetometerReading : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
...
struct __declspec(uuid("17eae872-2eb9-4ee7-8ad0-3127537d949b")) __declspec(novtable) IMagnetometerReadingChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::IMagnetometerReading ** value) = 0;
};

struct __declspec(uuid("853c64cc-0698-4dda-a6df-9cb9cc4ab40a")) __declspec(novtable) IMagnetometerStatics : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetDefault(Windows::Devices::Sensors::IMagnetometer ** result) = 0;
};

struct __declspec(uuid("5e354635-cf6b-4c63-abd8-10252b0bf6ec")) __declspec(novtable) IOrientationSensor : Windows::IInspectable
{
...
struct __declspec(uuid("0d924cf9-2f1f-49c9-8042-4a1813d67760")) __declspec(novtable) IOrientationSensor2 : Windows::IInspectable
{
    virtual HRESULT __stdcall put_ReadingTransform(winrt::Windows::Graphics::Display::DisplayOrientations value) = 0;
    virtual HRESULT __stdcall get_ReadingTransform(winrt::Windows::Graphics::Display::DisplayOrientations * value) = 0;
    virtual HRESULT __stdcall get_ReadingType(winrt::Windows::Devices::Sensors::SensorReadingType * type) = 0;
...
struct __declspec(uuid("5a69b648-4c29-49ec-b28f-ea1d117b66f0")) __declspec(novtable) IOrientationSensorDeviceId : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(hstring * value) = 0;
};

struct __declspec(uuid("4756c993-6595-4897-bcc6-d537ee757564")) __declspec(novtable) IOrientationSensorReading : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
...
struct __declspec(uuid("012c1186-c3ba-46bc-ae65-7a98996cbfb8")) __declspec(novtable) IOrientationSensorReadingChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::IOrientationSensorReading ** value) = 0;
};

struct __declspec(uuid("d1ac9824-3f5a-49a2-bc7b-1180bc38cd2b")) __declspec(novtable) IOrientationSensorReadingYawAccuracy : Windows::IInspectable
{
    virtual HRESULT __stdcall get_YawAccuracy(winrt::Windows::Devices::Sensors::MagnetometerAccuracy * value) = 0;
};

struct __declspec(uuid("10ef8712-fb4c-428a-898b-2765e409e669")) __declspec(novtable) IOrientationSensorStatics : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetDefault(Windows::Devices::Sensors::IOrientationSensor ** result) = 0;
};

struct __declspec(uuid("59da0d0b-d40a-4c71-9276-8a272a0a6619")) __declspec(novtable) IOrientationSensorStatics2 : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetDefaultForRelativeReadings(Windows::Devices::Sensors::IOrientationSensor ** result) = 0;
};

struct __declspec(uuid("d82ce920-2777-40ff-9f59-d654b085f12f")) __declspec(novtable) IOrientationSensorStatics3 : Windows::IInspectable
{
...
struct __declspec(uuid("9a1e013d-3d98-45f8-8920-8e4ecaca5f97")) __declspec(novtable) IPedometer : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(hstring * value) = 0;
    virtual HRESULT __stdcall get_PowerInMilliwatts(double * value) = 0;
    virtual HRESULT __stdcall get_MinimumReportInterval(uint32_t * value) = 0;
...
struct __declspec(uuid("e5a406df-2b81-4add-b2ff-77ab6c98ba19")) __declspec(novtable) IPedometer2 : Windows::IInspectable
{
...
struct __declspec(uuid("cbad8f50-7a54-466b-9010-77a162fca5d7")) __declspec(novtable) IPedometerDataThresholdFactory : Windows::IInspectable
{
...
struct __declspec(uuid("2245dcf4-a8e1-432f-896a-be0dd9b02d24")) __declspec(novtable) IPedometerReading : Windows::IInspectable
{
...
struct __declspec(uuid("f855e47e-abbc-4456-86a8-25cf2b333742")) __declspec(novtable) IPedometerReadingChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::IPedometerReading ** value) = 0;
};

struct __declspec(uuid("82980a2f-4083-4dfb-b411-938ea0f4b946")) __declspec(novtable) IPedometerStatics : Windows::IInspectable
{
...
struct __declspec(uuid("79f5c6bb-ce0e-4133-b47e-8627ea72f677")) __declspec(novtable) IPedometerStatics2 : Windows::IInspectable
{
...
struct __declspec(uuid("54c076b8-ecfb-4944-b928-74fc504d47ee")) __declspec(novtable) IProximitySensor : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(hstring * value) = 0;
...
struct __declspec(uuid("905ac121-6d27-4ad3-9db5-6467f2a5ad9d")) __declspec(novtable) IProximitySensorDataThresholdFactory : Windows::IInspectable
{
...
struct __declspec(uuid("71228d59-132d-4d5f-8ff9-2f0db8751ced")) __declspec(novtable) IProximitySensorReading : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
...
struct __declspec(uuid("cfc2f366-c3e8-40fd-8cc3-67e289004938")) __declspec(novtable) IProximitySensorReadingChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Reading(Windows::Devices::Sensors::IProximitySensorReading ** value) = 0;
};

struct __declspec(uuid("29186649-6269-4e57-a5ad-82be80813392")) __declspec(novtable) IProximitySensorStatics : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetDeviceSelector(hstring * value) = 0;
    virtual HRESULT __stdcall abi_FromId(hstring sensorId, Windows::Devices::Sensors::IProximitySensor ** result) = 0;
};

struct __declspec(uuid("cbf473ae-e9ca-422f-ad67-4c3d25df350c")) __declspec(novtable) IProximitySensorStatics2 : Windows::IInspectable
{
...
struct __declspec(uuid("54daec61-fe4b-4e07-b260-3a4cdfbe396e")) __declspec(novtable) ISensorDataThreshold : Windows::IInspectable
{
};

struct __declspec(uuid("9106f1b7-e88d-48b1-bc90-619c7b349391")) __declspec(novtable) ISensorDataThresholdTriggerDetails : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(hstring * value) = 0;
    virtual HRESULT __stdcall get_SensorType(winrt::Windows::Devices::Sensors::SensorType * value) = 0;
};

struct __declspec(uuid("c9c5c827-c71c-46e7-9da3-36a193b232bc")) __declspec(novtable) ISensorQuaternion : Windows::IInspectable
{
...
struct __declspec(uuid("0a3d5a67-22f4-4392-9538-65d0bd064aa6")) __declspec(novtable) ISensorRotationMatrix : Windows::IInspectable
{
...
struct __declspec(uuid("5ff53856-214a-4dee-a3f9-616f1ab06ffd")) __declspec(novtable) ISimpleOrientationSensor : Windows::IInspectable
{
...
struct __declspec(uuid("a277a798-8870-453e-8bd6-b8f5d8d7941b")) __declspec(novtable) ISimpleOrientationSensor2 : Windows::IInspectable
{
    virtual HRESULT __stdcall put_ReadingTransform(winrt::Windows::Graphics::Display::DisplayOrientations value) = 0;
    virtual HRESULT __stdcall get_ReadingTransform(winrt::Windows::Graphics::Display::DisplayOrientations * value) = 0;
};

struct __declspec(uuid("fbc00acb-3b76-41f6-8091-30efe646d3cf")) __declspec(novtable) ISimpleOrientationSensorDeviceId : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DeviceId(hstring * value) = 0;
};

struct __declspec(uuid("bcd5c660-23d4-4b4c-a22e-ba81ade0c601")) __declspec(novtable) ISimpleOrientationSensorOrientationChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
    virtual HRESULT __stdcall get_Orientation(winrt::Windows::Devices::Sensors::SimpleOrientation * value) = 0;
};

struct __declspec(uuid("72ed066f-70aa-40c6-9b1b-3433f7459b4e")) __declspec(novtable) ISimpleOrientationSensorStatics : Windows::IInspectable
{
...
template <typename T> class impl_IAccelerometer;
template <typename T> class impl_IAccelerometer2;
template <typename T> class impl_IAccelerometer3;
template <typename T> class impl_IAccelerometer4;
template <typename T> class impl_IAccelerometerDeviceId;
template <typename T> class impl_IAccelerometerReading;
template <typename T> class impl_IAccelerometerReadingChangedEventArgs;
template <typename T> class impl_IAccelerometerShakenEventArgs;
template <typename T> class impl_IAccelerometerStatics;
template <typename T> class impl_IAccelerometerStatics2;
template <typename T> class impl_IActivitySensor;
template <typename T> class impl_IActivitySensorReading;
template <typename T> class impl_IActivitySensorReadingChangeReport;
template <typename T> class impl_IActivitySensorReadingChangedEventArgs;
template <typename T> class impl_IActivitySensorStatics;
template <typename T> class impl_IActivitySensorTriggerDetails;
template <typename T> class impl_IAltimeter;
template <typename T> class impl_IAltimeterReading;
template <typename T> class impl_IAltimeterReadingChangedEventArgs;
template <typename T> class impl_IAltimeterStatics;
template <typename T> class impl_IBarometer;
template <typename T> class impl_IBarometerReading;
template <typename T> class impl_IBarometerReadingChangedEventArgs;
template <typename T> class impl_IBarometerStatics;
template <typename T> class impl_ICompass;
template <typename T> class impl_ICompass2;
template <typename T> class impl_ICompassDeviceId;
template <typename T> class impl_ICompassReading;
template <typename T> class impl_ICompassReadingChangedEventArgs;
template <typename T> class impl_ICompassReadingHeadingAccuracy;
template <typename T> class impl_ICompassStatics;
template <typename T> class impl_IGyrometer;
template <typename T> class impl_IGyrometer2;
template <typename T> class impl_IGyrometerDeviceId;
template <typename T> class impl_IGyrometerReading;
template <typename T> class impl_IGyrometerReadingChangedEventArgs;
template <typename T> class impl_IGyrometerStatics;
template <typename T> class impl_IInclinometer;
template <typename T> class impl_IInclinometer2;
template <typename T> class impl_IInclinometerDeviceId;
template <typename T> class impl_IInclinometerReading;
template <typename T> class impl_IInclinometerReadingChangedEventArgs;
template <typename T> class impl_IInclinometerReadingYawAccuracy;
template <typename T> class impl_IInclinometerStatics;
template <typename T> class impl_IInclinometerStatics2;
template <typename T> class impl_IInclinometerStatics3;
template <typename T> class impl_ILightSensor;
template <typename T> class impl_ILightSensorDeviceId;
template <typename T> class impl_ILightSensorReading;
template <typename T> class impl_ILightSensorReadingChangedEventArgs;
template <typename T> class impl_ILightSensorStatics;
template <typename T> class impl_IMagnetometer;
template <typename T> class impl_IMagnetometer2;
template <typename T> class impl_IMagnetometerDeviceId;
template <typename T> class impl_IMagnetometerReading;
template <typename T> class impl_IMagnetometerReadingChangedEventArgs;
template <typename T> class impl_IMagnetometerStatics;
template <typename T> class impl_IOrientationSensor;
template <typename T> class impl_IOrientationSensor2;
template <typename T> class impl_IOrientationSensorDeviceId;
template <typename T> class impl_IOrientationSensorReading;
template <typename T> class impl_IOrientationSensorReadingChangedEventArgs;
template <typename T> class impl_IOrientationSensorReadingYawAccuracy;
template <typename T> class impl_IOrientationSensorStatics;
template <typename T> class impl_IOrientationSensorStatics2;
template <typename T> class impl_IOrientationSensorStatics3;
template <typename T> class impl_IPedometer;
template <typename T> class impl_IPedometer2;
template <typename T> class impl_IPedometerDataThresholdFactory;
template <typename T> class impl_IPedometerReading;
template <typename T> class impl_IPedometerReadingChangedEventArgs;
template <typename T> class impl_IPedometerStatics;
template <typename T> class impl_IPedometerStatics2;
template <typename T> class impl_IProximitySensor;
template <typename T> class impl_IProximitySensorDataThresholdFactory;
template <typename T> class impl_IProximitySensorReading;
template <typename T> class impl_IProximitySensorReadingChangedEventArgs;
template <typename T> class impl_IProximitySensorStatics;
template <typename T> class impl_IProximitySensorStatics2;
template <typename T> class impl_ISensorDataThreshold;
template <typename T> class impl_ISensorDataThresholdTriggerDetails;
template <typename T> class impl_ISensorQuaternion;
template <typename T> class impl_ISensorRotationMatrix;
template <typename T> class impl_ISimpleOrientationSensor;
template <typename T> class impl_ISimpleOrientationSensor2;
template <typename T> class impl_ISimpleOrientationSensorDeviceId;
template <typename T> class impl_ISimpleOrientationSensorOrientationChangedEventArgs;
template <typename T> class impl_ISimpleOrientationSensorStatics;
