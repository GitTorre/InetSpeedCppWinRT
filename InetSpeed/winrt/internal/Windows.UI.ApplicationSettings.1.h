...
template <typename T> class impl_ISettingsPane;
template <typename T> class impl_ISettingsPaneCommandsRequest;
template <typename T> class impl_ISettingsPaneCommandsRequestedEventArgs;
template <typename T> class impl_ISettingsPaneStatics;
...
template <> struct traits<Windows::UI::ApplicationSettings::SettingsPane>
{
    ...
    using default_interface = Windows::UI::ApplicationSettings::ISettingsPane;
...
template <> struct traits<Windows::UI::ApplicationSettings::SettingsPaneCommandsRequest>
{
    ...
    using default_interface = Windows::UI::ApplicationSettings::ISettingsPaneCommandsRequest;
...
template <> struct traits<Windows::UI::ApplicationSettings::SettingsPaneCommandsRequestedEventArgs>
{
    ...
    using default_interface = Windows::UI::ApplicationSettings::ISettingsPaneCommandsRequestedEventArgs;
