...
template <typename T> class impl_IControlChannelTrigger;
template <typename T> class impl_IControlChannelTrigger2;
template <typename T> class impl_IControlChannelTriggerEventDetails;
template <typename T> class impl_IControlChannelTriggerFactory;
template <typename T> class impl_IControlChannelTriggerResetEventDetails;
template <typename T> class impl_IDatagramSocket;
template <typename T> class impl_IDatagramSocket2;
template <typename T> class impl_IDatagramSocket3;
template <typename T> class impl_IDatagramSocketControl;
template <typename T> class impl_IDatagramSocketControl2;
template <typename T> class impl_IDatagramSocketControl3;
template <typename T> class impl_IDatagramSocketInformation;
template <typename T> class impl_IDatagramSocketMessageReceivedEventArgs;
template <typename T> class impl_IDatagramSocketStatics;
template <typename T> class impl_IMessageWebSocket;
template <typename T> class impl_IMessageWebSocket2;
template <typename T> class impl_IMessageWebSocketControl;
template <typename T> class impl_IMessageWebSocketMessageReceivedEventArgs;
template <typename T> class impl_ISocketActivityContext;
template <typename T> class impl_ISocketActivityContextFactory;
template <typename T> class impl_ISocketActivityInformation;
template <typename T> class impl_ISocketActivityInformationStatics;
template <typename T> class impl_ISocketActivityTriggerDetails;
template <typename T> class impl_ISocketErrorStatics;
template <typename T> class impl_IStreamSocket;
template <typename T> class impl_IStreamSocket2;
template <typename T> class impl_IStreamSocket3;
template <typename T> class impl_IStreamSocketControl;
template <typename T> class impl_IStreamSocketControl2;
template <typename T> class impl_IStreamSocketControl3;
template <typename T> class impl_IStreamSocketInformation;
template <typename T> class impl_IStreamSocketInformation2;
template <typename T> class impl_IStreamSocketListener;
template <typename T> class impl_IStreamSocketListener2;
template <typename T> class impl_IStreamSocketListener3;
template <typename T> class impl_IStreamSocketListenerConnectionReceivedEventArgs;
template <typename T> class impl_IStreamSocketListenerControl;
template <typename T> class impl_IStreamSocketListenerControl2;
template <typename T> class impl_IStreamSocketListenerInformation;
template <typename T> class impl_IStreamSocketStatics;
template <typename T> class impl_IStreamWebSocket;
template <typename T> class impl_IStreamWebSocket2;
template <typename T> class impl_IStreamWebSocketControl;
template <typename T> class impl_IWebSocket;
template <typename T> class impl_IWebSocketClosedEventArgs;
template <typename T> class impl_IWebSocketControl;
template <typename T> class impl_IWebSocketControl2;
template <typename T> class impl_IWebSocketErrorStatics;
template <typename T> class impl_IWebSocketInformation;
template <typename T> class impl_IWebSocketInformation2;
template <typename T> class impl_IWebSocketServerCustomValidationRequestedEventArgs;
