...
template <typename D>
class WINRT_EBO impl_ICustomDevice
{
    auto shim() const { return impl::shim<D, ICustomDevice>(this); }
...
template <typename D>
class WINRT_EBO impl_ICustomDeviceStatics
{
    auto shim() const { return impl::shim<D, ICustomDeviceStatics>(this); }
...
template <typename D>
class WINRT_EBO impl_IIOControlCode
{
    auto shim() const { return impl::shim<D, IIOControlCode>(this); }
...
template <typename D>
class WINRT_EBO impl_IIOControlCodeFactory
{
    auto shim() const { return impl::shim<D, IIOControlCodeFactory>(this); }
...
template <typename D>
class WINRT_EBO impl_IKnownDeviceTypesStatics
{
    auto shim() const { return impl::shim<D, IKnownDeviceTypesStatics>(this); }
