...
{
    virtual HRESULT __stdcall abi_Invoke(Windows::IInspectable * sender, Windows::UI::Xaml::Data::ICurrentChangingEventArgs * e) = 0;
};

struct __declspec(uuid("3f7a0c6b-d00f-4730-8c1d-48e16c46f9ca")) __declspec(novtable) IBinding : Windows::IInspectable
{
    ...
    virtual HRESULT __stdcall get_Source(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall put_Source(Windows::IInspectable * value) = 0;
    ...
    virtual HRESULT __stdcall get_ConverterParameter(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall put_ConverterParameter(Windows::IInspectable * value) = 0;
...
struct __declspec(uuid("34f96fcb-0406-48b3-9e82-f333ec4c6910")) __declspec(novtable) IBinding2 : Windows::IInspectable
{
    virtual HRESULT __stdcall get_FallbackValue(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall put_FallbackValue(Windows::IInspectable * value) = 0;
    virtual HRESULT __stdcall get_TargetNullValue(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall put_TargetNullValue(Windows::IInspectable * value) = 0;
...
struct __declspec(uuid("1589a2ab-3d15-49bc-a447-8a5448e58870")) __declspec(novtable) IBindingBase : Windows::IInspectable
{
};

struct __declspec(uuid("22dafc3a-7701-4666-a1ba-9859bdcfec34")) __declspec(novtable) IBindingBaseFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstance(Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Data::IBindingBase ** instance) = 0;
};

struct __declspec(uuid("516a19a5-c2fd-4a9e-9fd3-9aa42f995a3c")) __declspec(novtable) IBindingExpression : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DataItem(Windows::IInspectable ** value) = 0;
...
struct __declspec(uuid("fded3154-e954-4f67-8fb6-6ed79b3a1cb3")) __declspec(novtable) IBindingExpressionBase : Windows::IInspectable
{
};

struct __declspec(uuid("ea7116a7-c2d9-4375-b471-66b9c48c7930")) __declspec(novtable) IBindingExpressionBaseFactory : Windows::IInspectable
{
};

struct __declspec(uuid("1cb55cd9-db72-40b3-a2b5-24ee6ea5c328")) __declspec(novtable) IBindingExpressionFactory : Windows::IInspectable
{
};

struct __declspec(uuid("ff42bb08-c39e-4f7e-8434-a1569083883c")) __declspec(novtable) IBindingFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstance(Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Data::IBinding ** instance) = 0;
};

struct __declspec(uuid("6fffd738-9839-419c-a17a-4b3604e1524e")) __declspec(novtable) IBindingOperations : Windows::IInspectable
{
};

struct __declspec(uuid("e155ef73-95a0-4aab-8c7d-2a47da073c79")) __declspec(novtable) IBindingOperationsStatics : Windows::IInspectable
{
...
struct __declspec(uuid("8be8bfe4-dbef-44df-8126-a31a89121ddc")) __declspec(novtable) ICollectionView : Windows::IInspectable
{
    virtual HRESULT __stdcall get_CurrentItem(Windows::IInspectable ** value) = 0;
    ...
    virtual HRESULT __stdcall get_CollectionGroups(Windows::Foundation::Collections::IObservableVector<Windows::IInspectable> ** value) = 0;
    virtual HRESULT __stdcall get_HasMoreItems(bool * value) = 0;
    virtual HRESULT __stdcall add_CurrentChanged(Windows::Foundation::EventHandler<Windows::IInspectable> * value, event_token * token) = 0;
    ...
    virtual HRESULT __stdcall abi_MoveCurrentTo(Windows::IInspectable * item, bool * returnValue) = 0;
...
struct __declspec(uuid("34d4aaf4-8e72-4950-9192-ecd07d399d0a")) __declspec(novtable) ICollectionViewFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateView(Windows::UI::Xaml::Data::ICollectionView ** result) = 0;
};

struct __declspec(uuid("7e01b9d8-d7b5-48b6-b31c-5bb5bdf5f09b")) __declspec(novtable) ICollectionViewGroup : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Group(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall get_GroupItems(Windows::Foundation::Collections::IObservableVector<Windows::IInspectable> ** value) = 0;
};

struct __declspec(uuid("a66a1146-d2fb-4ead-be9f-3578a466dcfe")) __declspec(novtable) ICollectionViewSource : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Source(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall put_Source(Windows::IInspectable * value) = 0;
...
struct __declspec(uuid("173a0710-46af-4c0c-818b-21b6ef81bf65")) __declspec(novtable) ICollectionViewSourceStatics : Windows::IInspectable
{
...
struct __declspec(uuid("f9891e29-51cc-47dd-a5b9-35dc4914af69")) __declspec(novtable) ICurrentChangingEventArgs : Windows::IInspectable
{
...
struct __declspec(uuid("153bbeee-62f3-48cf-8183-8be26de3a66e")) __declspec(novtable) ICurrentChangingEventArgsFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstance(Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Data::ICurrentChangingEventArgs ** instance) = 0;
    virtual HRESULT __stdcall abi_CreateWithCancelableParameter(bool isCancelable, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Data::ICurrentChangingEventArgs ** instance) = 0;
};

struct __declspec(uuid("30da92c0-23e8-42a0-ae7c-734a0e5d2782")) __declspec(novtable) ICustomProperty : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Type(Windows::UI::Xaml::Interop::TypeName * value) = 0;
    virtual HRESULT __stdcall get_Name(hstring * value) = 0;
    virtual HRESULT __stdcall abi_GetValue(Windows::IInspectable * target, Windows::IInspectable ** returnValue) = 0;
    virtual HRESULT __stdcall abi_SetValue(Windows::IInspectable * target, Windows::IInspectable * value) = 0;
    virtual HRESULT __stdcall abi_GetIndexedValue(Windows::IInspectable * target, Windows::IInspectable * index, Windows::IInspectable ** returnValue) = 0;
    virtual HRESULT __stdcall abi_SetIndexedValue(Windows::IInspectable * target, Windows::IInspectable * value, Windows::IInspectable * index) = 0;
    virtual HRESULT __stdcall get_CanWrite(bool * value) = 0;
    virtual HRESULT __stdcall get_CanRead(bool * value) = 0;
};

struct __declspec(uuid("7c925755-3e48-42b4-8677-76372267033f")) __declspec(novtable) ICustomPropertyProvider : Windows::IInspectable
{
...
struct __declspec(uuid("83b834be-0583-4a26-9b64-8bf4a2f65704")) __declspec(novtable) IItemIndexRange : Windows::IInspectable
{
...
struct __declspec(uuid("86e2c440-2e7a-4c7d-a664-e8abf07bfc7e")) __declspec(novtable) IItemIndexRangeFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstance(int32_t firstIndex, uint32_t length, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Data::IItemIndexRange ** instance) = 0;
};

struct __declspec(uuid("f05f5665-71fd-45a2-be13-a081d294a68d")) __declspec(novtable) IItemsRangeInfo : Windows::IInspectable
{
...
struct __declspec(uuid("cf75d69c-f2f4-486b-b302-bb4c09baebfa")) __declspec(novtable) INotifyPropertyChanged : Windows::IInspectable
{
...
struct __declspec(uuid("4f33a9a0-5cf4-47a4-b16f-d7faaf17457e")) __declspec(novtable) IPropertyChangedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_PropertyName(hstring * value) = 0;
};

struct __declspec(uuid("6dcc9c03-e0c7-4eee-8ea9-37e3406eeb1c")) __declspec(novtable) IPropertyChangedEventArgsFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstance(hstring name, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Data::IPropertyChangedEventArgs ** instance) = 0;
};

struct __declspec(uuid("2397ce84-2822-483a-b499-d0f031e06c6b")) __declspec(novtable) IRelativeSource : Windows::IInspectable
{
...
struct __declspec(uuid("ef8392cd-446e-4f93-aacb-9b1255577460")) __declspec(novtable) IRelativeSourceFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstance(Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Data::IRelativeSource ** instance) = 0;
};

struct __declspec(uuid("2e12ca86-e1ed-4245-be49-207e42aec524")) __declspec(novtable) ISelectionInfo : Windows::IInspectable
{
...
struct __declspec(uuid("7f5ee992-7694-4e6c-a51b-e34bf43de743")) __declspec(novtable) ISupportIncrementalLoading : Windows::IInspectable
{
...
struct __declspec(uuid("e6f2fef0-0712-487f-b313-f300b8d79aa1")) __declspec(novtable) IValueConverter : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_Convert(Windows::IInspectable * value, Windows::UI::Xaml::Interop::TypeName targetType, Windows::IInspectable * parameter, hstring language, Windows::IInspectable ** returnValue) = 0;
    virtual HRESULT __stdcall abi_ConvertBack(Windows::IInspectable * value, Windows::UI::Xaml::Interop::TypeName targetType, Windows::IInspectable * parameter, hstring language, Windows::IInspectable ** returnValue) = 0;
};

struct __declspec(uuid("50f19c16-0a22-4d8e-a089-1ea9951657d2")) __declspec(novtable) PropertyChangedEventHandler : IUnknown
{
    virtual HRESULT __stdcall abi_Invoke(Windows::IInspectable * sender, Windows::UI::Xaml::Data::IPropertyChangedEventArgs * e) = 0;
};
...
template <typename T> class impl_IBinding;
template <typename T> class impl_IBinding2;
template <typename T> class impl_IBindingBase;
template <typename T> class impl_IBindingBaseFactory;
template <typename T> class impl_IBindingExpression;
template <typename T> class impl_IBindingExpressionBase;
template <typename T> class impl_IBindingExpressionBaseFactory;
template <typename T> class impl_IBindingExpressionFactory;
template <typename T> class impl_IBindingFactory;
template <typename T> class impl_IBindingOperations;
template <typename T> class impl_IBindingOperationsStatics;
template <typename T> class impl_ICollectionView;
template <typename T> class impl_ICollectionViewFactory;
template <typename T> class impl_ICollectionViewGroup;
template <typename T> class impl_ICollectionViewSource;
template <typename T> class impl_ICollectionViewSourceStatics;
template <typename T> class impl_ICurrentChangingEventArgs;
template <typename T> class impl_ICurrentChangingEventArgsFactory;
template <typename T> class impl_ICustomProperty;
template <typename T> class impl_ICustomPropertyProvider;
template <typename T> class impl_IItemIndexRange;
template <typename T> class impl_IItemIndexRangeFactory;
template <typename T> class impl_IItemsRangeInfo;
template <typename T> class impl_INotifyPropertyChanged;
template <typename T> class impl_IPropertyChangedEventArgs;
template <typename T> class impl_IPropertyChangedEventArgsFactory;
template <typename T> class impl_IRelativeSource;
template <typename T> class impl_IRelativeSourceFactory;
template <typename T> class impl_ISelectionInfo;
template <typename T> class impl_ISupportIncrementalLoading;
template <typename T> class impl_IValueConverter;
