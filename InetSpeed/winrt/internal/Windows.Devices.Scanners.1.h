...
template <typename T> class impl_IImageScanner;
template <typename T> class impl_IImageScannerFeederConfiguration;
template <typename T> class impl_IImageScannerFormatConfiguration;
template <typename T> class impl_IImageScannerPreviewResult;
template <typename T> class impl_IImageScannerScanResult;
template <typename T> class impl_IImageScannerSourceConfiguration;
template <typename T> class impl_IImageScannerStatics;
...
template <> struct traits<Windows::Devices::Scanners::ImageScanner>
{
    ...
    using default_interface = Windows::Devices::Scanners::IImageScanner;
...
template <> struct traits<Windows::Devices::Scanners::ImageScannerAutoConfiguration>
{
    ...
    using default_interface = Windows::Devices::Scanners::IImageScannerFormatConfiguration;
...
template <> struct traits<Windows::Devices::Scanners::ImageScannerPreviewResult>
{
    ...
    using default_interface = Windows::Devices::Scanners::IImageScannerPreviewResult;
...
template <> struct traits<Windows::Devices::Scanners::ImageScannerScanResult>
{
    ...
    using default_interface = Windows::Devices::Scanners::IImageScannerScanResult;
