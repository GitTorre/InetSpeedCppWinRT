...
template <typename T> class impl_IAppCaptureAlternateShortcutKeys;
template <typename T> class impl_IAppCaptureAlternateShortcutKeys2;
template <typename T> class impl_IAppCaptureAlternateShortcutKeys3;
template <typename T> class impl_IAppCaptureManagerStatics;
template <typename T> class impl_IAppCaptureSettings;
template <typename T> class impl_IAppCaptureSettings2;
template <typename T> class impl_IAppCaptureSettings3;
template <typename T> class impl_IAppCaptureSettings4;
...
template <typename T> class impl_ICameraOptionsUIStatics;
...
template <> struct traits<Windows::Media::Capture::AppCaptureAlternateShortcutKeys>
{
    ...
    using default_interface = Windows::Media::Capture::IAppCaptureAlternateShortcutKeys;
...
template <> struct traits<Windows::Media::Capture::AppCaptureSettings>
{
    ...
    using default_interface = Windows::Media::Capture::IAppCaptureSettings;
