...
template <typename D>
class WINRT_EBO impl_ISettingsPane
{
    auto shim() const { return impl::shim<D, ISettingsPane>(this); }
...
template <typename D>
class WINRT_EBO impl_ISettingsPaneCommandsRequest
{
    auto shim() const { return impl::shim<D, ISettingsPaneCommandsRequest>(this); }
...
template <typename D>
class WINRT_EBO impl_ISettingsPaneCommandsRequestedEventArgs
{
    auto shim() const { return impl::shim<D, ISettingsPaneCommandsRequestedEventArgs>(this); }
...
template <typename D>
class WINRT_EBO impl_ISettingsPaneStatics
{
    auto shim() const { return impl::shim<D, ISettingsPaneStatics>(this); }
