...
template <typename T> class impl_IProcessLauncherOptions;
template <typename T> class impl_IProcessLauncherResult;
template <typename T> class impl_IProcessLauncherStatics;
...
template <typename T> class impl_IShutdownManagerStatics;
template <typename T> class impl_ITimeZoneSettingsStatics;
...
template <> struct traits<Windows::System::ProcessLauncherOptions>
{
    ...
    using default_interface = Windows::System::IProcessLauncherOptions;
...
template <> struct traits<Windows::System::ProcessLauncherResult>
{
    ...
    using default_interface = Windows::System::IProcessLauncherResult;
