...
struct __declspec(uuid("b6daa9fc-bc5b-401a-a8b2-6e754d14daa6")) __declspec(novtable) IPreallocatedWorkItem : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_RunAsync(Windows::Foundation::IAsyncAction ** operation) = 0;
};

struct __declspec(uuid("e3d32b45-dfea-469b-82c5-f6e3cefdeafb")) __declspec(novtable) IPreallocatedWorkItemFactory : Windows::IInspectable
{
...
struct __declspec(uuid("14285e06-63a7-4713-b6d9-62f64b56fb8b")) __declspec(novtable) ISignalNotifier : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_Enable() = 0;
    virtual HRESULT __stdcall abi_Terminate() = 0;
};

struct __declspec(uuid("1c4e4566-8400-46d3-a115-7d0c0dfc9f62")) __declspec(novtable) ISignalNotifierStatics : Windows::IInspectable
{
