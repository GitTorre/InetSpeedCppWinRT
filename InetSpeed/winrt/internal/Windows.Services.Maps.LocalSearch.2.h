...
template <typename D>
class WINRT_EBO impl_ILocalCategoriesStatics
{
    auto shim() const { return impl::shim<D, ILocalCategoriesStatics>(this); }
...
template <typename D>
class WINRT_EBO impl_ILocalLocation
{
    auto shim() const { return impl::shim<D, ILocalLocation>(this); }
...
template <typename D>
class WINRT_EBO impl_ILocalLocation2
{
    auto shim() const { return impl::shim<D, ILocalLocation2>(this); }
...
template <typename D>
class WINRT_EBO impl_ILocalLocationFinderResult
{
    auto shim() const { return impl::shim<D, ILocalLocationFinderResult>(this); }
...
template <typename D>
class WINRT_EBO impl_ILocalLocationFinderStatics
{
    auto shim() const { return impl::shim<D, ILocalLocationFinderStatics>(this); }
...
template <typename D>
class WINRT_EBO impl_ILocalLocationHoursOfOperationItem
{
    auto shim() const { return impl::shim<D, ILocalLocationHoursOfOperationItem>(this); }
...
template <typename D>
class WINRT_EBO impl_ILocalLocationRatingInfo
{
    auto shim() const { return impl::shim<D, ILocalLocationRatingInfo>(this); }
