...
template <typename T> class impl_IPrintExtensionContextStatic;
template <typename T> class impl_IPrintNotificationEventDetails;
template <typename T> class impl_IPrintTaskConfiguration;
template <typename T> class impl_IPrintTaskConfigurationSaveRequest;
template <typename T> class impl_IPrintTaskConfigurationSaveRequestedDeferral;
template <typename T> class impl_IPrintTaskConfigurationSaveRequestedEventArgs;
