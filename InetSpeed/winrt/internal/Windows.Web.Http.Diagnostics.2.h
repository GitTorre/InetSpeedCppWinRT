...
template <typename D>
class WINRT_EBO impl_IHttpDiagnosticProvider
{
    auto shim() const { return impl::shim<D, IHttpDiagnosticProvider>(this); }
...
template <typename D>
class WINRT_EBO impl_IHttpDiagnosticProviderRequestResponseCompletedEventArgs
{
    auto shim() const { return impl::shim<D, IHttpDiagnosticProviderRequestResponseCompletedEventArgs>(this); }
...
template <typename D>
class WINRT_EBO impl_IHttpDiagnosticProviderRequestResponseTimestamps
{
    auto shim() const { return impl::shim<D, IHttpDiagnosticProviderRequestResponseTimestamps>(this); }
...
template <typename D>
class WINRT_EBO impl_IHttpDiagnosticProviderRequestSentEventArgs
{
    auto shim() const { return impl::shim<D, IHttpDiagnosticProviderRequestSentEventArgs>(this); }
...
template <typename D>
class WINRT_EBO impl_IHttpDiagnosticProviderResponseReceivedEventArgs
{
    auto shim() const { return impl::shim<D, IHttpDiagnosticProviderResponseReceivedEventArgs>(this); }
...
template <typename D>
class WINRT_EBO impl_IHttpDiagnosticProviderStatics
{
    auto shim() const { return impl::shim<D, IHttpDiagnosticProviderStatics>(this); }
...
template <typename D>
class WINRT_EBO impl_IHttpDiagnosticSourceLocation
{
    auto shim() const { return impl::shim<D, IHttpDiagnosticSourceLocation>(this); }
