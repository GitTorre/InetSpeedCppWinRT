...
template <typename T> class impl_ILocalCategoriesStatics;
template <typename T> class impl_ILocalLocation;
template <typename T> class impl_ILocalLocation2;
template <typename T> class impl_ILocalLocationFinderResult;
template <typename T> class impl_ILocalLocationFinderStatics;
template <typename T> class impl_ILocalLocationHoursOfOperationItem;
template <typename T> class impl_ILocalLocationRatingInfo;
...
template <> struct traits<Windows::Services::Maps::LocalSearch::LocalLocation>
{
    ...
    using default_interface = Windows::Services::Maps::LocalSearch::ILocalLocation;
...
template <> struct traits<Windows::Services::Maps::LocalSearch::LocalLocationFinderResult>
{
    ...
    using default_interface = Windows::Services::Maps::LocalSearch::ILocalLocationFinderResult;
...
template <> struct traits<Windows::Services::Maps::LocalSearch::LocalLocationHoursOfOperationItem>
{
    ...
    using default_interface = Windows::Services::Maps::LocalSearch::ILocalLocationHoursOfOperationItem;
...
template <> struct traits<Windows::Services::Maps::LocalSearch::LocalLocationRatingInfo>
{
    ...
    using default_interface = Windows::Services::Maps::LocalSearch::ILocalLocationRatingInfo;
