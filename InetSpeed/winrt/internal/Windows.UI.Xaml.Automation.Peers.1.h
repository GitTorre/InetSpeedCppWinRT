...
struct __declspec(uuid("8b4acfeb-89fa-4f13-84be-35ca5b7c9590")) __declspec(novtable) IAppBarAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("8360f4e2-e396-4517-af5d-f4cf34c54edf")) __declspec(novtable) IAppBarAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IAppBar * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IAppBarAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("443262b2-4f6d-4b76-9d2e-3eff777e8864")) __declspec(novtable) IAppBarButtonAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("aef0342a-acb7-42dc-97e3-847071865fd6")) __declspec(novtable) IAppBarButtonAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IAppBarButton * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IAppBarButtonAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("8464efad-9655-4aff-9550-63ae9ec8fe9c")) __declspec(novtable) IAppBarToggleButtonAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("d6f9139d-02c1-4221-9591-7d4efeb74701")) __declspec(novtable) IAppBarToggleButtonAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IAppBarToggleButton * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IAppBarToggleButtonAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("2f32c302-f99b-491d-9726-a5e181643efa")) __declspec(novtable) IAutoSuggestBoxAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("80046849-18e7-4475-b362-4bbd53d24562")) __declspec(novtable) IAutoSuggestBoxAutomationPeerFactory : Windows::IInspectable
{
...
struct __declspec(uuid("35aac87a-62ee-4d3e-a24c-2bc8432d68b7")) __declspec(novtable) IAutomationPeer : Windows::IInspectable
{
    ...
    virtual HRESULT __stdcall abi_GetPattern(winrt::Windows::UI::Xaml::Automation::Peers::PatternInterface patternInterface, Windows::IInspectable ** returnValue) = 0;
    virtual HRESULT __stdcall abi_RaiseAutomationEvent(winrt::Windows::UI::Xaml::Automation::Peers::AutomationEvents eventId) = 0;
    virtual HRESULT __stdcall abi_RaisePropertyChangedEvent(Windows::UI::Xaml::Automation::IAutomationProperty * automationProperty, Windows::IInspectable * oldValue, Windows::IInspectable * newValue) = 0;
...
struct __declspec(uuid("ea1f89c7-ebf5-4ab8-88f7-680d821dac61")) __declspec(novtable) IAutomationPeer2 : Windows::IInspectable
{
};

struct __declspec(uuid("d3cfb977-0084-41d7-a221-28158d3bc32c")) __declspec(novtable) IAutomationPeer3 : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_Navigate(winrt::Windows::UI::Xaml::Automation::Peers::AutomationNavigationDirection direction, Windows::IInspectable ** returnValue) = 0;
    virtual HRESULT __stdcall abi_GetElementFromPoint(Windows::Foundation::Point pointInWindowCoordinates, Windows::IInspectable ** returnValue) = 0;
...
struct __declspec(uuid("761ce752-73c1-4f44-be75-43c49ec0d4d5")) __declspec(novtable) IAutomationPeer4 : Windows::IInspectable
{
...
struct __declspec(uuid("f632e1c6-0a3f-4574-9fef-cdc151765674")) __declspec(novtable) IAutomationPeer5 : Windows::IInspectable
{
...
struct __declspec(uuid("0c456061-52cf-43fa-82f8-07f137351e5a")) __declspec(novtable) IAutomationPeerAnnotation : Windows::IInspectable
{
...
struct __declspec(uuid("f59c439e-c65b-43cd-9009-03fc023363a7")) __declspec(novtable) IAutomationPeerAnnotationFactory : Windows::IInspectable
{
...
struct __declspec(uuid("8809a87d-09b2-4d45-b78b-1d3b3b09f661")) __declspec(novtable) IAutomationPeerAnnotationStatics : Windows::IInspectable
{
...
struct __declspec(uuid("20c27545-a88b-43c8-bc24-cea9dafd04a3")) __declspec(novtable) IAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstance(Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("bea93e67-dbee-4f7b-af0d-a79aae5333bf")) __declspec(novtable) IAutomationPeerOverrides : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetPatternCore(winrt::Windows::UI::Xaml::Automation::Peers::PatternInterface patternInterface, Windows::IInspectable ** returnValue) = 0;
...
struct __declspec(uuid("2603682a-9da6-4023-b496-496e5ef228d2")) __declspec(novtable) IAutomationPeerOverrides2 : Windows::IInspectable
{
...
struct __declspec(uuid("b6f0c4ad-4d39-49e6-bb91-d924eefd8538")) __declspec(novtable) IAutomationPeerOverrides3 : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_NavigateCore(winrt::Windows::UI::Xaml::Automation::Peers::AutomationNavigationDirection direction, Windows::IInspectable ** returnValue) = 0;
    virtual HRESULT __stdcall abi_GetElementFromPointCore(Windows::Foundation::Point pointInWindowCoordinates, Windows::IInspectable ** returnValue) = 0;
    virtual HRESULT __stdcall abi_GetFocusedElementCore(Windows::IInspectable ** returnValue) = 0;
...
struct __declspec(uuid("b186cda2-5d46-4bcd-a811-269ad15b3aee")) __declspec(novtable) IAutomationPeerOverrides4 : Windows::IInspectable
{
...
struct __declspec(uuid("2c847c85-781e-49f7-9fef-b9e14d014707")) __declspec(novtable) IAutomationPeerOverrides5 : Windows::IInspectable
{
...
struct __declspec(uuid("f4b40e52-642f-4629-a54a-ea5d2349c448")) __declspec(novtable) IAutomationPeerProtected : Windows::IInspectable
{
...
struct __declspec(uuid("562f7fb0-a331-4a9c-9dec-bfb7586fffff")) __declspec(novtable) IAutomationPeerStatics : Windows::IInspectable
{
...
struct __declspec(uuid("572c5714-7f87-4271-819f-6cf4c4d022d0")) __declspec(novtable) IAutomationPeerStatics3 : Windows::IInspectable
{
...
struct __declspec(uuid("fb77efbe-39ec-4508-8ac3-51a1424027d7")) __declspec(novtable) IButtonAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("3fdb9f49-f4ab-4780-8644-03376299a175")) __declspec(novtable) IButtonAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IButton * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IButtonAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("a4f3b5b6-7585-4e0b-96d2-08cf6f28befa")) __declspec(novtable) IButtonBaseAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("8a04091e-e6b2-4c60-a759-c13ca45165ed")) __declspec(novtable) IButtonBaseAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::Primitives::IButtonBase * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IButtonBaseAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("dcc44ee0-fa45-45c6-8bb7-320d808f5958")) __declspec(novtable) ICaptureElementAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("9b92ef48-85e9-4869-b175-8f7cf45a6d9f")) __declspec(novtable) ICaptureElementAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::ICaptureElement * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::ICaptureElementAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("eb15bc42-c0a9-46c6-ac24-b83de429c733")) __declspec(novtable) ICheckBoxAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("b75c775d-eb8f-44ef-a27c-e26ac7de8333")) __declspec(novtable) ICheckBoxAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::ICheckBox * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::ICheckBoxAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("7eb40d0b-75c5-4263-ba6a-d4a54fb0f239")) __declspec(novtable) IComboBoxAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("098e5b0d-1b90-40b9-9be3-b23267eb13cf")) __declspec(novtable) IComboBoxAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IComboBox * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IComboBoxAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("12ddc76e-9552-446a-82ee-938cc371800f")) __declspec(novtable) IComboBoxItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("134ac7fc-397a-403f-a6ec-1ce8beda15e5")) __declspec(novtable) IComboBoxItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IComboBoxItem * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IComboBoxItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("4fef6df2-289c-4c04-831b-5a668c6d7104")) __declspec(novtable) IComboBoxItemDataAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("14a8d4f6-469a-41ba-9d93-44a1a55da872")) __declspec(novtable) IComboBoxItemDataAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithParentAndItem(Windows::IInspectable * item, Windows::UI::Xaml::Automation::Peers::IComboBoxAutomationPeer * parent, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IComboBoxItemDataAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("d07d357f-a0b9-45dc-991a-76c505e7d0f5")) __declspec(novtable) IDatePickerAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("e5667d19-9157-4436-9f4d-7fb99174b48e")) __declspec(novtable) IDatePickerAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IDatePicker * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IDatePickerAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("752aed38-c2bf-4880-82b2-a6c05e90c135")) __declspec(novtable) IDatePickerFlyoutPresenterAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("8ec0353a-4284-4b00-aef8-a2688ea5e3c4")) __declspec(novtable) IFlipViewAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("4395ab0d-8d83-483c-88eb-e2617b0d293f")) __declspec(novtable) IFlipViewAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IFlipView * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IFlipViewAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("c83034de-fa08-4bd3-aeb2-d2e5bfa04df9")) __declspec(novtable) IFlipViewItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("69109356-d0e5-4c10-a09c-ad0bf1b0cb01")) __declspec(novtable) IFlipViewItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IFlipViewItem * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IFlipViewItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("b0986175-00bc-4118-8a6f-16ee9c15d968")) __declspec(novtable) IFlipViewItemDataAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("3c864393-0aea-4e78-bc11-b775cac4114c")) __declspec(novtable) IFlipViewItemDataAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithParentAndItem(Windows::IInspectable * item, Windows::UI::Xaml::Automation::Peers::IFlipViewAutomationPeer * parent, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IFlipViewItemDataAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("a01840b4-5fca-456f-98ea-300eb40b585e")) __declspec(novtable) IFlyoutPresenterAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("f350155f-8924-44c0-ba44-653fe79f1efb")) __declspec(novtable) IFlyoutPresenterAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IFlyoutPresenter * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IFlyoutPresenterAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("b90ad781-bfeb-4451-bd47-9f3a63ebd24a")) __declspec(novtable) IFrameworkElementAutomationPeer : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Owner(Windows::UI::Xaml::IUIElement ** value) = 0;
};

struct __declspec(uuid("0db9b8bc-b812-48e3-af1f-dbc57600c325")) __declspec(novtable) IFrameworkElementAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::IFrameworkElement * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IFrameworkElementAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("b9c0b997-2820-44a1-a5a8-9b801edc269e")) __declspec(novtable) IFrameworkElementAutomationPeerStatics : Windows::IInspectable
{
...
struct __declspec(uuid("1c4401a4-d951-49ca-8f82-c7f3c60681b0")) __declspec(novtable) IGridViewAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("8aca59dd-22a7-4800-894b-c1f485f38953")) __declspec(novtable) IGridViewAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IGridView * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IGridViewAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("e3dcef3a-e08a-48e7-b23a-2be5b66e474e")) __declspec(novtable) IGridViewHeaderItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("2c80b4d2-ffc2-4157-88dd-59cd92e39715")) __declspec(novtable) IGridViewHeaderItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IGridViewHeaderItem * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IGridViewHeaderItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("93ef2d07-346c-4166-a4ba-bc6a181e7f33")) __declspec(novtable) IGridViewItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("fafec376-f22e-466d-913c-ae24ccdb160f")) __declspec(novtable) IGridViewItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IGridViewItem * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IGridViewItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("f3f4868f-29d4-4094-8c54-ea61a88294a4")) __declspec(novtable) IGridViewItemDataAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("a65e7a88-770d-402c-996f-67506af2a4af")) __declspec(novtable) IGridViewItemDataAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithParentAndItem(Windows::IInspectable * item, Windows::UI::Xaml::Automation::Peers::IGridViewAutomationPeer * parent, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IGridViewItemDataAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("1914fe6d-0740-4236-9ee1-38cf19c1c388")) __declspec(novtable) IGroupItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("56a64567-f21c-4c90-b379-15a27c7f8409")) __declspec(novtable) IGroupItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IGroupItem * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IGroupItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("4ddee056-4ebc-4620-a05d-903e3c9a4ead")) __declspec(novtable) IHubAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("c762d43f-79dd-43ee-8777-8d08b39aa065")) __declspec(novtable) IHubAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IHub * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IHubAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("16d91ff7-7431-4d82-83ce-cfa3192b0f18")) __declspec(novtable) IHubSectionAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("c68e27e8-17ec-4329-91ae-2d0b2339d498")) __declspec(novtable) IHubSectionAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IHubSection * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IHubSectionAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("aa7afcb1-0edf-46d9-aa9e-0eb21d140097")) __declspec(novtable) IHyperlinkButtonAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("59bc1661-c182-49af-9526-44b88e628455")) __declspec(novtable) IHyperlinkButtonAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IHyperlinkButton * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IHyperlinkButtonAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("9b0bbf8c-60a2-48bf-ab2c-1a52a451d2d4")) __declspec(novtable) IImageAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("90304003-687d-47bf-b3a2-4babcad8ef50")) __declspec(novtable) IImageAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IImage * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IImageAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("123baaa4-f2e8-4bcb-9382-5dfdd11fe45f")) __declspec(novtable) IInkToolbarAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("953c34f6-3b31-47a7-b3bf-25d3ae99c317")) __declspec(novtable) IItemAutomationPeer : Windows::IInspectable
{
...
struct __declspec(uuid("29065073-de3d-4d3f-97b4-4d6f9d53444d")) __declspec(novtable) IItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithParentAndItem(Windows::IInspectable * item, Windows::UI::Xaml::Automation::Peers::IItemsControlAutomationPeer * parent, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("96e76bf1-37f7-4088-925d-65268e83e34d")) __declspec(novtable) IItemsControlAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("c48d8917-95a8-47b8-a517-bf891a6c039b")) __declspec(novtable) IItemsControlAutomationPeer2 : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateItemAutomationPeer(Windows::IInspectable * item, Windows::UI::Xaml::Automation::Peers::IItemAutomationPeer ** returnValue) = 0;
};

struct __declspec(uuid("4038a259-2e1a-49ca-a533-c64f181577e6")) __declspec(novtable) IItemsControlAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IItemsControl * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IItemsControlAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("361dc0e8-b56f-45e9-80fe-10a0fb0fe177")) __declspec(novtable) IItemsControlAutomationPeerOverrides2 : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_OnCreateItemAutomationPeer(Windows::IInspectable * item, Windows::UI::Xaml::Automation::Peers::IItemAutomationPeer ** returnValue) = 0;
};

struct __declspec(uuid("8cd0d608-b402-4a6e-bd9a-343f8845eb32")) __declspec(novtable) IListBoxAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("e2362185-7df6-49f7-8abc-4c33f1a3d46e")) __declspec(novtable) IListBoxAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IListBox * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IListBoxAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("1bc6e1c6-2997-42df-99eb-92bc1dd149fb")) __declspec(novtable) IListBoxItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("509f9dd8-b0aa-443f-a110-41209af44f1c")) __declspec(novtable) IListBoxItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IListBoxItem * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IListBoxItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("fd7d5fee-fde0-482a-8084-dcebba5b9806")) __declspec(novtable) IListBoxItemDataAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("d7924e16-bd8d-4662-a995-20ff9a056093")) __declspec(novtable) IListBoxItemDataAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithParentAndItem(Windows::IInspectable * item, Windows::UI::Xaml::Automation::Peers::IListBoxAutomationPeer * parent, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IListBoxItemDataAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("56dfdc58-2395-4060-8047-8ea463698a24")) __declspec(novtable) IListPickerFlyoutPresenterAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("73cecc87-c0dc-4260-9148-75e9864a7230")) __declspec(novtable) IListViewAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("65f39174-eaa2-4e44-8be6-4cca28cd0288")) __declspec(novtable) IListViewAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IListView * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IListViewAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("87ec7649-b83d-4e55-9afd-bd835e748f5c")) __declspec(novtable) IListViewBaseAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("70d3c2be-8950-4647-9362-fd002f8ff82e")) __declspec(novtable) IListViewBaseAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IListViewBase * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IListViewBaseAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("7cb8b732-c1f0-4a3c-bc14-85dd48dedb85")) __declspec(novtable) IListViewBaseHeaderItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("40ec995f-d631-4004-832e-6d8643e51561")) __declspec(novtable) IListViewBaseHeaderItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IListViewBaseHeaderItem * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IListViewBaseHeaderItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("67ab1e4b-ad61-4c88-ba45-0f3a8d061f8f")) __declspec(novtable) IListViewHeaderItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("07668694-2ca5-4be4-a8b9-592d48f76087")) __declspec(novtable) IListViewHeaderItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IListViewHeaderItem * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IListViewHeaderItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("ca114e70-a16d-4d09-a1cf-1856ef98a9ec")) __declspec(novtable) IListViewItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("c47dfbc0-facc-4024-a73b-17ec4e662654")) __declspec(novtable) IListViewItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IListViewItem * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IListViewItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("15a8d7fd-d7a5-4a6c-963c-6f7ce464671a")) __declspec(novtable) IListViewItemDataAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("d0db12bb-d715-4523-acc0-1e1072d8e32b")) __declspec(novtable) IListViewItemDataAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithParentAndItem(Windows::IInspectable * item, Windows::UI::Xaml::Automation::Peers::IListViewBaseAutomationPeer * parent, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IListViewItemDataAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("50b406ca-bae9-4816-8a3a-0cb4f96478a2")) __declspec(novtable) ILoopingSelectorAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("d3fa68bf-04cf-4f4c-8d3e-4780a19d4788")) __declspec(novtable) ILoopingSelectorItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("ef567e32-7cd2-4d32-9590-1f588d5ef38d")) __declspec(novtable) ILoopingSelectorItemDataAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("425beee4-f2e8-4bcb-9382-5dfdd11fe45f")) __declspec(novtable) IMapControlAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("ba0b9fc2-a6e2-41a5-b17a-d1594613efba")) __declspec(novtable) IMediaElementAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("b2ad3b28-7575-4173-9bc7-80367a164ed2")) __declspec(novtable) IMediaElementAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IMediaElement * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IMediaElementAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("02bed209-3f65-4fdd-b5ca-c4750d4e6ea4")) __declspec(novtable) IMediaPlayerElementAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("08848077-82af-4d19-b170-282a9e0e7f37")) __declspec(novtable) IMediaPlayerElementAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IMediaPlayerElement * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IMediaPlayerElementAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("a3ad8d93-79f8-4958-a3c8-980defb83d15")) __declspec(novtable) IMediaTransportControlsAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("f41cb003-e103-4ab0-812a-a08fbdb570ce")) __declspec(novtable) IMediaTransportControlsAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IMediaTransportControls * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IMediaTransportControlsAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("1fc19462-21df-456e-aa11-8fac6b4b2af6")) __declspec(novtable) IMenuFlyoutItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("d08bfcb8-20d1-45d8-a2c2-2f130df714e0")) __declspec(novtable) IMenuFlyoutItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IMenuFlyoutItem * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IMenuFlyoutItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("e244a871-fcbb-48fc-8a93-41ea134b53ce")) __declspec(novtable) IMenuFlyoutPresenterAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("07b5172d-761d-452b-9e6d-fa2a8be0ad26")) __declspec(novtable) IMenuFlyoutPresenterAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IMenuFlyoutPresenter * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IMenuFlyoutPresenterAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("684f065e-3df3-4b9f-82ad-8819db3b218a")) __declspec(novtable) IPasswordBoxAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("ac3d7ede-dca4-481c-b520-4a9b3f3b179c")) __declspec(novtable) IPasswordBoxAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IPasswordBox * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IPasswordBoxAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("28414bf7-8382-4eae-93c1-d6f035aa8155")) __declspec(novtable) IPickerFlyoutPresenterAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("e715a8f8-3b9d-402c-81e2-6e912ef58981")) __declspec(novtable) IPivotAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("3efe0f94-0c91-4341-b9ac-1b56b4e6b84f")) __declspec(novtable) IPivotAutomationPeerFactory : Windows::IInspectable
{
...
struct __declspec(uuid("1a4241ad-5d55-4d27-b40f-2d37506fbe78")) __declspec(novtable) IPivotItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("f2810471-183f-416b-b41a-1e5a958a91f4")) __declspec(novtable) IPivotItemAutomationPeerFactory : Windows::IInspectable
{
...
struct __declspec(uuid("a2a3b788-ea1d-48b7-88ee-f08b6aa07fee")) __declspec(novtable) IPivotItemDataAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("517a2480-d3b6-412e-82b6-94a0a84c13b0")) __declspec(novtable) IPivotItemDataAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithParentAndItem(Windows::IInspectable * item, Windows::UI::Xaml::Automation::Peers::IPivotAutomationPeer * parent, Windows::UI::Xaml::Automation::Peers::IPivotItemDataAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("93f48f86-d840-4fb6-ac2f-5f779b854b0d")) __declspec(novtable) IProgressBarAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("364679ab-b80f-41b4-8eea-2f5251bc739c")) __declspec(novtable) IProgressBarAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IProgressBar * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IProgressBarAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("bc305eee-39d3-4eeb-ac33-2394de123e2e")) __declspec(novtable) IProgressRingAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("f3db204b-157e-40bc-9593-55bc5c71a4f6")) __declspec(novtable) IProgressRingAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IProgressRing * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IProgressRingAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("7e6a5ed8-0b30-4743-b102-dcdf548e3131")) __declspec(novtable) IRadioButtonAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("4940c4fd-3d88-49ca-8f31-924187af0bfe")) __declspec(novtable) IRadioButtonAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IRadioButton * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IRadioButtonAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("e454b549-4b2c-42ad-b04b-d35947d1ee50")) __declspec(novtable) IRangeBaseAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("827c7601-3078-4479-95ea-91374ca06207")) __declspec(novtable) IRangeBaseAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::Primitives::IRangeBase * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IRangeBaseAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("29e41ad5-a8ac-4e8a-83d8-09e37e054257")) __declspec(novtable) IRepeatButtonAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("6a6ff9d4-575e-4e60-bdd6-ec14419b4ff6")) __declspec(novtable) IRepeatButtonAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::Primitives::IRepeatButton * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IRepeatButtonAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("c69f5c04-16ee-467a-a833-c3da8458ad64")) __declspec(novtable) IRichEditBoxAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("752c8399-d296-4d87-9020-a4750e885b3c")) __declspec(novtable) IRichEditBoxAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IRichEditBox * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IRichEditBoxAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("93a01a9c-9609-41fa-82f3-909c09f49a72")) __declspec(novtable) IRichTextBlockAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("2038ae61-1389-467a-aed6-37334da9622b")) __declspec(novtable) IRichTextBlockAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IRichTextBlock * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IRichTextBlockAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("8c9a409a-2736-437b-ab36-a16a202f105d")) __declspec(novtable) IRichTextBlockOverflowAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("bd5eb663-2c14-4665-adef-f2b033947beb")) __declspec(novtable) IRichTextBlockOverflowAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IRichTextBlockOverflow * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IRichTextBlockOverflowAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("69e0c369-bbe7-41f2-87ca-aad813fe550e")) __declspec(novtable) IScrollBarAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("e1302110-afeb-4595-8e3d-edc0844a2b21")) __declspec(novtable) IScrollBarAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::Primitives::IScrollBar * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IScrollBarAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("d985f259-1b09-4e88-88fd-421750dc6b45")) __declspec(novtable) IScrollViewerAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("270dff7d-d96d-48f9-a36a-c252aa9c4670")) __declspec(novtable) IScrollViewerAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IScrollViewer * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IScrollViewerAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("854011a4-18a6-4f30-939b-8871afa3f5e9")) __declspec(novtable) ISearchBoxAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("b3c01430-7faa-41bb-8e91-7c761c5267f1")) __declspec(novtable) ISearchBoxAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::ISearchBox * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::ISearchBoxAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("162ac829-7115-43ec-b383-a7b71644069d")) __declspec(novtable) ISelectorAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("7b525646-829b-4dcc-bd52-5a8d0399387a")) __declspec(novtable) ISelectorAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::Primitives::ISelector * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::ISelectorAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("ae8b3477-860a-45bb-bf7c-e1b27419d1dd")) __declspec(novtable) ISelectorItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("66d7edfb-786d-4362-a964-ebfb21776c30")) __declspec(novtable) ISelectorItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithParentAndItem(Windows::IInspectable * item, Windows::UI::Xaml::Automation::Peers::ISelectorAutomationPeer * parent, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::ISelectorItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("3c2fac6c-a977-47fc-b44e-2754c0b2bea9")) __declspec(novtable) ISemanticZoomAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("f518d44d-a493-4496-b077-9674c7f4c5fa")) __declspec(novtable) ISemanticZoomAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::ISemanticZoom * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::ISemanticZoomAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("d0de0cdb-30cf-47a6-a5eb-9c77f0b0d6dd")) __declspec(novtable) ISettingsFlyoutAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("f94762bd-8a14-40e4-94a7-3f33c922e945")) __declspec(novtable) ISettingsFlyoutAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::ISettingsFlyout * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::ISettingsFlyoutAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("ec30015a-d611-46d0-ae4f-6ecf27dfbaa5")) __declspec(novtable) ISliderAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("971b8056-9a7a-4df9-95fa-6f5c04c91cac")) __declspec(novtable) ISliderAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::ISlider * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::ISliderAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("be2057f5-6715-4e69-a050-92bd0ce232a9")) __declspec(novtable) ITextBlockAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("76bf924b-7ca0-4b01-bc5c-a8cf4d3691de")) __declspec(novtable) ITextBlockAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::ITextBlock * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::ITextBlockAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("3a4f1ca0-5e5d-4d26-9067-e740bf657a9f")) __declspec(novtable) ITextBoxAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("01f0c067-966b-4130-b872-469e42bd4a7f")) __declspec(novtable) ITextBoxAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::ITextBox * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::ITextBoxAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("dc2949b5-b45e-4d6d-892f-d9422c950efb")) __declspec(novtable) IThumbAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("970743ff-af41-4600-b55d-26d43df860e1")) __declspec(novtable) IThumbAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::Primitives::IThumb * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IThumbAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("a43d44ef-3285-4df7-b4a4-e4cdf36a3a17")) __declspec(novtable) ITimePickerAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("978f6671-47f8-40a7-9e21-68128b16b4fd")) __declspec(novtable) ITimePickerAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::ITimePicker * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::ITimePickerAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("da93ee27-82f1-4701-8706-be297bf06043")) __declspec(novtable) ITimePickerFlyoutPresenterAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("62dbe6c5-bc0a-45bb-bf77-ea0f1502891f")) __declspec(novtable) IToggleButtonAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("c9218cc4-ad4b-4d03-a6a4-7d59e6360004")) __declspec(novtable) IToggleButtonAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::Primitives::IToggleButton * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IToggleButtonAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("6b57eafe-6af1-4903-8373-3437bf352345")) __declspec(novtable) IToggleMenuFlyoutItemAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("94364b77-8f6c-4837-aae3-94d010d8d162")) __declspec(novtable) IToggleMenuFlyoutItemAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IToggleMenuFlyoutItem * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IToggleMenuFlyoutItemAutomationPeer ** instance) = 0;
};

struct __declspec(uuid("c011f174-e89e-4790-bf9a-78ebb5f59e9f")) __declspec(novtable) IToggleSwitchAutomationPeer : Windows::IInspectable
{
};

struct __declspec(uuid("31f933e3-fef8-4419-9df5-d9ef7196ea34")) __declspec(novtable) IToggleSwitchAutomationPeerFactory : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_CreateInstanceWithOwner(Windows::UI::Xaml::Controls::IToggleSwitch * owner, Windows::IInspectable * outer, Windows::IInspectable ** inner, Windows::UI::Xaml::Automation::Peers::IToggleSwitchAutomationPeer ** instance) = 0;
};
...
template <typename T> class impl_IAppBarAutomationPeer;
template <typename T> class impl_IAppBarAutomationPeerFactory;
template <typename T> class impl_IAppBarButtonAutomationPeer;
template <typename T> class impl_IAppBarButtonAutomationPeerFactory;
template <typename T> class impl_IAppBarToggleButtonAutomationPeer;
template <typename T> class impl_IAppBarToggleButtonAutomationPeerFactory;
template <typename T> class impl_IAutoSuggestBoxAutomationPeer;
template <typename T> class impl_IAutoSuggestBoxAutomationPeerFactory;
template <typename T> class impl_IAutomationPeer;
template <typename T> class impl_IAutomationPeer2;
template <typename T> class impl_IAutomationPeer3;
template <typename T> class impl_IAutomationPeer4;
template <typename T> class impl_IAutomationPeer5;
template <typename T> class impl_IAutomationPeerAnnotation;
template <typename T> class impl_IAutomationPeerAnnotationFactory;
template <typename T> class impl_IAutomationPeerAnnotationStatics;
template <typename T> class impl_IAutomationPeerFactory;
template <typename T> class impl_IAutomationPeerOverrides;
template <typename T> class impl_IAutomationPeerOverrides2;
template <typename T> class impl_IAutomationPeerOverrides3;
template <typename T> class impl_IAutomationPeerOverrides4;
template <typename T> class impl_IAutomationPeerOverrides5;
template <typename T> class impl_IAutomationPeerProtected;
template <typename T> class impl_IAutomationPeerStatics;
template <typename T> class impl_IAutomationPeerStatics3;
template <typename T> class impl_IButtonAutomationPeer;
template <typename T> class impl_IButtonAutomationPeerFactory;
template <typename T> class impl_IButtonBaseAutomationPeer;
template <typename T> class impl_IButtonBaseAutomationPeerFactory;
template <typename T> class impl_ICaptureElementAutomationPeer;
template <typename T> class impl_ICaptureElementAutomationPeerFactory;
template <typename T> class impl_ICheckBoxAutomationPeer;
template <typename T> class impl_ICheckBoxAutomationPeerFactory;
template <typename T> class impl_IComboBoxAutomationPeer;
template <typename T> class impl_IComboBoxAutomationPeerFactory;
template <typename T> class impl_IComboBoxItemAutomationPeer;
template <typename T> class impl_IComboBoxItemAutomationPeerFactory;
template <typename T> class impl_IComboBoxItemDataAutomationPeer;
template <typename T> class impl_IComboBoxItemDataAutomationPeerFactory;
template <typename T> class impl_IDatePickerAutomationPeer;
template <typename T> class impl_IDatePickerAutomationPeerFactory;
template <typename T> class impl_IDatePickerFlyoutPresenterAutomationPeer;
template <typename T> class impl_IFlipViewAutomationPeer;
template <typename T> class impl_IFlipViewAutomationPeerFactory;
template <typename T> class impl_IFlipViewItemAutomationPeer;
template <typename T> class impl_IFlipViewItemAutomationPeerFactory;
template <typename T> class impl_IFlipViewItemDataAutomationPeer;
template <typename T> class impl_IFlipViewItemDataAutomationPeerFactory;
template <typename T> class impl_IFlyoutPresenterAutomationPeer;
template <typename T> class impl_IFlyoutPresenterAutomationPeerFactory;
template <typename T> class impl_IFrameworkElementAutomationPeer;
template <typename T> class impl_IFrameworkElementAutomationPeerFactory;
template <typename T> class impl_IFrameworkElementAutomationPeerStatics;
template <typename T> class impl_IGridViewAutomationPeer;
template <typename T> class impl_IGridViewAutomationPeerFactory;
template <typename T> class impl_IGridViewHeaderItemAutomationPeer;
template <typename T> class impl_IGridViewHeaderItemAutomationPeerFactory;
template <typename T> class impl_IGridViewItemAutomationPeer;
template <typename T> class impl_IGridViewItemAutomationPeerFactory;
template <typename T> class impl_IGridViewItemDataAutomationPeer;
template <typename T> class impl_IGridViewItemDataAutomationPeerFactory;
template <typename T> class impl_IGroupItemAutomationPeer;
template <typename T> class impl_IGroupItemAutomationPeerFactory;
template <typename T> class impl_IHubAutomationPeer;
template <typename T> class impl_IHubAutomationPeerFactory;
template <typename T> class impl_IHubSectionAutomationPeer;
template <typename T> class impl_IHubSectionAutomationPeerFactory;
template <typename T> class impl_IHyperlinkButtonAutomationPeer;
template <typename T> class impl_IHyperlinkButtonAutomationPeerFactory;
template <typename T> class impl_IImageAutomationPeer;
template <typename T> class impl_IImageAutomationPeerFactory;
template <typename T> class impl_IInkToolbarAutomationPeer;
template <typename T> class impl_IItemAutomationPeer;
template <typename T> class impl_IItemAutomationPeerFactory;
template <typename T> class impl_IItemsControlAutomationPeer;
template <typename T> class impl_IItemsControlAutomationPeer2;
template <typename T> class impl_IItemsControlAutomationPeerFactory;
template <typename T> class impl_IItemsControlAutomationPeerOverrides2;
template <typename T> class impl_IListBoxAutomationPeer;
template <typename T> class impl_IListBoxAutomationPeerFactory;
template <typename T> class impl_IListBoxItemAutomationPeer;
template <typename T> class impl_IListBoxItemAutomationPeerFactory;
template <typename T> class impl_IListBoxItemDataAutomationPeer;
template <typename T> class impl_IListBoxItemDataAutomationPeerFactory;
template <typename T> class impl_IListPickerFlyoutPresenterAutomationPeer;
template <typename T> class impl_IListViewAutomationPeer;
template <typename T> class impl_IListViewAutomationPeerFactory;
template <typename T> class impl_IListViewBaseAutomationPeer;
template <typename T> class impl_IListViewBaseAutomationPeerFactory;
template <typename T> class impl_IListViewBaseHeaderItemAutomationPeer;
template <typename T> class impl_IListViewBaseHeaderItemAutomationPeerFactory;
template <typename T> class impl_IListViewHeaderItemAutomationPeer;
template <typename T> class impl_IListViewHeaderItemAutomationPeerFactory;
template <typename T> class impl_IListViewItemAutomationPeer;
template <typename T> class impl_IListViewItemAutomationPeerFactory;
template <typename T> class impl_IListViewItemDataAutomationPeer;
template <typename T> class impl_IListViewItemDataAutomationPeerFactory;
template <typename T> class impl_ILoopingSelectorAutomationPeer;
template <typename T> class impl_ILoopingSelectorItemAutomationPeer;
template <typename T> class impl_ILoopingSelectorItemDataAutomationPeer;
template <typename T> class impl_IMapControlAutomationPeer;
template <typename T> class impl_IMediaElementAutomationPeer;
template <typename T> class impl_IMediaElementAutomationPeerFactory;
template <typename T> class impl_IMediaPlayerElementAutomationPeer;
template <typename T> class impl_IMediaPlayerElementAutomationPeerFactory;
template <typename T> class impl_IMediaTransportControlsAutomationPeer;
template <typename T> class impl_IMediaTransportControlsAutomationPeerFactory;
template <typename T> class impl_IMenuFlyoutItemAutomationPeer;
template <typename T> class impl_IMenuFlyoutItemAutomationPeerFactory;
template <typename T> class impl_IMenuFlyoutPresenterAutomationPeer;
template <typename T> class impl_IMenuFlyoutPresenterAutomationPeerFactory;
template <typename T> class impl_IPasswordBoxAutomationPeer;
template <typename T> class impl_IPasswordBoxAutomationPeerFactory;
template <typename T> class impl_IPickerFlyoutPresenterAutomationPeer;
template <typename T> class impl_IPivotAutomationPeer;
template <typename T> class impl_IPivotAutomationPeerFactory;
template <typename T> class impl_IPivotItemAutomationPeer;
template <typename T> class impl_IPivotItemAutomationPeerFactory;
template <typename T> class impl_IPivotItemDataAutomationPeer;
template <typename T> class impl_IPivotItemDataAutomationPeerFactory;
template <typename T> class impl_IProgressBarAutomationPeer;
template <typename T> class impl_IProgressBarAutomationPeerFactory;
template <typename T> class impl_IProgressRingAutomationPeer;
template <typename T> class impl_IProgressRingAutomationPeerFactory;
template <typename T> class impl_IRadioButtonAutomationPeer;
template <typename T> class impl_IRadioButtonAutomationPeerFactory;
template <typename T> class impl_IRangeBaseAutomationPeer;
template <typename T> class impl_IRangeBaseAutomationPeerFactory;
template <typename T> class impl_IRepeatButtonAutomationPeer;
template <typename T> class impl_IRepeatButtonAutomationPeerFactory;
template <typename T> class impl_IRichEditBoxAutomationPeer;
template <typename T> class impl_IRichEditBoxAutomationPeerFactory;
template <typename T> class impl_IRichTextBlockAutomationPeer;
template <typename T> class impl_IRichTextBlockAutomationPeerFactory;
template <typename T> class impl_IRichTextBlockOverflowAutomationPeer;
template <typename T> class impl_IRichTextBlockOverflowAutomationPeerFactory;
template <typename T> class impl_IScrollBarAutomationPeer;
template <typename T> class impl_IScrollBarAutomationPeerFactory;
template <typename T> class impl_IScrollViewerAutomationPeer;
template <typename T> class impl_IScrollViewerAutomationPeerFactory;
template <typename T> class impl_ISearchBoxAutomationPeer;
template <typename T> class impl_ISearchBoxAutomationPeerFactory;
template <typename T> class impl_ISelectorAutomationPeer;
template <typename T> class impl_ISelectorAutomationPeerFactory;
template <typename T> class impl_ISelectorItemAutomationPeer;
template <typename T> class impl_ISelectorItemAutomationPeerFactory;
template <typename T> class impl_ISemanticZoomAutomationPeer;
template <typename T> class impl_ISemanticZoomAutomationPeerFactory;
template <typename T> class impl_ISettingsFlyoutAutomationPeer;
template <typename T> class impl_ISettingsFlyoutAutomationPeerFactory;
template <typename T> class impl_ISliderAutomationPeer;
template <typename T> class impl_ISliderAutomationPeerFactory;
template <typename T> class impl_ITextBlockAutomationPeer;
template <typename T> class impl_ITextBlockAutomationPeerFactory;
template <typename T> class impl_ITextBoxAutomationPeer;
template <typename T> class impl_ITextBoxAutomationPeerFactory;
template <typename T> class impl_IThumbAutomationPeer;
template <typename T> class impl_IThumbAutomationPeerFactory;
template <typename T> class impl_ITimePickerAutomationPeer;
template <typename T> class impl_ITimePickerAutomationPeerFactory;
template <typename T> class impl_ITimePickerFlyoutPresenterAutomationPeer;
template <typename T> class impl_IToggleButtonAutomationPeer;
template <typename T> class impl_IToggleButtonAutomationPeerFactory;
template <typename T> class impl_IToggleMenuFlyoutItemAutomationPeer;
template <typename T> class impl_IToggleMenuFlyoutItemAutomationPeerFactory;
template <typename T> class impl_IToggleSwitchAutomationPeer;
template <typename T> class impl_IToggleSwitchAutomationPeerFactory;
