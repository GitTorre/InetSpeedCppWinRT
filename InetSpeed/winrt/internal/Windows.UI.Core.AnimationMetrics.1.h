...
template <typename T> class impl_IAnimationDescription;
template <typename T> class impl_IAnimationDescriptionFactory;
template <typename T> class impl_IOpacityAnimation;
template <typename T> class impl_IPropertyAnimation;
template <typename T> class impl_IScaleAnimation;
...
template <> struct traits<Windows::UI::Core::AnimationMetrics::AnimationDescription>
{
    ...
    using default_interface = Windows::UI::Core::AnimationMetrics::IAnimationDescription;
...
template <> struct traits<Windows::UI::Core::AnimationMetrics::OpacityAnimation>
{
    ...
    using default_interface = Windows::UI::Core::AnimationMetrics::IOpacityAnimation;
...
template <> struct traits<Windows::UI::Core::AnimationMetrics::PropertyAnimation>
{
    ...
    using default_interface = Windows::UI::Core::AnimationMetrics::IPropertyAnimation;
...
template <> struct traits<Windows::UI::Core::AnimationMetrics::ScaleAnimation>
{
    ...
    using default_interface = Windows::UI::Core::AnimationMetrics::IScaleAnimation;
