...
struct __declspec(uuid("6a0b5ffc-63b4-480f-9e6a-8a92816aade4")) __declspec(novtable) IDtdEntity : Windows::IInspectable
{
    virtual HRESULT __stdcall get_PublicId(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall get_SystemId(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall get_NotationName(Windows::IInspectable ** value) = 0;
};

struct __declspec(uuid("8cb4e04d-6d46-4edb-ab73-df83c51ad397")) __declspec(novtable) IDtdNotation : Windows::IInspectable
{
    virtual HRESULT __stdcall get_PublicId(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall get_SystemId(Windows::IInspectable ** value) = 0;
};

struct __declspec(uuid("ac144aa4-b4f1-4db6-b206-8a22c308db0a")) __declspec(novtable) IXmlAttribute : Windows::IInspectable
{
...
struct __declspec(uuid("4d04b46f-c8bd-45b4-8899-0400d7c2c60f")) __declspec(novtable) IXmlCDataSection : Windows::IInspectable
{
};

struct __declspec(uuid("132e42ab-4e36-4df6-b1c8-0ce62fd88b26")) __declspec(novtable) IXmlCharacterData : Windows::IInspectable
{
...
struct __declspec(uuid("bca474d5-b61f-4611-9cac-2e92e3476d47")) __declspec(novtable) IXmlComment : Windows::IInspectable
{
};

struct __declspec(uuid("f7f3a506-1e87-42d6-bcfb-b8c809fa5494")) __declspec(novtable) IXmlDocument : Windows::IInspectable
{
    ...
    virtual HRESULT __stdcall abi_CreateAttributeNS(Windows::IInspectable * namespaceUri, hstring qualifiedName, Windows::Data::Xml::Dom::IXmlAttribute ** newAttribute) = 0;
    virtual HRESULT __stdcall abi_CreateElementNS(Windows::IInspectable * namespaceUri, hstring qualifiedName, Windows::Data::Xml::Dom::IXmlElement ** newElement) = 0;
...
struct __declspec(uuid("e2ea6a96-0c21-44a5-8bc9-9e4a262708ec")) __declspec(novtable) IXmlDocumentFragment : Windows::IInspectable
{
};

struct __declspec(uuid("6cd0e74e-ee65-4489-9ebf-ca43e87ba637")) __declspec(novtable) IXmlDocumentIO : Windows::IInspectable
{
...
struct __declspec(uuid("5d034661-7bd8-4ad5-9ebf-81e6347263b1")) __declspec(novtable) IXmlDocumentIO2 : Windows::IInspectable
{
...
struct __declspec(uuid("5543d254-d757-4b79-9539-232b18f50bf1")) __declspec(novtable) IXmlDocumentStatics : Windows::IInspectable
{
...
struct __declspec(uuid("f7342425-9781-4964-8e94-9b1c6dfc9bc7")) __declspec(novtable) IXmlDocumentType : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Name(hstring * value) = 0;
...
struct __declspec(uuid("6de58132-f11d-4fbb-8cc6-583cba93112f")) __declspec(novtable) IXmlDomImplementation : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_HasFeature(hstring feature, Windows::IInspectable * version, bool * featureSupported) = 0;
};

struct __declspec(uuid("2dfb8a1f-6b10-4ef8-9f83-efcce8faec37")) __declspec(novtable) IXmlElement : Windows::IInspectable
{
    ...
    virtual HRESULT __stdcall abi_GetElementsByTagName(hstring tagName, Windows::Data::Xml::Dom::IXmlNodeList ** elements) = 0;
    virtual HRESULT __stdcall abi_SetAttributeNS(Windows::IInspectable * namespaceUri, hstring qualifiedName, hstring value) = 0;
    virtual HRESULT __stdcall abi_GetAttributeNS(Windows::IInspectable * namespaceUri, hstring localName, hstring * value) = 0;
    virtual HRESULT __stdcall abi_RemoveAttributeNS(Windows::IInspectable * namespaceUri, hstring localName) = 0;
    ...
    virtual HRESULT __stdcall abi_GetAttributeNodeNS(Windows::IInspectable * namespaceUri, hstring localName, Windows::Data::Xml::Dom::IXmlAttribute ** previousAttribute) = 0;
};

struct __declspec(uuid("2e2f47bc-c3d0-4ccf-bb86-0ab8c36a61cf")) __declspec(novtable) IXmlEntityReference : Windows::IInspectable
{
};

struct __declspec(uuid("58aa07a8-fed6-46f7-b4c5-fb1ba72108d6")) __declspec(novtable) IXmlLoadSettings : Windows::IInspectable
{
...
struct __declspec(uuid("b3a69eb0-aab0-4b82-a6fa-b1453f7c021b")) __declspec(novtable) IXmlNamedNodeMap : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Length(uint32_t * value) = 0;
    ...
    virtual HRESULT __stdcall abi_GetNamedItemNS(Windows::IInspectable * namespaceUri, hstring name, Windows::Data::Xml::Dom::IXmlNode ** node) = 0;
    virtual HRESULT __stdcall abi_RemoveNamedItemNS(Windows::IInspectable * namespaceUri, hstring name, Windows::Data::Xml::Dom::IXmlNode ** previousNode) = 0;
...
struct __declspec(uuid("1c741d59-2122-47d5-a856-83f3d4214875")) __declspec(novtable) IXmlNode : Windows::IInspectable
{
    virtual HRESULT __stdcall get_NodeValue(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall put_NodeValue(Windows::IInspectable * value) = 0;
    ...
    virtual HRESULT __stdcall get_NamespaceUri(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall get_LocalName(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall get_Prefix(Windows::IInspectable ** value) = 0;
    virtual HRESULT __stdcall abi_Normalize() = 0;
    virtual HRESULT __stdcall put_Prefix(Windows::IInspectable * value) = 0;
};

struct __declspec(uuid("8c60ad77-83a4-4ec1-9c54-7ba429e13da6")) __declspec(novtable) IXmlNodeList : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Length(uint32_t * value) = 0;
    virtual HRESULT __stdcall abi_Item(uint32_t index, Windows::Data::Xml::Dom::IXmlNode ** node) = 0;
};

struct __declspec(uuid("63dbba8b-d0db-4fe1-b745-f9433afdc25b")) __declspec(novtable) IXmlNodeSelector : Windows::IInspectable
{
    ...
    virtual HRESULT __stdcall abi_SelectSingleNodeNS(hstring xpath, Windows::IInspectable * namespaces, Windows::Data::Xml::Dom::IXmlNode ** node) = 0;
    virtual HRESULT __stdcall abi_SelectNodesNS(hstring xpath, Windows::IInspectable * namespaces, Windows::Data::Xml::Dom::IXmlNodeList ** nodelist) = 0;
};

struct __declspec(uuid("5cc5b382-e6dd-4991-abef-06d8d2e7bd0c")) __declspec(novtable) IXmlNodeSerializer : Windows::IInspectable
{
...
struct __declspec(uuid("2707fd1e-1e92-4ece-b6f4-26f069078ddc")) __declspec(novtable) IXmlProcessingInstruction : Windows::IInspectable
{
...
struct __declspec(uuid("f931a4cb-308d-4760-a1d5-43b67450ac7e")) __declspec(novtable) IXmlText : Windows::IInspectable
{
