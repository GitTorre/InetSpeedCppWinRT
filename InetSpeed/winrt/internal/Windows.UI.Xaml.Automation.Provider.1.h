...
template <typename T> class impl_IAnnotationProvider;
template <typename T> class impl_ICustomNavigationProvider;
template <typename T> class impl_IDockProvider;
template <typename T> class impl_IDragProvider;
template <typename T> class impl_IDropTargetProvider;
template <typename T> class impl_IExpandCollapseProvider;
template <typename T> class impl_IGridItemProvider;
template <typename T> class impl_IGridProvider;
template <typename T> class impl_IIRawElementProviderSimple;
template <typename T> class impl_IInvokeProvider;
template <typename T> class impl_IItemContainerProvider;
template <typename T> class impl_IMultipleViewProvider;
template <typename T> class impl_IObjectModelProvider;
template <typename T> class impl_IRangeValueProvider;
template <typename T> class impl_IScrollItemProvider;
template <typename T> class impl_IScrollProvider;
template <typename T> class impl_ISelectionItemProvider;
template <typename T> class impl_ISelectionProvider;
template <typename T> class impl_ISpreadsheetItemProvider;
template <typename T> class impl_ISpreadsheetProvider;
template <typename T> class impl_IStylesProvider;
template <typename T> class impl_ISynchronizedInputProvider;
template <typename T> class impl_ITableItemProvider;
template <typename T> class impl_ITableProvider;
template <typename T> class impl_ITextChildProvider;
template <typename T> class impl_ITextEditProvider;
template <typename T> class impl_ITextProvider;
template <typename T> class impl_ITextProvider2;
template <typename T> class impl_ITextRangeProvider;
template <typename T> class impl_ITextRangeProvider2;
template <typename T> class impl_IToggleProvider;
template <typename T> class impl_ITransformProvider;
template <typename T> class impl_ITransformProvider2;
template <typename T> class impl_IValueProvider;
template <typename T> class impl_IVirtualizedItemProvider;
template <typename T> class impl_IWindowProvider;
