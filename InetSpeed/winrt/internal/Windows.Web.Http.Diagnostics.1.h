...
struct __declspec(uuid("bd811501-a056-4d39-b174-833b7b03b02c")) __declspec(novtable) IHttpDiagnosticProvider : Windows::IInspectable
{
...
struct __declspec(uuid("735f98ee-94f6-4532-b26e-61e1b1e4efd4")) __declspec(novtable) IHttpDiagnosticProviderRequestResponseCompletedEventArgs : Windows::IInspectable
{
...
struct __declspec(uuid("e0afde10-55cf-4c01-91d4-a20557d849f0")) __declspec(novtable) IHttpDiagnosticProviderRequestResponseTimestamps : Windows::IInspectable
{
...
struct __declspec(uuid("3f5196d0-4c1f-4ebe-a57a-06930771c50d")) __declspec(novtable) IHttpDiagnosticProviderRequestSentEventArgs : Windows::IInspectable
{
...
struct __declspec(uuid("a0a2566c-ab5f-4d66-bb2d-084cf41635d0")) __declspec(novtable) IHttpDiagnosticProviderResponseReceivedEventArgs : Windows::IInspectable
{
    virtual HRESULT __stdcall get_Timestamp(Windows::Foundation::DateTime * value) = 0;
    virtual HRESULT __stdcall get_ActivityId(GUID * value) = 0;
...
struct __declspec(uuid("5b824ec1-6a6c-47cc-afec-1e86bc26053b")) __declspec(novtable) IHttpDiagnosticProviderStatics : Windows::IInspectable
{
...
struct __declspec(uuid("54a9d260-8860-423f-b6fa-d77716f647a7")) __declspec(novtable) IHttpDiagnosticSourceLocation : Windows::IInspectable
{
...
template <typename T> class impl_IHttpDiagnosticProvider;
template <typename T> class impl_IHttpDiagnosticProviderRequestResponseCompletedEventArgs;
template <typename T> class impl_IHttpDiagnosticProviderRequestResponseTimestamps;
template <typename T> class impl_IHttpDiagnosticProviderRequestSentEventArgs;
template <typename T> class impl_IHttpDiagnosticProviderResponseReceivedEventArgs;
template <typename T> class impl_IHttpDiagnosticProviderStatics;
template <typename T> class impl_IHttpDiagnosticSourceLocation;
...
template <> struct traits<Windows::Web::Http::Diagnostics::HttpDiagnosticProvider>
{
    ...
    using default_interface = Windows::Web::Http::Diagnostics::IHttpDiagnosticProvider;
...
template <> struct traits<Windows::Web::Http::Diagnostics::HttpDiagnosticProviderRequestResponseCompletedEventArgs>
{
    ...
    using default_interface = Windows::Web::Http::Diagnostics::IHttpDiagnosticProviderRequestResponseCompletedEventArgs;
...
template <> struct traits<Windows::Web::Http::Diagnostics::HttpDiagnosticProviderRequestResponseTimestamps>
{
    ...
    using default_interface = Windows::Web::Http::Diagnostics::IHttpDiagnosticProviderRequestResponseTimestamps;
...
template <> struct traits<Windows::Web::Http::Diagnostics::HttpDiagnosticProviderRequestSentEventArgs>
{
    ...
    using default_interface = Windows::Web::Http::Diagnostics::IHttpDiagnosticProviderRequestSentEventArgs;
...
template <> struct traits<Windows::Web::Http::Diagnostics::HttpDiagnosticProviderResponseReceivedEventArgs>
{
    ...
    using default_interface = Windows::Web::Http::Diagnostics::IHttpDiagnosticProviderResponseReceivedEventArgs;
...
template <> struct traits<Windows::Web::Http::Diagnostics::HttpDiagnosticSourceLocation>
{
    ...
    using default_interface = Windows::Web::Http::Diagnostics::IHttpDiagnosticSourceLocation;
