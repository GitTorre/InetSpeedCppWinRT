...
template <typename T> class impl_ISmsBinaryMessage;
template <typename T> class impl_ISmsBroadcastMessage;
template <typename T> class impl_ISmsDevice;
template <typename T> class impl_ISmsDevice2;
template <typename T> class impl_ISmsDevice2Statics;
template <typename T> class impl_ISmsDeviceMessageStore;
template <typename T> class impl_ISmsDeviceStatics;
template <typename T> class impl_ISmsDeviceStatics2;
...
template <typename T> class impl_ISmsMessage;
template <typename T> class impl_ISmsMessageBase;
template <typename T> class impl_ISmsMessageReceivedEventArgs;
...
template <typename T> class impl_ISmsReceivedEventDetails;
template <typename T> class impl_ISmsReceivedEventDetails2;
template <typename T> class impl_ISmsSendMessageResult;
template <typename T> class impl_ISmsStatusMessage;
template <typename T> class impl_ISmsTextMessage;
template <typename T> class impl_ISmsTextMessage2;
template <typename T> class impl_ISmsTextMessageStatics;
...
template <> struct traits<Windows::Devices::Sms::GetSmsMessagesOperation>
{
    ...
    using default_interface = Windows::Foundation::IAsyncOperationWithProgress<Windows::Foundation::Collections::IVectorView<Windows::Devices::Sms::ISmsMessage>, int32_t>;
