...
template <typename T> class impl_IClassicAppManagerStatics;
template <typename T> class impl_IInstalledClassicAppInfo;
...
template <> struct traits<Windows::Management::Deployment::Preview::InstalledClassicAppInfo>
{
    ...
    using default_interface = Windows::Management::Deployment::Preview::IInstalledClassicAppInfo;
