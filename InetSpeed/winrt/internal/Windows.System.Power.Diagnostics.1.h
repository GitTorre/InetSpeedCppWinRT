...
struct __declspec(uuid("d7663702-d3a6-46e0-8f9b-50b95bb4f9c5")) __declspec(novtable) IBackgroundEnergyDiagnosticsStatics : Windows::IInspectable
{
...
struct __declspec(uuid("23ca0917-cd07-4609-be15-8fe894c5e41e")) __declspec(novtable) IForegroundEnergyDiagnosticsStatics : Windows::IInspectable
{
    virtual HRESULT __stdcall get_DeviceSpecificConversionFactor(double * value) = 0;
    virtual HRESULT __stdcall abi_ComputeTotalEnergyUsage(uint64_t * value) = 0;
    virtual HRESULT __stdcall abi_ResetTotalEnergyUsage() = 0;
