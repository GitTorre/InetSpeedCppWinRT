...
struct __declspec(uuid("a714944a-1619-4fc6-b31b-89512ef022a2")) __declspec(novtable) IXamlUIPresenter : Windows::IInspectable
{
...
struct __declspec(uuid("aafb84cd-9f6d-4f80-ac2c-0e6cb9f31659")) __declspec(novtable) IXamlUIPresenterHost : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_ResolveFileResource(hstring path, hstring * returnValue) = 0;
};

struct __declspec(uuid("61595672-7ca4-4a21-b56a-88f4812388ca")) __declspec(novtable) IXamlUIPresenterHost2 : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_GetGenericXamlFilePath(hstring * returnValue) = 0;
};

struct __declspec(uuid("b14292bf-7320-41bb-9f26-4d6fd34db45a")) __declspec(novtable) IXamlUIPresenterHost3 : Windows::IInspectable
{
    virtual HRESULT __stdcall abi_ResolveDictionaryResource(Windows::UI::Xaml::IResourceDictionary * dictionary, Windows::IInspectable * dictionaryKey, Windows::IInspectable * suggestedValue, Windows::IInspectable ** returnValue) = 0;
};

struct __declspec(uuid("71eaeac8-45e1-4192-85aa-3a422edd23cf")) __declspec(novtable) IXamlUIPresenterStatics : Windows::IInspectable
{
...
struct __declspec(uuid("5c6b68d2-cf1c-4f53-bf09-6a745f7a9703")) __declspec(novtable) IXamlUIPresenterStatics2 : Windows::IInspectable
{
...
template <typename T> class impl_IXamlUIPresenter;
template <typename T> class impl_IXamlUIPresenterHost;
template <typename T> class impl_IXamlUIPresenterHost2;
template <typename T> class impl_IXamlUIPresenterHost3;
template <typename T> class impl_IXamlUIPresenterStatics;
template <typename T> class impl_IXamlUIPresenterStatics2;
...
template <> struct traits<Windows::UI::Xaml::Hosting::XamlUIPresenter>
{
    ...
    using default_interface = Windows::UI::Xaml::Hosting::IXamlUIPresenter;
