...
template <typename T> class impl_ICallControl;
template <typename T> class impl_ICallControlStatics;
template <typename T> class impl_IDefaultAudioDeviceChangedEventArgs;
template <typename T> class impl_IDialRequestedEventArgs;
...
template <typename T> class impl_IKeypadPressedEventArgs;
...
template <typename T> class impl_IRedialRequestedEventArgs;
...
template <> struct traits<Windows::Media::Devices::CallControl>
{
    ...
    using default_interface = Windows::Media::Devices::ICallControl;
...
template <> struct traits<Windows::Media::Devices::DialRequestedEventArgs>
{
    ...
    using default_interface = Windows::Media::Devices::IDialRequestedEventArgs;
...
template <> struct traits<Windows::Media::Devices::KeypadPressedEventArgs>
{
    ...
    using default_interface = Windows::Media::Devices::IKeypadPressedEventArgs;
...
template <> struct traits<Windows::Media::Devices::RedialRequestedEventArgs>
{
    ...
    using default_interface = Windows::Media::Devices::IRedialRequestedEventArgs;
