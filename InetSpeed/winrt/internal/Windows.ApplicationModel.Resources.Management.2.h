...
template <typename D>
class WINRT_EBO impl_IIndexedResourceCandidate
{
    auto shim() const { return impl::shim<D, IIndexedResourceCandidate>(this); }
...
template <typename D>
class WINRT_EBO impl_IIndexedResourceQualifier
{
    auto shim() const { return impl::shim<D, IIndexedResourceQualifier>(this); }
...
template <typename D>
class WINRT_EBO impl_IResourceIndexer
{
    auto shim() const { return impl::shim<D, IResourceIndexer>(this); }
...
template <typename D>
class WINRT_EBO impl_IResourceIndexerFactory
{
    auto shim() const { return impl::shim<D, IResourceIndexerFactory>(this); }
...
template <typename D>
class WINRT_EBO impl_IResourceIndexerFactory2
{
    auto shim() const { return impl::shim<D, IResourceIndexerFactory2>(this); }
