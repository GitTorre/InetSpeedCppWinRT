...
struct __declspec(uuid("d784837f-1100-3c6b-a455-f6262cc331b6")) __declspec(novtable) IFullTrustProcessLauncherStatics : Windows::IInspectable
{
...
struct __declspec(uuid("f75c23c8-b5f2-4f6c-88dd-36cb1d599d17")) __declspec(novtable) IStartupTask : Windows::IInspectable
{
...
struct __declspec(uuid("ee5b60bd-a148-41a7-b26e-e8b88a1e62f8")) __declspec(novtable) IStartupTaskStatics : Windows::IInspectable
{
...
template <typename T> class impl_IFullTrustProcessLauncherStatics;
...
template <typename T> class impl_IStartupTask;
template <typename T> class impl_IStartupTaskStatics;
...
template <> struct traits<Windows::ApplicationModel::StartupTask>
{
    ...
    using default_interface = Windows::ApplicationModel::IStartupTask;
