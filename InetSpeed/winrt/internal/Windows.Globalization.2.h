...
template <typename D>
class WINRT_EBO impl_IJapanesePhoneme
{
    auto shim() const { return impl::shim<D, IJapanesePhoneme>(this); }
...
template <typename D>
class WINRT_EBO impl_IJapanesePhoneticAnalyzerStatics
{
    auto shim() const { return impl::shim<D, IJapanesePhoneticAnalyzerStatics>(this); }
