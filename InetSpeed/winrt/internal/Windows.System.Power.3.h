...
struct BackgroundEnergyManager
{
    ...
    static event_token RecentEnergyUsageIncreased(const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
    using RecentEnergyUsageIncreased_revoker = factory_event_revoker<IBackgroundEnergyManagerStatics>;
    static RecentEnergyUsageIncreased_revoker RecentEnergyUsageIncreased(auto_revoke_t, const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
    static void RecentEnergyUsageIncreased(event_token token);
    static event_token RecentEnergyUsageReturnedToLow(const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
    using RecentEnergyUsageReturnedToLow_revoker = factory_event_revoker<IBackgroundEnergyManagerStatics>;
    static RecentEnergyUsageReturnedToLow_revoker RecentEnergyUsageReturnedToLow(auto_revoke_t, const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
...
struct PowerManager
{
    ...
    static event_token EnergySaverStatusChanged(const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
    using EnergySaverStatusChanged_revoker = factory_event_revoker<IPowerManagerStatics>;
    static EnergySaverStatusChanged_revoker EnergySaverStatusChanged(auto_revoke_t, const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
    static void EnergySaverStatusChanged(event_token token);
    static Windows::System::Power::BatteryStatus BatteryStatus();
    static event_token BatteryStatusChanged(const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
    using BatteryStatusChanged_revoker = factory_event_revoker<IPowerManagerStatics>;
    static BatteryStatusChanged_revoker BatteryStatusChanged(auto_revoke_t, const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
    static void BatteryStatusChanged(event_token token);
    static Windows::System::Power::PowerSupplyStatus PowerSupplyStatus();
    static event_token PowerSupplyStatusChanged(const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
    using PowerSupplyStatusChanged_revoker = factory_event_revoker<IPowerManagerStatics>;
    static PowerSupplyStatusChanged_revoker PowerSupplyStatusChanged(auto_revoke_t, const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
    static void PowerSupplyStatusChanged(event_token token);
    static int32_t RemainingChargePercent();
    static event_token RemainingChargePercentChanged(const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
    using RemainingChargePercentChanged_revoker = factory_event_revoker<IPowerManagerStatics>;
    static RemainingChargePercentChanged_revoker RemainingChargePercentChanged(auto_revoke_t, const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
    static void RemainingChargePercentChanged(event_token token);
    static Windows::Foundation::TimeSpan RemainingDischargeTime();
    static event_token RemainingDischargeTimeChanged(const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
    using RemainingDischargeTimeChanged_revoker = factory_event_revoker<IPowerManagerStatics>;
    static RemainingDischargeTimeChanged_revoker RemainingDischargeTimeChanged(auto_revoke_t, const Windows::Foundation::EventHandler<Windows::IInspectable> & handler);
