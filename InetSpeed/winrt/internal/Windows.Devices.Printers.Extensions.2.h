...
template <typename D>
class WINRT_EBO impl_IPrintExtensionContextStatic
{
    auto shim() const { return impl::shim<D, IPrintExtensionContextStatic>(this); }
...
template <typename D>
class WINRT_EBO impl_IPrintNotificationEventDetails
{
    auto shim() const { return impl::shim<D, IPrintNotificationEventDetails>(this); }
...
template <typename D>
class WINRT_EBO impl_IPrintTaskConfiguration
{
    auto shim() const { return impl::shim<D, IPrintTaskConfiguration>(this); }
...
template <typename D>
class WINRT_EBO impl_IPrintTaskConfigurationSaveRequest
{
    auto shim() const { return impl::shim<D, IPrintTaskConfigurationSaveRequest>(this); }
...
template <typename D>
class WINRT_EBO impl_IPrintTaskConfigurationSaveRequestedDeferral
{
    auto shim() const { return impl::shim<D, IPrintTaskConfigurationSaveRequestedDeferral>(this); }
...
template <typename D>
class WINRT_EBO impl_IPrintTaskConfigurationSaveRequestedEventArgs
{
    auto shim() const { return impl::shim<D, IPrintTaskConfigurationSaveRequestedEventArgs>(this); }
