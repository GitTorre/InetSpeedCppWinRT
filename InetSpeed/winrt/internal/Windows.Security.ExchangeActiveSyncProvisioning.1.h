...
struct __declspec(uuid("45b72362-dfba-4a9b-aced-6fe2adcb6420")) __declspec(novtable) IEasClientSecurityPolicy : Windows::IInspectable
{
...
struct __declspec(uuid("463c299c-7f19-4c66-b403-cb45dd57a2b3")) __declspec(novtable) IEasComplianceResults : Windows::IInspectable
{
...
struct __declspec(uuid("2fbe60c9-1aa8-47f5-88bb-cb3ef0bffb15")) __declspec(novtable) IEasComplianceResults2 : Windows::IInspectable
{
...
template <typename T> class impl_IEasClientSecurityPolicy;
template <typename T> class impl_IEasComplianceResults;
template <typename T> class impl_IEasComplianceResults2;
...
template <> struct traits<Windows::Security::ExchangeActiveSyncProvisioning::EasClientSecurityPolicy>
{
    ...
    using default_interface = Windows::Security::ExchangeActiveSyncProvisioning::IEasClientSecurityPolicy;
...
template <> struct traits<Windows::Security::ExchangeActiveSyncProvisioning::EasComplianceResults>
{
    ...
    using default_interface = Windows::Security::ExchangeActiveSyncProvisioning::IEasComplianceResults;
