...
template <typename D>
class WINRT_EBO impl_IKeyboardCapabilities
{
    auto shim() const { return impl::shim<D, IKeyboardCapabilities>(this); }
...
template <typename D>
class WINRT_EBO impl_IMouseCapabilities
{
    auto shim() const { return impl::shim<D, IMouseCapabilities>(this); }
...
template <typename D>
class WINRT_EBO impl_IMouseDevice
{
    auto shim() const { return impl::shim<D, IMouseDevice>(this); }
...
template <typename D>
class WINRT_EBO impl_IMouseDeviceStatics
{
    auto shim() const { return impl::shim<D, IMouseDeviceStatics>(this); }
...
template <typename D>
class WINRT_EBO impl_IMouseEventArgs
{
    auto shim() const { return impl::shim<D, IMouseEventArgs>(this); }
...
template <typename D>
class WINRT_EBO impl_IPointerDevice
{
    auto shim() const { return impl::shim<D, IPointerDevice>(this); }
...
template <typename D>
class WINRT_EBO impl_IPointerDevice2
{
    auto shim() const { return impl::shim<D, IPointerDevice2>(this); }
...
template <typename D>
class WINRT_EBO impl_IPointerDeviceStatics
{
    auto shim() const { return impl::shim<D, IPointerDeviceStatics>(this); }
...
template <typename D>
class WINRT_EBO impl_ITouchCapabilities
{
    auto shim() const { return impl::shim<D, ITouchCapabilities>(this); }
