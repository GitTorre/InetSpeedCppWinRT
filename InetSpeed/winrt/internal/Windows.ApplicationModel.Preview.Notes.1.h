...
template <typename T> class impl_INotePlacementChangedPreviewEventArgs;
template <typename T> class impl_INoteVisibilityChangedPreviewEventArgs;
template <typename T> class impl_INotesWindowManagerPreview;
template <typename T> class impl_INotesWindowManagerPreviewStatics;
...
template <> struct traits<Windows::ApplicationModel::Preview::Notes::NotePlacementChangedPreviewEventArgs>
{
    ...
    using default_interface = Windows::ApplicationModel::Preview::Notes::INotePlacementChangedPreviewEventArgs;
...
template <> struct traits<Windows::ApplicationModel::Preview::Notes::NoteVisibilityChangedPreviewEventArgs>
{
    ...
    using default_interface = Windows::ApplicationModel::Preview::Notes::INoteVisibilityChangedPreviewEventArgs;
...
template <> struct traits<Windows::ApplicationModel::Preview::Notes::NotesWindowManagerPreview>
{
    ...
    using default_interface = Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview;
