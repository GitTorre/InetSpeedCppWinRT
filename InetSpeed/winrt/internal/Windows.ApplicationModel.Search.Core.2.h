...
template <typename D>
class WINRT_EBO impl_IRequestingFocusOnKeyboardInputEventArgs
{
    auto shim() const { return impl::shim<D, IRequestingFocusOnKeyboardInputEventArgs>(this); }
...
template <typename D>
class WINRT_EBO impl_ISearchSuggestion
{
    auto shim() const { return impl::shim<D, ISearchSuggestion>(this); }
...
template <typename D>
class WINRT_EBO impl_ISearchSuggestionManager
{
    auto shim() const { return impl::shim<D, ISearchSuggestionManager>(this); }
...
template <typename D>
class WINRT_EBO impl_ISearchSuggestionsRequestedEventArgs
{
    auto shim() const { return impl::shim<D, ISearchSuggestionsRequestedEventArgs>(this); }
