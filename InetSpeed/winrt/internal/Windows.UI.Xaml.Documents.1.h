...
template <typename T> class impl_IBlock;
template <typename T> class impl_IBlockFactory;
template <typename T> class impl_IBlockStatics;
template <typename T> class impl_IBold;
template <typename T> class impl_IGlyphs;
template <typename T> class impl_IGlyphs2;
template <typename T> class impl_IGlyphsStatics;
template <typename T> class impl_IGlyphsStatics2;
template <typename T> class impl_IHyperlink;
template <typename T> class impl_IHyperlink2;
template <typename T> class impl_IHyperlink3;
template <typename T> class impl_IHyperlinkClickEventArgs;
template <typename T> class impl_IHyperlinkStatics;
template <typename T> class impl_IHyperlinkStatics2;
template <typename T> class impl_IHyperlinkStatics3;
template <typename T> class impl_IInline;
template <typename T> class impl_IInlineFactory;
template <typename T> class impl_IInlineUIContainer;
template <typename T> class impl_IItalic;
template <typename T> class impl_ILineBreak;
template <typename T> class impl_IParagraph;
template <typename T> class impl_IParagraphStatics;
template <typename T> class impl_IRun;
template <typename T> class impl_IRunStatics;
template <typename T> class impl_ISpan;
template <typename T> class impl_ISpanFactory;
template <typename T> class impl_ITextElement;
template <typename T> class impl_ITextElement2;
template <typename T> class impl_ITextElement3;
template <typename T> class impl_ITextElementFactory;
template <typename T> class impl_ITextElementOverrides;
template <typename T> class impl_ITextElementStatics;
template <typename T> class impl_ITextElementStatics2;
template <typename T> class impl_ITextElementStatics3;
template <typename T> class impl_ITextPointer;
template <typename T> class impl_ITypography;
template <typename T> class impl_ITypographyStatics;
template <typename T> class impl_IUnderline;
