...
template <typename T> class impl_ISearchPane;
template <typename T> class impl_ISearchPaneQueryChangedEventArgs;
template <typename T> class impl_ISearchPaneQueryLinguisticDetails;
template <typename T> class impl_ISearchPaneQuerySubmittedEventArgs;
template <typename T> class impl_ISearchPaneQuerySubmittedEventArgsWithLinguisticDetails;
template <typename T> class impl_ISearchPaneResultSuggestionChosenEventArgs;
template <typename T> class impl_ISearchPaneStatics;
template <typename T> class impl_ISearchPaneStaticsWithHideThisApplication;
template <typename T> class impl_ISearchPaneSuggestionsRequest;
template <typename T> class impl_ISearchPaneSuggestionsRequestDeferral;
template <typename T> class impl_ISearchPaneSuggestionsRequestedEventArgs;
template <typename T> class impl_ISearchPaneVisibilityChangedEventArgs;
