...
template <typename D>
class WINRT_EBO impl_IKnownRetailInfoPropertiesStatics
{
    auto shim() const { return impl::shim<D, IKnownRetailInfoPropertiesStatics>(this); }
...
template <typename D>
class WINRT_EBO impl_IRetailInfoStatics
{
    auto shim() const { return impl::shim<D, IRetailInfoStatics>(this); }
