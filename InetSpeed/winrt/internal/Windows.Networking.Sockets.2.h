...
template <typename D>
class WINRT_EBO impl_IControlChannelTrigger
{
    auto shim() const { return impl::shim<D, IControlChannelTrigger>(this); }
...
template <typename D>
class WINRT_EBO impl_IControlChannelTrigger2
{
    auto shim() const { return impl::shim<D, IControlChannelTrigger2>(this); }
...
template <typename D>
class WINRT_EBO impl_IControlChannelTriggerEventDetails
{
    auto shim() const { return impl::shim<D, IControlChannelTriggerEventDetails>(this); }
...
template <typename D>
class WINRT_EBO impl_IControlChannelTriggerFactory
{
    auto shim() const { return impl::shim<D, IControlChannelTriggerFactory>(this); }
...
template <typename D>
class WINRT_EBO impl_IControlChannelTriggerResetEventDetails
{
    auto shim() const { return impl::shim<D, IControlChannelTriggerResetEventDetails>(this); }
