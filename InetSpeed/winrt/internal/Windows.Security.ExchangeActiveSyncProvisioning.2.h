...
template <typename D>
class WINRT_EBO impl_IEasClientSecurityPolicy
{
    auto shim() const { return impl::shim<D, IEasClientSecurityPolicy>(this); }
...
template <typename D>
class WINRT_EBO impl_IEasComplianceResults
{
    auto shim() const { return impl::shim<D, IEasComplianceResults>(this); }
...
template <typename D>
class WINRT_EBO impl_IEasComplianceResults2
{
    auto shim() const { return impl::shim<D, IEasComplianceResults2>(this); }
