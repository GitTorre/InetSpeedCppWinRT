...
template <typename D>
class WINRT_EBO impl_IAnimationDescription
{
    auto shim() const { return impl::shim<D, IAnimationDescription>(this); }
...
template <typename D>
class WINRT_EBO impl_IAnimationDescriptionFactory
{
    auto shim() const { return impl::shim<D, IAnimationDescriptionFactory>(this); }
...
template <typename D>
class WINRT_EBO impl_IOpacityAnimation
{
    auto shim() const { return impl::shim<D, IOpacityAnimation>(this); }
...
template <typename D>
class WINRT_EBO impl_IPropertyAnimation
{
    auto shim() const { return impl::shim<D, IPropertyAnimation>(this); }
...
template <typename D>
class WINRT_EBO impl_IScaleAnimation
{
    auto shim() const { return impl::shim<D, IScaleAnimation>(this); }
