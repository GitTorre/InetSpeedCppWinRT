...
template <typename T> class impl_IRequestingFocusOnKeyboardInputEventArgs;
template <typename T> class impl_ISearchSuggestion;
template <typename T> class impl_ISearchSuggestionManager;
template <typename T> class impl_ISearchSuggestionsRequestedEventArgs;
...
template <> struct traits<Windows::ApplicationModel::Search::Core::RequestingFocusOnKeyboardInputEventArgs>
{
    ...
    using default_interface = Windows::ApplicationModel::Search::Core::IRequestingFocusOnKeyboardInputEventArgs;
...
template <> struct traits<Windows::ApplicationModel::Search::Core::SearchSuggestion>
{
    ...
    using default_interface = Windows::ApplicationModel::Search::Core::ISearchSuggestion;
...
template <> struct traits<Windows::ApplicationModel::Search::Core::SearchSuggestionManager>
{
    ...
    using default_interface = Windows::ApplicationModel::Search::Core::ISearchSuggestionManager;
...
template <> struct traits<Windows::ApplicationModel::Search::Core::SearchSuggestionsRequestedEventArgs>
{
    ...
    using default_interface = Windows::ApplicationModel::Search::Core::ISearchSuggestionsRequestedEventArgs;
