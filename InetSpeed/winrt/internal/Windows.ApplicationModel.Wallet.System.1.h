...
struct __declspec(uuid("522e2bff-96a2-4a17-8d19-fe1d9f837561")) __declspec(novtable) IWalletItemSystemStore : Windows::IInspectable
{
...
struct __declspec(uuid("f98d3a4e-be00-4fdd-9734-6c113c1ac1cb")) __declspec(novtable) IWalletItemSystemStore2 : Windows::IInspectable
{
    virtual HRESULT __stdcall add_ItemsChanged(Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::Wallet::System::WalletItemSystemStore, Windows::IInspectable> * handler, event_token * cookie) = 0;
    virtual HRESULT __stdcall remove_ItemsChanged(event_token cookie) = 0;
};

struct __declspec(uuid("bee8eb89-2634-4b9a-8b23-ee8903c91fe0")) __declspec(novtable) IWalletManagerSystemStatics : Windows::IInspectable
{
