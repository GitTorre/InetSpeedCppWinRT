...
template <typename T> class impl_ICustomDevice;
template <typename T> class impl_ICustomDeviceStatics;
template <typename T> class impl_IIOControlCode;
template <typename T> class impl_IIOControlCodeFactory;
template <typename T> class impl_IKnownDeviceTypesStatics;
...
template <> struct traits<Windows::Devices::Custom::CustomDevice>
{
    ...
    using default_interface = Windows::Devices::Custom::ICustomDevice;
...
template <> struct traits<Windows::Devices::Custom::IOControlCode>
{
    ...
    using default_interface = Windows::Devices::Custom::IIOControlCode;
