...
template <typename D>
class WINRT_EBO impl_ICallControl
{
    auto shim() const { return impl::shim<D, ICallControl>(this); }

public:

    uint64_t IndicateNewIncomingCall(bool enableRinger, hstring_ref callerId) const;
...
template <typename D>
class WINRT_EBO impl_ICallControlStatics
{
    auto shim() const { return impl::shim<D, ICallControlStatics>(this); }

public:

    Windows::Media::Devices::CallControl GetDefault() const;
    Windows::Media::Devices::CallControl FromId(hstring_ref deviceId) const;
};
...
template <typename D>
class WINRT_EBO impl_IDialRequestedEventArgs
{
    auto shim() const { return impl::shim<D, IDialRequestedEventArgs>(this); }

public:

    void Handled() const;
    Windows::IInspectable Contact() const;
};
...
template <typename D>
class WINRT_EBO impl_IKeypadPressedEventArgs
{
    auto shim() const { return impl::shim<D, IKeypadPressedEventArgs>(this); }
...
template <typename D>
class WINRT_EBO impl_IRedialRequestedEventArgs
{
    auto shim() const { return impl::shim<D, IRedialRequestedEventArgs>(this); }
...
struct CallControlEventHandler : Windows::IUnknown
{
    CallControlEventHandler(std::nullptr_t = nullptr) noexcept {}
    auto operator->() const noexcept { return ptr<CallControlEventHandler>(m_ptr); }
...
struct DialRequestedEventHandler : Windows::IUnknown
{
    DialRequestedEventHandler(std::nullptr_t = nullptr) noexcept {}
    auto operator->() const noexcept { return ptr<DialRequestedEventHandler>(m_ptr); }
...
struct KeypadPressedEventHandler : Windows::IUnknown
{
    KeypadPressedEventHandler(std::nullptr_t = nullptr) noexcept {}
    auto operator->() const noexcept { return ptr<KeypadPressedEventHandler>(m_ptr); }
...
struct RedialRequestedEventHandler : Windows::IUnknown
{
    RedialRequestedEventHandler(std::nullptr_t = nullptr) noexcept {}
    auto operator->() const noexcept { return ptr<RedialRequestedEventHandler>(m_ptr); }
    ...
    impl::consume<ICallControl>
{
    ...
    auto operator->() const noexcept { return ptr<ICallControl>(m_ptr); }
};
    ...
    impl::consume<ICallControlStatics>
{
    ...
    auto operator->() const noexcept { return ptr<ICallControlStatics>(m_ptr); }
};
    ...
    impl::consume<IDialRequestedEventArgs>
{
    ...
    auto operator->() const noexcept { return ptr<IDialRequestedEventArgs>(m_ptr); }
};
    ...
    impl::consume<IKeypadPressedEventArgs>
{
    ...
    auto operator->() const noexcept { return ptr<IKeypadPressedEventArgs>(m_ptr); }
};
    ...
    impl::consume<IRedialRequestedEventArgs>
{
    ...
    auto operator->() const noexcept { return ptr<IRedialRequestedEventArgs>(m_ptr); }
};
