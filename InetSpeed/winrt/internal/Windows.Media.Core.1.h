...
template <typename T> class impl_IAudioStreamDescriptor;
template <typename T> class impl_IAudioStreamDescriptor2;
template <typename T> class impl_IAudioStreamDescriptorFactory;
template <typename T> class impl_IAudioTrack;
template <typename T> class impl_IAudioTrackOpenFailedEventArgs;
template <typename T> class impl_IAudioTrackSupportInfo;
template <typename T> class impl_IDataCue;
template <typename T> class impl_IFaceDetectedEventArgs;
template <typename T> class impl_IFaceDetectionEffect;
template <typename T> class impl_IFaceDetectionEffectDefinition;
template <typename T> class impl_IFaceDetectionEffectFrame;
template <typename T> class impl_IHighDynamicRangeControl;
template <typename T> class impl_IHighDynamicRangeOutput;
template <typename T> class impl_IMediaBinder;
template <typename T> class impl_IMediaBindingEventArgs;
template <typename T> class impl_IMediaCue;
template <typename T> class impl_IMediaCueEventArgs;
template <typename T> class impl_IMediaSource;
template <typename T> class impl_IMediaSource2;
template <typename T> class impl_IMediaSource3;
template <typename T> class impl_IMediaSourceError;
template <typename T> class impl_IMediaSourceOpenOperationCompletedEventArgs;
template <typename T> class impl_IMediaSourceStateChangedEventArgs;
template <typename T> class impl_IMediaSourceStatics;
template <typename T> class impl_IMediaSourceStatics2;
template <typename T> class impl_IMediaStreamDescriptor;
template <typename T> class impl_IMediaStreamSample;
template <typename T> class impl_IMediaStreamSampleProtectionProperties;
template <typename T> class impl_IMediaStreamSampleStatics;
template <typename T> class impl_IMediaStreamSource;
template <typename T> class impl_IMediaStreamSource2;
template <typename T> class impl_IMediaStreamSourceClosedEventArgs;
template <typename T> class impl_IMediaStreamSourceClosedRequest;
template <typename T> class impl_IMediaStreamSourceFactory;
template <typename T> class impl_IMediaStreamSourceSampleRenderedEventArgs;
template <typename T> class impl_IMediaStreamSourceSampleRequest;
template <typename T> class impl_IMediaStreamSourceSampleRequestDeferral;
template <typename T> class impl_IMediaStreamSourceSampleRequestedEventArgs;
template <typename T> class impl_IMediaStreamSourceStartingEventArgs;
template <typename T> class impl_IMediaStreamSourceStartingRequest;
template <typename T> class impl_IMediaStreamSourceStartingRequestDeferral;
template <typename T> class impl_IMediaStreamSourceSwitchStreamsRequest;
template <typename T> class impl_IMediaStreamSourceSwitchStreamsRequestDeferral;
template <typename T> class impl_IMediaStreamSourceSwitchStreamsRequestedEventArgs;
template <typename T> class impl_IMediaTrack;
template <typename T> class impl_IMseSourceBuffer;
template <typename T> class impl_IMseSourceBufferList;
template <typename T> class impl_IMseStreamSource;
template <typename T> class impl_IMseStreamSourceStatics;
template <typename T> class impl_ISceneAnalysisEffect;
template <typename T> class impl_ISceneAnalysisEffectFrame;
template <typename T> class impl_ISceneAnalyzedEventArgs;
template <typename T> class impl_ISingleSelectMediaTrackList;
template <typename T> class impl_ITimedMetadataTrack;
template <typename T> class impl_ITimedMetadataTrack2;
template <typename T> class impl_ITimedMetadataTrackError;
template <typename T> class impl_ITimedMetadataTrackFactory;
template <typename T> class impl_ITimedMetadataTrackFailedEventArgs;
template <typename T> class impl_ITimedTextCue;
template <typename T> class impl_ITimedTextLine;
template <typename T> class impl_ITimedTextRegion;
template <typename T> class impl_ITimedTextSource;
template <typename T> class impl_ITimedTextSourceResolveResultEventArgs;
template <typename T> class impl_ITimedTextSourceStatics;
template <typename T> class impl_ITimedTextStyle;
template <typename T> class impl_ITimedTextSubformat;
template <typename T> class impl_IVideoStabilizationEffect;
template <typename T> class impl_IVideoStabilizationEffectEnabledChangedEventArgs;
template <typename T> class impl_IVideoStreamDescriptor;
template <typename T> class impl_IVideoStreamDescriptorFactory;
template <typename T> class impl_IVideoTrack;
template <typename T> class impl_IVideoTrackOpenFailedEventArgs;
template <typename T> class impl_IVideoTrackSupportInfo;
