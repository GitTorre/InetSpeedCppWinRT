...
struct __declspec(uuid("a88214e1-59c7-4a20-aba6-9f6707937230")) __declspec(novtable) IServiceDeviceStatics : Windows::IInspectable
{
...
struct __declspec(uuid("5ece44ee-1b23-4dd2-8652-bc164f003128")) __declspec(novtable) IStorageDeviceStatics : Windows::IInspectable
{
...
template <typename T> class impl_IServiceDeviceStatics;
template <typename T> class impl_IStorageDeviceStatics;
