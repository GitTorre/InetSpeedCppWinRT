...
{
    bool value {};
    check_hresult(shim()->abi_IsTypePresent(get(typeName), &value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->abi_IsMethodPresent(get(typeName), get(methodName), &value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->abi_IsMethodPresentWithArity(get(typeName), get(methodName), inputParameterCount, &value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->abi_IsEventPresent(get(typeName), get(eventName), &value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->abi_IsPropertyPresent(get(typeName), get(propertyName), &value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->abi_IsReadOnlyPropertyPresent(get(typeName), get(propertyName), &value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->abi_IsWriteablePropertyPresent(get(typeName), get(propertyName), &value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->abi_IsEnumNamedValuePresent(get(enumTypeName), get(valueName), &value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->abi_IsApiContractPresentByMajor(get(contractName), majorVersion, &value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->abi_IsApiContractPresentByMajorAndMinor(get(contractName), majorVersion, minorVersion, &value));
    return value;
}
