...
{
    hstring value;
    check_hresult(shim()->get_FullXml(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<winrt::Windows::Media::DialProtocol::DialAppLaunchResult> impl_IDialApp<D>::RequestLaunchAsync(hstring_ref appArgument) const
{
    ...
    check_hresult(shim()->abi_RequestLaunchAsync(get(appArgument), put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Media::DialProtocol::DialAppStateDetails> impl_IDialApp<D>::GetAppStateAsync() const
{
    ...
    check_hresult(shim()->abi_GetAppStateAsync(put(value)));
    return value;
}
...
template <typename D> Windows::Media::DialProtocol::DialApp impl_IDialDevice<D>::GetDialApp(hstring_ref appName) const
{
    ...
    check_hresult(shim()->abi_GetDialApp(get(appName), put(value)));
    return value;
}
...
{
    hstring selector;
    check_hresult(shim()->abi_GetDeviceSelector(get(appName), put(selector)));
    return selector;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<bool> impl_IDialDeviceStatics<D>::DeviceInfoSupportsDialAsync(const Windows::Devices::Enumeration::DeviceInformation & device) const
{
    ...
    check_hresult(shim()->abi_DeviceInfoSupportsDialAsync(get(device), put(operation)));
    return operation;
}
...
template <typename D> Windows::Media::DialProtocol::DialDevice impl_IDialDeviceSelectedEventArgs<D>::SelectedDialDevice() const
{
    ...
    check_hresult(shim()->get_SelectedDialDevice(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVector<hstring> impl_IDialDevicePickerFilter<D>::SupportedAppNames() const
{
    ...
    check_hresult(shim()->get_SupportedAppNames(put(value)));
    return value;
}
...
{
    event_token token {};
    check_hresult(shim()->add_DialDeviceSelected(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_DialDeviceSelected(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_DialDevicePickerDismissed(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_DialDevicePickerDismissed(token));
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Media::DialProtocol::DialDevice> operation;
    check_hresult(shim()->abi_PickSingleDialDeviceAsync(get(selection), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Media::DialProtocol::DialDevice> operation;
    check_hresult(shim()->abi_PickSingleDialDeviceAsyncWithPlacement(get(selection), preferredPlacement, put(operation)));
    return operation;
}
...
{
    check_hresult(shim()->abi_SetDisplayStatus(get(device), status));
}
