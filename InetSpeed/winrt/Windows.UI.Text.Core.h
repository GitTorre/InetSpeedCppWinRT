...
#include "impl\Windows.UI.Text.2.h"
#include "impl\Windows.UI.ViewManagement.2.h"
#include "impl\Windows.UI.Text.Core.2.h"
...
template <typename D> wchar_t consume_Windows_UI_Text_Core_ICoreTextServicesStatics<D>::HiddenCharacter() const
{
    wchar_t value{};
