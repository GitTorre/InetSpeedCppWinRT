...
template <typename D> Windows::Devices::WiFiDirect::Services::WiFiDirectServiceConfigurationMethod impl_IWiFiDirectServiceProvisioningInfo<D>::SelectedConfigurationMethod() const
{
    ...
    check_hresult(shim()->get_SelectedConfigurationMethod(&value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_IsGroupFormationNeeded(&value));
    return value;
}
...
template <typename D> Windows::Storage::Streams::IBuffer impl_IWiFiDirectServiceAutoAcceptSessionConnectedEventArgs<D>::SessionInfo() const
{
    ...
    check_hresult(shim()->get_SessionInfo(put(value)));
    return value;
}
...
{
    Windows::Storage::Streams::IBuffer value;
    check_hresult(shim()->get_DeferredSessionInfo(put(value)));
    return value;
}
...
template <typename D> Windows::Devices::WiFiDirect::Services::WiFiDirectServiceSessionRequest impl_IWiFiDirectServiceSessionRequestedEventArgs<D>::GetSessionRequest() const
{
    ...
    check_hresult(shim()->abi_GetSessionRequest(put(value)));
    return value;
}
...
template <typename D> Windows::Devices::WiFiDirect::Services::WiFiDirectServiceAdvertiser impl_IWiFiDirectServiceAdvertiserFactory<D>::CreateWiFiDirectServiceAdvertiser(hstring_ref serviceName) const
{
    ...
    check_hresult(shim()->abi_CreateWiFiDirectServiceAdvertiser(get(serviceName), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::Collections::IVector<hstring> impl_IWiFiDirectServiceAdvertiser<D>::ServiceNamePrefixes() const
{
    ...
    check_hresult(shim()->get_ServiceNamePrefixes(put(value)));
    return value;
}
...
{
    Windows::Storage::Streams::IBuffer value;
    check_hresult(shim()->get_ServiceInfo(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVector<winrt::Windows::Devices::WiFiDirect::Services::WiFiDirectServiceConfigurationMethod> impl_IWiFiDirectServiceAdvertiser<D>::PreferredConfigurationMethods() const
{
    ...
    check_hresult(shim()->get_PreferredConfigurationMethods(put(value)));
    return value;
}
...
template <typename D> Windows::Devices::WiFiDirect::Services::WiFiDirectServiceStatus impl_IWiFiDirectServiceAdvertiser<D>::ServiceStatus() const
{
    ...
    check_hresult(shim()->get_ServiceStatus(&value));
    return value;
}
...
{
    check_hresult(shim()->put_DeferredSessionInfo(get(value)));
}
...
template <typename D> Windows::Devices::WiFiDirect::Services::WiFiDirectServiceAdvertisementStatus impl_IWiFiDirectServiceAdvertiser<D>::AdvertisementStatus() const
{
    ...
    check_hresult(shim()->get_AdvertisementStatus(&value));
    return value;
}
...
template <typename D> Windows::Devices::WiFiDirect::Services::WiFiDirectServiceError impl_IWiFiDirectServiceAdvertiser<D>::ServiceError() const
{
    ...
    check_hresult(shim()->get_ServiceError(&value));
    return value;
}
...
{
    event_token token {};
    check_hresult(shim()->add_SessionRequested(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_SessionRequested(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_AutoAcceptSessionConnected(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_AutoAcceptSessionConnected(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_AdvertisementStatusChanged(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_AdvertisementStatusChanged(token));
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Devices::WiFiDirect::Services::WiFiDirectServiceSession> impl_IWiFiDirectServiceAdvertiser<D>::ConnectAsync(const Windows::Devices::Enumeration::DeviceInformation & deviceInfo) const
{
    ...
    check_hresult(shim()->abi_ConnectAsync(get(deviceInfo), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Devices::WiFiDirect::Services::WiFiDirectServiceSession> result;
    check_hresult(shim()->abi_ConnectAsyncWithPin(get(deviceInfo), get(pin), put(result)));
    return result;
}
...
template <typename D> hstring impl_IWiFiDirectServiceStatics<D>::GetSelector(hstring_ref serviceName) const
{
    ...
    check_hresult(shim()->abi_GetSelector(get(serviceName), put(serviceSelector)));
...
{
    hstring serviceSelector;
    check_hresult(shim()->abi_GetSelectorWithFilter(get(serviceName), get(serviceInfoFilter), put(serviceSelector)));
    return serviceSelector;
}
...
{
    Windows::Storage::Streams::IBuffer value;
    check_hresult(shim()->get_RemoteServiceInfo(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_SessionInfo(get(value)));
}
...
{
    event_token token {};
    check_hresult(shim()->add_SessionDeferred(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_SessionDeferred(token));
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Devices::WiFiDirect::Services::WiFiDirectServiceProvisioningInfo> impl_IWiFiDirectService<D>::GetProvisioningInfoAsync(Windows::Devices::WiFiDirect::Services::WiFiDirectServiceConfigurationMethod selectedConfigurationMethod) const
{
    ...
    check_hresult(shim()->abi_GetProvisioningInfoAsync(selectedConfigurationMethod, put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Devices::WiFiDirect::Services::WiFiDirectServiceSession> result;
    check_hresult(shim()->abi_ConnectAsyncWithPin(get(pin), put(result)));
    return result;
}
...
template <typename D> Windows::Devices::WiFiDirect::Services::WiFiDirectServiceProvisioningInfo impl_IWiFiDirectServiceSessionRequest<D>::ProvisioningInfo() const
{
    ...
    check_hresult(shim()->get_ProvisioningInfo(put(value)));
    return value;
}
...
{
    uint32_t value {};
    check_hresult(shim()->get_AdvertisementId(&value));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_ServiceAddress(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_SessionAddress(put(value)));
    return value;
}
...
{
    event_token token {};
    check_hresult(shim()->add_SessionStatusChanged(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_SessionStatusChanged(token));
}
...
template <typename D> Windows::Foundation::IAsyncAction impl_IWiFiDirectServiceSession<D>::AddStreamSocketListenerAsync(const Windows::Networking::Sockets::StreamSocketListener & value) const
{
    ...
    check_hresult(shim()->abi_AddStreamSocketListenerAsync(get(value), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncAction result;
    check_hresult(shim()->abi_AddDatagramSocketAsync(get(value), put(result)));
    return result;
}
...
{
    event_token token {};
    check_hresult(shim()->add_RemotePortAdded(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_RemotePortAdded(token));
}
