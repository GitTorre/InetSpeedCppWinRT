...
{
    bool enabled {};
    check_hresult(shim()->get_Enabled(&enabled));
    return enabled;
}
...
{
    check_hresult(shim()->abi_AddUInt8Array(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddUInt8ArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddUInt8ArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddInt16Array(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddInt16ArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddInt16ArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddUInt16Array(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddUInt16ArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddUInt16ArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddInt32Array(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddInt32ArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddInt32ArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddUInt32Array(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddUInt32ArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddUInt32ArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddInt64Array(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddInt64ArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddInt64ArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddUInt64Array(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddUInt64ArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddUInt64ArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddSingleArray(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddSingleArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddSingleArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddDoubleArray(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddDoubleArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddDoubleArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddChar16Array(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddChar16ArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddChar16ArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddBooleanArray(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddBooleanArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddBooleanArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddStringArray(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddStringArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddStringArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddGuidArray(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddGuidArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddGuidArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddDateTime(get(name), get(value)));
}
...
{
    check_hresult(shim()->abi_AddDateTimeWithFormat(get(name), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddDateTimeWithFormatAndTags(get(name), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddDateTimeArray(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddDateTimeArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddDateTimeArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddTimeSpan(get(name), get(value)));
}
...
{
    check_hresult(shim()->abi_AddTimeSpanWithFormat(get(name), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddTimeSpanWithFormatAndTags(get(name), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddTimeSpanArray(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddTimeSpanArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddTimeSpanArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}

template <typename D> void impl_ILoggingFields<D>::AddPoint(hstring_ref name, const Windows::Foundation::Point & value) const
{
    check_hresult(shim()->abi_AddPoint(get(name), get(value)));
}
...
{
    check_hresult(shim()->abi_AddPointWithFormat(get(name), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddPointWithFormatAndTags(get(name), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddPointArray(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddPointArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddPointArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}

template <typename D> void impl_ILoggingFields<D>::AddSize(hstring_ref name, const Windows::Foundation::Size & value) const
{
    check_hresult(shim()->abi_AddSize(get(name), get(value)));
}
...
{
    check_hresult(shim()->abi_AddSizeWithFormat(get(name), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddSizeWithFormatAndTags(get(name), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddSizeArray(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddSizeArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddSizeArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}

template <typename D> void impl_ILoggingFields<D>::AddRect(hstring_ref name, const Windows::Foundation::Rect & value) const
{
    check_hresult(shim()->abi_AddRect(get(name), get(value)));
}
...
{
    check_hresult(shim()->abi_AddRectWithFormat(get(name), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddRectWithFormatAndTags(get(name), get(value), format, tags));
}
...
{
    check_hresult(shim()->abi_AddRectArray(get(name), value.size(), get(value)));
}
...
{
    check_hresult(shim()->abi_AddRectArrayWithFormat(get(name), value.size(), get(value), format));
}
...
{
    check_hresult(shim()->abi_AddRectArrayWithFormatAndTags(get(name), value.size(), get(value), format, tags));
}

template <typename D> bool impl_ILoggingTarget<D>::IsEnabled() const
{
    bool result {};
    check_hresult(shim()->abi_IsEnabled(&result));
    return result;
}
...
{
    bool result {};
    check_hresult(shim()->abi_IsEnabledWithLevel(level, &result));
    return result;
}
...
{
    bool result {};
    check_hresult(shim()->abi_IsEnabledWithLevelAndKeywords(level, keywords, &result));
    return result;
}
