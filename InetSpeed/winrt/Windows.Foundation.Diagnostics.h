...
#include "impl\Windows.Foundation.Diagnostics.2.h"
...
template <typename D> void consume_Windows_Foundation_Diagnostics_ILoggingFields<D>::AddChar16(param::hstring const& name, wchar_t value) const
{
    check_hresult(WINRT_SHIM(Windows::Foundation::Diagnostics::ILoggingFields)->AddChar16(get_abi(name), value));
}

template <typename D> void consume_Windows_Foundation_Diagnostics_ILoggingFields<D>::AddChar16(param::hstring const& name, wchar_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat const& format) const
{
...
template <typename D> void consume_Windows_Foundation_Diagnostics_ILoggingFields<D>::AddChar16(param::hstring const& name, wchar_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat const& format, int32_t tags) const
{
...
template <typename D> void consume_Windows_Foundation_Diagnostics_ILoggingFields<D>::AddChar16Array(param::hstring const& name, array_view<wchar_t const> value) const
{
...
template <typename D> void consume_Windows_Foundation_Diagnostics_ILoggingFields<D>::AddChar16Array(param::hstring const& name, array_view<wchar_t const> value, Windows::Foundation::Diagnostics::LoggingFieldFormat const& format) const
{
...
template <typename D> void consume_Windows_Foundation_Diagnostics_ILoggingFields<D>::AddChar16Array(param::hstring const& name, array_view<wchar_t const> value, Windows::Foundation::Diagnostics::LoggingFieldFormat const& format, int32_t tags) const
{
...
struct produce<D, Windows::Foundation::Diagnostics::ILoggingFields> : produce_base<D, Windows::Foundation::Diagnostics::ILoggingFields>
{
    ...
    HRESULT __stdcall AddChar16(HSTRING name, wchar_t value) noexcept override
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall AddChar16WithFormat(HSTRING name, wchar_t value, abi_t<Windows::Foundation::Diagnostics::LoggingFieldFormat> format) noexcept override
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall AddChar16WithFormatAndTags(HSTRING name, wchar_t value, abi_t<Windows::Foundation::Diagnostics::LoggingFieldFormat> format, int32_t tags) noexcept override
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall AddChar16Array(HSTRING name, uint32_t __valueSize, wchar_t* value) noexcept override
    {
        try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().AddChar16Array(*reinterpret_cast<hstring const*>(&name), array_view<wchar_t const>(reinterpret_cast<wchar_t const *>(value), reinterpret_cast<wchar_t const *>(value) + __valueSize));
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall AddChar16ArrayWithFormat(HSTRING name, uint32_t __valueSize, wchar_t* value, abi_t<Windows::Foundation::Diagnostics::LoggingFieldFormat> format) noexcept override
    {
        try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().AddChar16Array(*reinterpret_cast<hstring const*>(&name), array_view<wchar_t const>(reinterpret_cast<wchar_t const *>(value), reinterpret_cast<wchar_t const *>(value) + __valueSize), *reinterpret_cast<Windows::Foundation::Diagnostics::LoggingFieldFormat const*>(&format));
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall AddChar16ArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, wchar_t* value, abi_t<Windows::Foundation::Diagnostics::LoggingFieldFormat> format, int32_t tags) noexcept override
    {
        try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().AddChar16Array(*reinterpret_cast<hstring const*>(&name), array_view<wchar_t const>(reinterpret_cast<wchar_t const *>(value), reinterpret_cast<wchar_t const *>(value) + __valueSize), *reinterpret_cast<Windows::Foundation::Diagnostics::LoggingFieldFormat const*>(&format), tags);
            return S_OK;
        }
        catch (...)
        {
