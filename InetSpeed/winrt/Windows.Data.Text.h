...
WINRT_WARNING_PUSH
#include "impl\Windows.Data.Text.2.h"
...
template <typename D> void consume_Windows_Data_Text_IUnicodeCharactersStatics<D>::GetSurrogatePairFromCodepoint(uint32_t codepoint, wchar_t& highSurrogate, wchar_t& lowSurrogate) const
{
...
struct produce<D, Windows::Data::Text::IUnicodeCharactersStatics> : produce_base<D, Windows::Data::Text::IUnicodeCharactersStatics>
{
    ...
    HRESULT __stdcall GetSurrogatePairFromCodepoint(uint32_t codepoint, wchar_t* highSurrogate, wchar_t* lowSurrogate) noexcept override
    {
        try
        {
            typename D::abi_guard guard(this->shim());
