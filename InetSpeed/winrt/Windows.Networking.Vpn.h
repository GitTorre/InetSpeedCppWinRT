...
{
    check_hresult(shim()->abi_GetKeepAlivePayload(get(channel), put(keepAlivePacket)));
}
...
{
    check_hresult(shim()->abi_Encapsulate(get(channel), get(packets), get(encapulatedPackets)));
}
...
{
    check_hresult(shim()->abi_Decapsulate(get(channel), get(encapBuffer), get(decapsulatedPackets), get(controlPacketsToSend)));
}
...
{
    check_hresult(shim()->put_OptionsText(get(value)));
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<hstring> impl_IVpnCustomComboBox<D>::OptionsText() const
{
    ...
    check_hresult(shim()->get_OptionsText(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_DisplayText(get(value)));
}
...
{
    check_hresult(shim()->put_InitialCheckState(value));
}

template <typename D> bool impl_IVpnCustomCheckBox<D>::InitialCheckState() const
{
    bool value {};
    check_hresult(shim()->get_InitialCheckState(&value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_Checked(&value));
    return value;
}
...
template <typename D> Windows::Networking::Vpn::VpnRoute impl_IVpnRouteFactory<D>::CreateVpnRoute(const Windows::Networking::HostName & address, uint8_t prefixSize) const
{
    ...
    check_hresult(shim()->abi_CreateVpnRoute(get(address), prefixSize, put(route)));
    return route;
}
...
{
    check_hresult(shim()->put_PrefixSize(value));
}

template <typename D> uint8_t impl_IVpnRoute<D>::PrefixSize() const
{
    uint8_t value {};
    check_hresult(shim()->get_PrefixSize(&value));
    return value;
}
...
{
    check_hresult(shim()->put_Ipv4InclusionRoutes(get(value)));
}
...
{
    check_hresult(shim()->put_Ipv6InclusionRoutes(get(value)));
}
...
template <typename D> Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnRoute> impl_IVpnRouteAssignment<D>::Ipv4InclusionRoutes() const
{
    ...
    check_hresult(shim()->get_Ipv4InclusionRoutes(put(value)));
    return value;
}
...
{
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnRoute> value;
    check_hresult(shim()->get_Ipv6InclusionRoutes(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_Ipv4ExclusionRoutes(get(value)));
}
...
{
    check_hresult(shim()->put_Ipv6ExclusionRoutes(get(value)));
}
...
{
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnRoute> value;
    check_hresult(shim()->get_Ipv4ExclusionRoutes(put(value)));
    return value;
}
...
template <typename D> Windows::Networking::Vpn::VpnNamespaceInfo impl_IVpnNamespaceInfoFactory<D>::CreateVpnNamespaceInfo(hstring_ref name, const Windows::Foundation::Collections::IVector<Windows::Networking::HostName> & dnsServerList, const Windows::Foundation::Collections::IVector<Windows::Networking::HostName> & proxyServerList) const
{
    ...
    check_hresult(shim()->abi_CreateVpnNamespaceInfo(get(name), get(dnsServerList), get(proxyServerList), put(namespaceInfo)));
    return namespaceInfo;
}

template <typename D> void impl_IVpnNamespaceInfo<D>::Namespace(hstring_ref value) const
{
    check_hresult(shim()->put_Namespace(get(value)));
}

template <typename D> hstring impl_IVpnNamespaceInfo<D>::Namespace() const
{
    hstring value;
    check_hresult(shim()->get_Namespace(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_DnsServers(get(value)));
}
...
template <typename D> Windows::Foundation::Collections::IVector<Windows::Networking::HostName> impl_IVpnNamespaceInfo<D>::DnsServers() const
{
    ...
    check_hresult(shim()->get_DnsServers(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_WebProxyServers(get(value)));
}
...
{
    Windows::Foundation::Collections::IVector<Windows::Networking::HostName> value;
    check_hresult(shim()->get_WebProxyServers(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_NamespaceList(get(value)));
}
...
template <typename D> Windows::Networking::Vpn::VpnInterfaceId impl_IVpnInterfaceIdFactory<D>::CreateVpnInterfaceId(array_ref<const uint8_t> address) const
{
    ...
    check_hresult(shim()->abi_CreateVpnInterfaceId(address.size(), get(address), put(vpnInterfaceId)));
    return vpnInterfaceId;
}

template <typename D> void impl_IVpnInterfaceId<D>::GetAddressInfo(com_array<uint8_t> & id) const
{
    check_hresult(shim()->abi_GetAddressInfo(put_size(id), put(id)));
}
...
template <typename D> Windows::Security::Credentials::PasswordCredential impl_IVpnPickedCredential<D>::PasskeyCredential() const
{
    ...
    check_hresult(shim()->get_PasskeyCredential(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_AdditionalPin(put(value)));
    return value;
}
...
{
    Windows::Security::Credentials::PasswordCredential value { nullptr };
    check_hresult(shim()->get_OldPasswordCredential(put(value)));
    return value;
}
...
template <typename D> Windows::Security::Cryptography::Certificates::Certificate impl_IVpnCredential<D>::CertificateCredential() const
{
    ...
    check_hresult(shim()->get_CertificateCredential(put(value)));
    return value;
}
...
template <typename D> Windows::Storage::Streams::Buffer impl_IVpnSystemHealth<D>::StatementOfHealth() const
{
    ...
    check_hresult(shim()->get_StatementOfHealth(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_ServerServiceName(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::Networking::HostName> impl_IVpnChannelConfiguration<D>::ServerHostNameList() const
{
    ...
    check_hresult(shim()->get_ServerHostNameList(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_CustomField(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::Foundation::Uri> impl_IVpnChannelConfiguration2<D>::ServerUris() const
{
    ...
    check_hresult(shim()->get_ServerUris(put(value)));
    return value;
}
...
{
    check_hresult(shim()->abi_AssociateTransport(get(mainOuterTunnelTransport), get(optionalOuterTunnelTransport)));
}
...
{
    check_hresult(shim()->abi_Start(get(assignedClientIPv4list), get(assignedClientIPv6list), get(vpnInterfaceId), get(routeScope), get(namespaceScope), mtuSize, maxFrameSize, optimizeForLowCostNetwork, get(mainOuterTunnelTransport), get(optionalOuterTunnelTransport)));
}
...
template <typename D> Windows::Networking::Vpn::VpnPickedCredential impl_IVpnChannel<D>::RequestCredentials(Windows::Networking::Vpn::VpnCredentialType credType, bool isRetry, bool isSingleSignOnCredential, const Windows::Security::Cryptography::Certificates::Certificate & certificate) const
{
    ...
    check_hresult(shim()->abi_RequestCredentials(credType, isRetry, isSingleSignOnCredential, get(certificate), put(credential)));
    return credential;
}
...
{
    check_hresult(shim()->abi_RequestVpnPacketBuffer(type, put(vpnPacketBuffer)));
}

template <typename D> void impl_IVpnChannel<D>::LogDiagnosticMessage(hstring_ref message) const
{
    check_hresult(shim()->abi_LogDiagnosticMessage(get(message)));
}
...
{
    event_token token {};
    check_hresult(shim()->add_ActivityChange(get(handler), &token));
    return token;
}
...
template <typename D> Windows::Networking::Vpn::VpnSystemHealth impl_IVpnChannel<D>::SystemHealth() const
{
    ...
    check_hresult(shim()->get_SystemHealth(put(value)));
    return value;
}
...
{
    check_hresult(shim()->abi_RequestCustomPrompt(get(customPrompt)));
}

template <typename D> void impl_IVpnChannel<D>::SetErrorMessage(hstring_ref message) const
{
    check_hresult(shim()->abi_SetErrorMessage(get(message)));
}
...
{
    check_hresult(shim()->abi_SetAllowedSslTlsVersions(get(tunnelTransport), useTls12));
}
...
{
    check_hresult(shim()->abi_StartWithMainTransport(get(assignedClientIPv4list), get(assignedClientIPv6list), get(vpnInterfaceId), get(assignedRoutes), get(assignedDomainName), mtuSize, maxFrameSize, Reserved, get(mainOuterTunnelTransport)));
}
...
{
    check_hresult(shim()->abi_StartExistingTransports(get(assignedClientIPv4list), get(assignedClientIPv6list), get(vpnInterfaceId), get(assignedRoutes), get(assignedDomainName), mtuSize, maxFrameSize, Reserved));
}
...
{
    event_token token {};
    check_hresult(shim()->add_ActivityStateChange(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_ActivityStateChange(token));
}
...
template <typename D> Windows::Networking::Vpn::VpnPacketBuffer impl_IVpnChannel2<D>::GetVpnSendPacketBuffer() const
{
    ...
    check_hresult(shim()->abi_GetVpnSendPacketBuffer(put(vpnSendPacketBuffer)));
...
template <typename D> Windows::Networking::Vpn::VpnPacketBuffer impl_IVpnChannel2<D>::GetVpnReceivePacketBuffer() const
{
    ...
    check_hresult(shim()->abi_GetVpnReceivePacketBuffer(put(vpnReceivePacketBuffer)));
...
template <typename D> Windows::Foundation::IAsyncAction impl_IVpnChannel2<D>::RequestCustomPromptAsync(const Windows::Foundation::Collections::IVectorView<Windows::Networking::Vpn::IVpnCustomPromptElement> & customPromptElement) const
{
    ...
    check_hresult(shim()->abi_RequestCustomPromptAsync(get(customPromptElement), put(action)));
    return action;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Networking::Vpn::VpnCredential> impl_IVpnChannel2<D>::RequestCredentialsAsync(Windows::Networking::Vpn::VpnCredentialType credType, uint32_t credOptions, const Windows::Security::Cryptography::Certificates::Certificate & certificate) const
{
    ...
    check_hresult(shim()->abi_RequestCredentialsWithCertificateAsync(credType, credOptions, get(certificate), put(credential)));
    return credential;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Networking::Vpn::VpnCredential> credential;
    check_hresult(shim()->abi_RequestCredentialsWithOptionsAsync(credType, credOptions, put(credential)));
    return credential;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Networking::Vpn::VpnCredential> credential;
    check_hresult(shim()->abi_RequestCredentialsSimpleAsync(credType, put(credential)));
    return credential;
}

template <typename D> void impl_IVpnChannel2<D>::TerminateConnection(hstring_ref message) const
{
    check_hresult(shim()->abi_TerminateConnection(get(message)));
}
...
{
    check_hresult(shim()->abi_StartWithTrafficFilter(get(assignedClientIpv4List), get(assignedClientIpv6List), get(vpnInterfaceId), get(assignedRoutes), get(assignedNamespace), mtuSize, maxFrameSize, reserved, get(mainOuterTunnelTransport), get(optionalOuterTunnelTransport), get(assignedTrafficFilters)));
}
...
{
    check_hresult(shim()->put_Emphasized(value));
}

template <typename D> bool impl_IVpnCustomPromptElement<D>::Emphasized() const
{
    bool value {};
    check_hresult(shim()->get_Emphasized(&value));
    return value;
}
...
{
    check_hresult(shim()->abi_ProcessEventAsync(get(thirdPartyPlugIn), get(event)));
}
...
template <typename D> Windows::Networking::Vpn::VpnPacketBuffer impl_IVpnPacketBufferFactory<D>::CreateVpnPacketBuffer(const Windows::Networking::Vpn::VpnPacketBuffer & parentBuffer, uint32_t offset, uint32_t length) const
{
    ...
    check_hresult(shim()->abi_CreateVpnPacketBuffer(get(parentBuffer), offset, length, put(vpnPacketBuffer)));
...
{
    check_hresult(shim()->put_TransportAffinity(value));
}

template <typename D> uint32_t impl_IVpnPacketBuffer<D>::TransportAffinity() const
{
    uint32_t value {};
    check_hresult(shim()->get_TransportAffinity(&value));
    return value;
}
...
template <typename D> Windows::Networking::Vpn::VpnAppId impl_IVpnPacketBuffer2<D>::AppId() const
{
    ...
    check_hresult(shim()->get_AppId(put(value)));
    return value;
}
...
{
    check_hresult(shim()->abi_Append(get(nextVpnPacketBuffer)));
}
...
{
    check_hresult(shim()->abi_AddAtBegin(get(nextVpnPacketBuffer)));
}
...
template <typename D> Windows::Networking::Vpn::VpnPacketBuffer impl_IVpnPacketBufferList<D>::RemoveAtEnd() const
{
    ...
    check_hresult(shim()->abi_RemoveAtEnd(put(nextVpnPacketBuffer)));
...
{
    Windows::Networking::Vpn::VpnPacketBuffer nextVpnPacketBuffer { nullptr };
    check_hresult(shim()->abi_RemoveAtBegin(put(nextVpnPacketBuffer)));
    return nextVpnPacketBuffer;
}
...
{
    check_hresult(shim()->abi_AddLeadingPacket(get(nextVpnPacketBuffer)));
}

template <typename D> Windows::Networking::Vpn::VpnPacketBuffer impl_IVpnPacketBufferList2<D>::RemoveLeadingPacket() const
{
    Windows::Networking::Vpn::VpnPacketBuffer nextVpnPacketBuffer { nullptr };
    check_hresult(shim()->abi_RemoveLeadingPacket(put(nextVpnPacketBuffer)));
    return nextVpnPacketBuffer;
}
...
{
    check_hresult(shim()->abi_AddTrailingPacket(get(nextVpnPacketBuffer)));
}

template <typename D> Windows::Networking::Vpn::VpnPacketBuffer impl_IVpnPacketBufferList2<D>::RemoveTrailingPacket() const
{
    Windows::Networking::Vpn::VpnPacketBuffer nextVpnPacketBuffer { nullptr };
    check_hresult(shim()->abi_RemoveTrailingPacket(put(nextVpnPacketBuffer)));
    return nextVpnPacketBuffer;
}
...
{
    check_hresult(shim()->put_IsTextHidden(value));
}

template <typename D> bool impl_IVpnCustomPromptTextInput<D>::IsTextHidden() const
{
    bool value {};
    check_hresult(shim()->get_IsTextHidden(&value));
    return value;
}
...
{
    check_hresult(shim()->put_InitialValue(value));
}

template <typename D> bool impl_IVpnCustomPromptBooleanInput<D>::InitialValue() const
{
    bool value {};
    check_hresult(shim()->get_InitialValue(&value));
    return value;
}
...
{
    Windows::Networking::Vpn::VpnChannelActivityEventType value {};
    check_hresult(shim()->get_ActivityState(&value));
    return value;
}
...
template <typename D> Windows::Networking::Vpn::VpnDomainNameInfo impl_IVpnDomainNameInfoFactory<D>::CreateVpnDomainNameInfo(hstring_ref name, Windows::Networking::Vpn::VpnDomainNameType nameType, const Windows::Foundation::Collections::IIterable<Windows::Networking::HostName> & dnsServerList, const Windows::Foundation::Collections::IIterable<Windows::Networking::HostName> & proxyServerList) const
{
    ...
    check_hresult(shim()->abi_CreateVpnDomainNameInfo(get(name), nameType, get(dnsServerList), get(proxyServerList), put(domainNameInfo)));
...
{
    check_hresult(shim()->put_DomainName(get(value)));
}
...
{
    check_hresult(shim()->put_DomainNameType(value));
}
...
template <typename D> Windows::Networking::Vpn::VpnDomainNameType impl_IVpnDomainNameInfo<D>::DomainNameType() const
{
    ...
    check_hresult(shim()->get_DomainNameType(&value));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVector<Windows::Foundation::Uri> impl_IVpnDomainNameInfo2<D>::WebProxyUris() const
{
    ...
    check_hresult(shim()->get_WebProxyUris(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnDomainNameInfo> impl_IVpnDomainNameAssignment<D>::DomainNameList() const
{
    ...
    check_hresult(shim()->get_DomainNameList(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_ProxyAutoConfigurationUri(get(value)));
}

template <typename D> Windows::Foundation::Uri impl_IVpnDomainNameAssignment<D>::ProxyAutoConfigurationUri() const
{
    Windows::Foundation::Uri value { nullptr };
    check_hresult(shim()->get_ProxyAutoConfigurationUri(put(value)));
    return value;
}
...
template <typename D> Windows::Networking::Vpn::VpnAppId impl_IVpnAppIdFactory<D>::Create(Windows::Networking::Vpn::VpnAppIdType type, hstring_ref value) const
{
    ...
    check_hresult(shim()->abi_Create(type, get(value), put(result)));
    return result;
}
...
template <typename D> Windows::Networking::Vpn::VpnTrafficFilter impl_IVpnTrafficFilterFactory<D>::Create(const Windows::Networking::Vpn::VpnAppId & appId) const
{
    ...
    check_hresult(shim()->abi_Create(get(appId), put(result)));
    return result;
}
...
{
    Windows::Foundation::Collections::IVector<hstring> value;
    check_hresult(shim()->get_RemotePortRanges(put(value)));
    return value;
}
...
{
    Windows::Foundation::Collections::IVector<hstring> value;
    check_hresult(shim()->get_LocalAddressRanges(put(value)));
    return value;
}
...
{
    Windows::Foundation::Collections::IVector<hstring> value;
    check_hresult(shim()->get_RemoteAddressRanges(put(value)));
    return value;
}
...
template <typename D> Windows::Networking::Vpn::VpnRoutingPolicyType impl_IVpnTrafficFilter<D>::RoutingPolicyType() const
{
    ...
    check_hresult(shim()->get_RoutingPolicyType(&value));
    return value;
}
...
{
    check_hresult(shim()->put_RoutingPolicyType(value));
}
...
template <typename D> Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnTrafficFilter> impl_IVpnTrafficFilterAssignment<D>::TrafficFilterList() const
{
    ...
    check_hresult(shim()->get_TrafficFilterList(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_ProfileName(get(value)));
}
...
template <typename D> Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnAppId> impl_IVpnProfile<D>::AppTriggers() const
{
    ...
    check_hresult(shim()->get_AppTriggers(put(value)));
    return value;
}
...
{
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnDomainNameInfo> value;
    check_hresult(shim()->get_DomainNameInfoList(put(value)));
    return value;
}
...
{
    Windows::Foundation::Collections::IVector<Windows::Networking::Vpn::VpnTrafficFilter> value;
    check_hresult(shim()->get_TrafficFilters(put(value)));
    return value;
}
...
{
    Windows::Foundation::Collections::IVector<hstring> value;
    check_hresult(shim()->get_Servers(put(value)));
    return value;
}
...
template <typename D> Windows::Networking::Vpn::VpnNativeProtocolType impl_IVpnNativeProfile<D>::NativeProtocolType() const
{
    ...
    check_hresult(shim()->get_NativeProtocolType(&value));
    return value;
}
...
{
    check_hresult(shim()->put_NativeProtocolType(value));
}
...
template <typename D> Windows::Networking::Vpn::VpnAuthenticationMethod impl_IVpnNativeProfile<D>::UserAuthenticationMethod() const
{
    ...
    check_hresult(shim()->get_UserAuthenticationMethod(&value));
    return value;
}
...
{
    check_hresult(shim()->put_UserAuthenticationMethod(value));
}
...
{
    Windows::Networking::Vpn::VpnAuthenticationMethod value {};
    check_hresult(shim()->get_TunnelAuthenticationMethod(&value));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::Vpn::VpnManagementErrorStatus> impl_IVpnManagementAgent<D>::AddProfileFromXmlAsync(hstring_ref xml) const
{
    ...
    check_hresult(shim()->abi_AddProfileFromXmlAsync(get(xml), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::Vpn::VpnManagementErrorStatus> operation;
    check_hresult(shim()->abi_AddProfileFromObjectAsync(get(profile), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::Vpn::VpnManagementErrorStatus> operation;
    check_hresult(shim()->abi_UpdateProfileFromXmlAsync(get(xml), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::Vpn::VpnManagementErrorStatus> operation;
    check_hresult(shim()->abi_UpdateProfileFromObjectAsync(get(profile), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::Networking::Vpn::IVpnProfile>> impl_IVpnManagementAgent<D>::GetProfilesAsync() const
{
    ...
    check_hresult(shim()->abi_GetProfilesAsync(put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::Vpn::VpnManagementErrorStatus> operation;
    check_hresult(shim()->abi_DeleteProfileAsync(get(profile), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::Vpn::VpnManagementErrorStatus> operation;
    check_hresult(shim()->abi_ConnectProfileAsync(get(profile), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::Vpn::VpnManagementErrorStatus> operation;
    check_hresult(shim()->abi_ConnectProfileWithPasswordCredentialAsync(get(profile), get(passwordCredential), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::Vpn::VpnManagementErrorStatus> operation;
    check_hresult(shim()->abi_DisconnectProfileAsync(get(profile), put(operation)));
    return operation;
}
