...
{
    int32_t value {};
    check_hresult(shim()->get_CountryCode(&value));
    return value;
}
...
{
    int32_t result {};
    check_hresult(shim()->abi_GetLengthOfGeographicalAreaCode(&result));
    return result;
}
...
{
    hstring result;
    check_hresult(shim()->abi_GetNationalSignificantNumber(put(result)));
    return result;
}
...
{
    int32_t result {};
    check_hresult(shim()->abi_GetLengthOfNationalDestinationCode(&result));
    return result;
}
...
template <typename D> Windows::Globalization::PhoneNumberFormatting::PredictedPhoneNumberKind impl_IPhoneNumberInfo<D>::PredictNumberKind() const
{
    ...
    check_hresult(shim()->abi_PredictNumberKind(&result));
    return result;
}
...
{
    hstring result;
    check_hresult(shim()->abi_GetGeographicRegionCode(put(result)));
    return result;
}
...
template <typename D> Windows::Globalization::PhoneNumberFormatting::PhoneNumberMatchResult impl_IPhoneNumberInfo<D>::CheckNumberMatch(const Windows::Globalization::PhoneNumberFormatting::PhoneNumberInfo & otherNumber) const
{
    ...
    check_hresult(shim()->abi_CheckNumberMatch(get(otherNumber), &result));
    return result;
}
...
{
    hstring result;
    check_hresult(shim()->abi_Format(get(number), put(result)));
    return result;
}
...
{
    hstring result;
    check_hresult(shim()->abi_FormatWithOutputFormat(get(number), numberFormat, put(result)));
    return result;
}
...
{
    hstring result;
    check_hresult(shim()->abi_FormatPartialString(get(number), put(result)));
    return result;
}
...
{
    hstring result;
    check_hresult(shim()->abi_FormatString(get(number), put(result)));
    return result;
}
...
{
    hstring result;
    check_hresult(shim()->abi_FormatStringWithLeftToRightMarkers(get(number), put(result)));
    return result;
}
...
template <typename D> Windows::Globalization::PhoneNumberFormatting::PhoneNumberInfo impl_IPhoneNumberInfoFactory<D>::Create(hstring_ref number) const
{
    ...
    check_hresult(shim()->abi_Create(get(number), put(result)));
    return result;
}
...
template <typename D> Windows::Globalization::PhoneNumberFormatting::PhoneNumberParseResult impl_IPhoneNumberInfoStatics<D>::TryParse(hstring_ref input, Windows::Globalization::PhoneNumberFormatting::PhoneNumberInfo & phoneNumber) const
{
    ...
    check_hresult(shim()->abi_TryParse(get(input), put(phoneNumber), &result));
    return result;
}
...
{
    Windows::Globalization::PhoneNumberFormatting::PhoneNumberParseResult result {};
    check_hresult(shim()->abi_TryParseWithRegion(get(input), get(regionCode), put(phoneNumber), &result));
    return result;
}
...
{
    check_hresult(shim()->abi_TryCreate(get(regionCode), put(phoneNumber)));
}

template <typename D> int32_t impl_IPhoneNumberFormatterStatics<D>::GetCountryCodeForRegion(hstring_ref regionCode) const
{
    int32_t result {};
    check_hresult(shim()->abi_GetCountryCodeForRegion(get(regionCode), &result));
    return result;
}
...
{
    hstring result;
    check_hresult(shim()->abi_GetNationalDirectDialingPrefixForRegion(get(regionCode), stripNonDigit, put(result)));
    return result;
}
...
{
    hstring result;
    check_hresult(shim()->abi_WrapWithLeftToRightMarkers(get(number), put(result)));
    return result;
}
