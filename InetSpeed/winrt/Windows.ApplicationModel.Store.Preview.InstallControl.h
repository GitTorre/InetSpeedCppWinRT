...
{
    uint64_t value {};
    check_hresult(shim()->get_DownloadSizeInBytes(&value));
    return value;
}
...
{
    uint64_t value {};
    check_hresult(shim()->get_BytesDownloaded(&value));
    return value;
}
...
{
    double value {};
    check_hresult(shim()->get_PercentComplete(&value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_ReadyForLaunch(&value));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallType impl_IAppInstallItem<D>::InstallType() const
{
    ...
    check_hresult(shim()->get_InstallType(&value));
    return value;
}
...
template <typename D> Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallStatus impl_IAppInstallItem<D>::GetCurrentStatus() const
{
    ...
    check_hresult(shim()->abi_GetCurrentStatus(put(result)));
    return result;
}
...
{
    check_hresult(shim()->abi_Restart());
}
...
{
    check_hresult(shim()->abi_CancelWithTelemetry(get(correlationVector)));
}

template <typename D> void impl_IAppInstallItem2<D>::Pause(hstring_ref correlationVector) const
{
    check_hresult(shim()->abi_PauseWithTelemetry(get(correlationVector)));
}

template <typename D> void impl_IAppInstallItem2<D>::Restart(hstring_ref correlationVector) const
{
    check_hresult(shim()->abi_RestartWithTelemetry(get(correlationVector)));
}
...
{
    event_token token {};
    check_hresult(shim()->add_ItemCompleted(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_ItemCompleted(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_ItemStatusChanged(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_ItemStatusChanged(token));
}
...
template <typename D> Windows::ApplicationModel::Store::Preview::InstallControl::AutoUpdateSetting impl_IAppInstallManager<D>::AutoUpdateSetting() const
{
    ...
    check_hresult(shim()->get_AutoUpdateSetting(&value));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<bool> impl_IAppInstallManager<D>::GetIsApplicableAsync(hstring_ref productId, hstring_ref skuId) const
{
    ...
    check_hresult(shim()->abi_GetIsApplicableAsync(get(productId), get(skuId), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem> impl_IAppInstallManager<D>::StartAppInstallAsync(hstring_ref productId, hstring_ref skuId, bool repair, bool forceUseOfNonRemovableStorage) const
{
    ...
    check_hresult(shim()->abi_StartAppInstallAsync(get(productId), get(skuId), repair, forceUseOfNonRemovableStorage, put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem> operation;
    check_hresult(shim()->abi_UpdateAppByPackageFamilyNameAsync(get(packageFamilyName), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem> operation;
    check_hresult(shim()->abi_SearchForUpdatesAsync(get(productId), get(skuId), put(operation)));
    return operation;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem>> impl_IAppInstallManager<D>::SearchForAllUpdatesAsync() const
{
    ...
    check_hresult(shim()->abi_SearchForAllUpdatesAsync(put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(shim()->abi_IsStoreBlockedByPolicyAsync(get(storeClientName), get(storeClientPublisher), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(shim()->abi_GetIsAppAllowedToInstallAsync(get(productId), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem> operation;
    check_hresult(shim()->abi_StartAppInstallWithTelemetryAsync(get(productId), get(skuId), repair, forceUseOfNonRemovableStorage, get(catalogId), get(bundleId), get(correlationVector), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem> operation;
    check_hresult(shim()->abi_UpdateAppByPackageFamilyNameWithTelemetryAsync(get(packageFamilyName), get(correlationVector), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem> operation;
    check_hresult(shim()->abi_SearchForUpdatesWithTelemetryAsync(get(productId), get(skuId), get(catalogId), get(correlationVector), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem>> operation;
    check_hresult(shim()->abi_SearchForAllUpdatesWithTelemetryAsync(get(correlationVector), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(shim()->abi_GetIsAppAllowedToInstallWithTelemetryAsync(get(productId), get(skuId), get(catalogId), get(correlationVector), put(operation)));
    return operation;
}

template <typename D> void impl_IAppInstallManager2<D>::Cancel(hstring_ref productId, hstring_ref correlationVector) const
{
    check_hresult(shim()->abi_CancelWithTelemetry(get(productId), get(correlationVector)));
}

template <typename D> void impl_IAppInstallManager2<D>::Pause(hstring_ref productId, hstring_ref correlationVector) const
{
    check_hresult(shim()->abi_PauseWithTelemetry(get(productId), get(correlationVector)));
}

template <typename D> void impl_IAppInstallManager2<D>::Restart(hstring_ref productId, hstring_ref correlationVector) const
{
    check_hresult(shim()->abi_RestartWithTelemetry(get(productId), get(correlationVector)));
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem>> operation;
    check_hresult(shim()->abi_StartProductInstallAsync(get(productId), get(catalogId), get(flightId), get(clientId), repair, forceUseOfNonRemovableStorage, get(correlationVector), get(targetVolume), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem>> operation;
    check_hresult(shim()->abi_StartProductInstallForUserAsync(get(user), get(productId), get(catalogId), get(flightId), get(clientId), repair, forceUseOfNonRemovableStorage, get(correlationVector), get(targetVolume), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem> operation;
    check_hresult(shim()->abi_UpdateAppByPackageFamilyNameForUserAsync(get(user), get(packageFamilyName), get(correlationVector), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem> operation;
    check_hresult(shim()->abi_SearchForUpdatesForUserAsync(get(user), get(productId), get(skuId), get(catalogId), get(correlationVector), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Store::Preview::InstallControl::AppInstallItem>> operation;
    check_hresult(shim()->abi_SearchForAllUpdatesForUserAsync(get(user), get(correlationVector), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(shim()->abi_GetIsAppAllowedToInstallForUserAsync(get(user), get(productId), get(skuId), get(catalogId), get(correlationVector), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<bool> operation;
    check_hresult(shim()->abi_GetIsApplicableForUserAsync(get(user), get(productId), get(skuId), put(operation)));
    return operation;
}
...
{
    check_hresult(shim()->abi_MoveToFrontOfDownloadQueue(get(productId), get(correlationVector)));
}
