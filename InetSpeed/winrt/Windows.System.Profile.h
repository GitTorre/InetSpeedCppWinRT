...
struct produce<D, Windows::System::Profile::IKnownRetailInfoPropertiesStatics> : produce_base<D, Windows::System::Profile::IKnownRetailInfoPropertiesStatics>
{
    HRESULT __stdcall get_RetailAccessCode(abi_arg_out<hstring> value) noexcept override
    {
        try
        {
            *value = detach(shim().RetailAccessCode());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall get_DisplayModelName(abi_arg_out<hstring> value) noexcept override
    {
        try
        {
            *value = detach(shim().DisplayModelName());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall get_DisplayDescription(abi_arg_out<hstring> value) noexcept override
    {
        try
        {
            *value = detach(shim().DisplayDescription());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall get_BatteryLifeDescription(abi_arg_out<hstring> value) noexcept override
    {
        try
        {
            *value = detach(shim().BatteryLifeDescription());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall get_ProcessorDescription(abi_arg_out<hstring> value) noexcept override
    {
        try
        {
            *value = detach(shim().ProcessorDescription());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall get_StorageDescription(abi_arg_out<hstring> value) noexcept override
    {
        try
        {
            *value = detach(shim().StorageDescription());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall get_GraphicsDescription(abi_arg_out<hstring> value) noexcept override
    {
        try
        {
            *value = detach(shim().GraphicsDescription());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall get_FrontCameraDescription(abi_arg_out<hstring> value) noexcept override
    {
        try
        {
            *value = detach(shim().FrontCameraDescription());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall get_RearCameraDescription(abi_arg_out<hstring> value) noexcept override
    {
        try
        {
            *value = detach(shim().RearCameraDescription());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall get_HasOpticalDrive(abi_arg_out<hstring> value) noexcept override
    {
        try
        {
            *value = detach(shim().HasOpticalDrive());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall get_IsOfficeInstalled(abi_arg_out<hstring> value) noexcept override
    {
        try
        {
            *value = detach(shim().IsOfficeInstalled());
            return S_OK;
        }
        catch (...)
        {
    ...
    HRESULT __stdcall get_WindowsEdition(abi_arg_out<hstring> value) noexcept override
    {
        try
        {
            *value = detach(shim().WindowsEdition());
            return S_OK;
        }
        catch (...)
        {
...
struct produce<D, Windows::System::Profile::IRetailInfoStatics> : produce_base<D, Windows::System::Profile::IRetailInfoStatics>
{
    HRESULT __stdcall get_IsDemoModeEnabled(bool * value) noexcept override
    {
        try
        {
            *value = detach(shim().IsDemoModeEnabled());
            return S_OK;
        }
        catch (...)
        {
...
{
    bool value {};
    check_hresult(shim()->get_IsDemoModeEnabled(&value));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_RetailAccessCode(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_DisplayModelName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_IsFeatured(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_FormFactor(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_ScreenSize(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_DisplayDescription(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_BatteryLifeDescription(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_ProcessorDescription(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_Memory(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_StorageDescription(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_GraphicsDescription(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_FrontCameraDescription(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_RearCameraDescription(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_HasNfc(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_HasSdSlot(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_HasOpticalDrive(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_IsOfficeInstalled(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_WindowsEdition(put(value)));
    return value;
}
