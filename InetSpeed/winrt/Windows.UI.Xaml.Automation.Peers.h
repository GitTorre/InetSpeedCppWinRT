...
template <typename D> Windows::UI::Xaml::Automation::Peers::ItemsControlAutomationPeer impl_IItemAutomationPeer<D>::ItemsControlAutomationPeer() const
{
    ...
    check_hresult(shim()->get_ItemsControlAutomationPeer(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Xaml::Automation::Peers::ItemAutomationPeer impl_IItemAutomationPeerFactory<D>::CreateInstanceWithParentAndItem(const Windows::IInspectable & item, const Windows::UI::Xaml::Automation::Peers::ItemsControlAutomationPeer & parent, const Windows::IInspectable & outer, Windows::IInspectable & inner) const
{
    ...
    check_hresult(shim()->abi_CreateInstanceWithParentAndItem(get(item), get(parent), get(outer), put(inner), put(instance)));
    return instance;
}
...
template <typename D> Windows::UI::Xaml::Automation::Peers::ButtonBaseAutomationPeer impl_IButtonBaseAutomationPeerFactory<D>::CreateInstanceWithOwner(const Windows::UI::Xaml::Controls::Primitives::ButtonBase & owner, const Windows::IInspectable & outer, Windows::IInspectable & inner) const
{
    ...
    check_hresult(shim()->abi_CreateInstanceWithOwner(get(owner), get(outer), put(inner), put(instance)));
    return instance;
}
...
template <typename D> Windows::UI::Xaml::Automation::Peers::ItemAutomationPeer impl_IItemsControlAutomationPeer2<D>::CreateItemAutomationPeer(const Windows::IInspectable & item) const
{
    ...
    check_hresult(shim()->abi_CreateItemAutomationPeer(get(item), put(returnValue)));
    return returnValue;
}
...
{
    Windows::UI::Xaml::Automation::Peers::ItemAutomationPeer returnValue { nullptr };
    check_hresult(shim()->abi_OnCreateItemAutomationPeer(get(item), put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::UI::Xaml::Automation::Peers::AutoSuggestBoxAutomationPeer impl_IAutoSuggestBoxAutomationPeerFactory<D>::CreateInstanceWithOwner(const Windows::UI::Xaml::Controls::AutoSuggestBox & owner) const
{
    ...
    check_hresult(shim()->abi_CreateInstanceWithOwner(get(owner), put(instance)));
    return instance;
}
...
template <typename D> Windows::UI::Xaml::Automation::Peers::AutomationPeer impl_IAutomationPeer<D>::EventsSource() const
{
    ...
    check_hresult(shim()->get_EventsSource(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_EventsSource(get(value)));
}
...
template <typename D> Windows::IInspectable impl_IAutomationPeer<D>::GetPattern(Windows::UI::Xaml::Automation::Peers::PatternInterface patternInterface) const
{
    ...
    check_hresult(shim()->abi_GetPattern(patternInterface, put(returnValue)));
    return returnValue;
}
...
{
    check_hresult(shim()->abi_RaiseAutomationEvent(eventId));
}
...
{
    check_hresult(shim()->abi_RaisePropertyChangedEvent(get(automationProperty), get(oldValue), get(newValue)));
}

template <typename D> hstring impl_IAutomationPeer<D>::GetAcceleratorKey() const
{
    hstring returnValue;
    check_hresult(shim()->abi_GetAcceleratorKey(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetAccessKey(put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::UI::Xaml::Automation::Peers::AutomationControlType impl_IAutomationPeer<D>::GetAutomationControlType() const
{
    ...
    check_hresult(shim()->abi_GetAutomationControlType(&returnValue));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetAutomationId(put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::Foundation::Rect impl_IAutomationPeer<D>::GetBoundingRectangle() const
{
    ...
    check_hresult(shim()->abi_GetBoundingRectangle(put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::Foundation::Collections::IVector<Windows::UI::Xaml::Automation::Peers::AutomationPeer> impl_IAutomationPeer<D>::GetChildren() const
{
    ...
    check_hresult(shim()->abi_GetChildren(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetClassName(put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::Foundation::Point impl_IAutomationPeer<D>::GetClickablePoint() const
{
    ...
    check_hresult(shim()->abi_GetClickablePoint(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetHelpText(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetItemStatus(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetItemType(put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::UI::Xaml::Automation::Peers::AutomationPeer impl_IAutomationPeer<D>::GetLabeledBy() const
{
    ...
    check_hresult(shim()->abi_GetLabeledBy(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetLocalizedControlType(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetName(put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::UI::Xaml::Automation::Peers::AutomationOrientation impl_IAutomationPeer<D>::GetOrientation() const
{
    ...
    check_hresult(shim()->abi_GetOrientation(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_HasKeyboardFocus(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsContentElement(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsControlElement(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsEnabled(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsKeyboardFocusable(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsOffscreen(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsPassword(&returnValue));
    return returnValue;
}
...
{
    Windows::UI::Xaml::Automation::Peers::AutomationPeer returnValue { nullptr };
    check_hresult(shim()->abi_GetPeerFromPoint(get(point), put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::UI::Xaml::Automation::Peers::AutomationLiveSetting impl_IAutomationPeer<D>::GetLiveSetting() const
{
    ...
    check_hresult(shim()->abi_GetLiveSetting(&returnValue));
    return returnValue;
}
...
{
    Windows::IInspectable returnValue;
    check_hresult(shim()->abi_GetPatternCore(patternInterface, put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetAcceleratorKeyCore(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetAccessKeyCore(put(returnValue)));
    return returnValue;
}
...
{
    Windows::UI::Xaml::Automation::Peers::AutomationControlType returnValue {};
    check_hresult(shim()->abi_GetAutomationControlTypeCore(&returnValue));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetAutomationIdCore(put(returnValue)));
    return returnValue;
}
...
{
    Windows::Foundation::Rect returnValue {};
    check_hresult(shim()->abi_GetBoundingRectangleCore(put(returnValue)));
    return returnValue;
}
...
{
    Windows::Foundation::Collections::IVector<Windows::UI::Xaml::Automation::Peers::AutomationPeer> returnValue;
    check_hresult(shim()->abi_GetChildrenCore(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetClassNameCore(put(returnValue)));
    return returnValue;
}
...
{
    Windows::Foundation::Point returnValue {};
    check_hresult(shim()->abi_GetClickablePointCore(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetHelpTextCore(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetItemStatusCore(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetItemTypeCore(put(returnValue)));
    return returnValue;
}
...
{
    Windows::UI::Xaml::Automation::Peers::AutomationPeer returnValue { nullptr };
    check_hresult(shim()->abi_GetLabeledByCore(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetLocalizedControlTypeCore(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetNameCore(put(returnValue)));
    return returnValue;
}
...
{
    Windows::UI::Xaml::Automation::Peers::AutomationOrientation returnValue {};
    check_hresult(shim()->abi_GetOrientationCore(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_HasKeyboardFocusCore(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsContentElementCore(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsControlElementCore(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsEnabledCore(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsKeyboardFocusableCore(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsOffscreenCore(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsPasswordCore(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsRequiredForFormCore(&returnValue));
    return returnValue;
}

template <typename D> void impl_IAutomationPeerOverrides<D>::SetFocusCore() const
{
    check_hresult(shim()->abi_SetFocusCore());
}
...
{
    Windows::UI::Xaml::Automation::Peers::AutomationPeer returnValue { nullptr };
    check_hresult(shim()->abi_GetPeerFromPointCore(get(point), put(returnValue)));
    return returnValue;
}
...
{
    Windows::UI::Xaml::Automation::Peers::AutomationLiveSetting returnValue {};
    check_hresult(shim()->abi_GetLiveSettingCore(&returnValue));
    return returnValue;
}
...
{
    Windows::UI::Xaml::Automation::Peers::AutomationPeer returnValue { nullptr };
    check_hresult(shim()->abi_PeerFromProvider(get(provider), put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::UI::Xaml::Automation::Provider::IRawElementProviderSimple impl_IAutomationPeerProtected<D>::ProviderFromPeer(const Windows::UI::Xaml::Automation::Peers::AutomationPeer & peer) const
{
    ...
    check_hresult(shim()->abi_ProviderFromPeer(get(peer), put(returnValue)));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_ListenerExists(eventId, &returnValue));
    return returnValue;
}
...
{
    check_hresult(shim()->abi_ShowContextMenuCore());
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::UI::Xaml::Automation::Peers::AutomationPeer> impl_IAutomationPeerOverrides2<D>::GetControlledPeersCore() const
{
    ...
    check_hresult(shim()->abi_GetControlledPeersCore(put(returnValue)));
    return returnValue;
}
...
{
    Windows::IInspectable returnValue;
    check_hresult(shim()->abi_Navigate(direction, put(returnValue)));
    return returnValue;
}
...
{
    Windows::IInspectable returnValue;
    check_hresult(shim()->abi_GetElementFromPoint(get(pointInWindowCoordinates), put(returnValue)));
    return returnValue;
}
...
{
    Windows::Foundation::Collections::IVectorView<Windows::UI::Xaml::Automation::Peers::AutomationPeer> returnValue;
    check_hresult(shim()->abi_GetControlledPeers(put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::Foundation::Collections::IVector<Windows::UI::Xaml::Automation::Peers::AutomationPeerAnnotation> impl_IAutomationPeer3<D>::GetAnnotations() const
{
    ...
    check_hresult(shim()->abi_GetAnnotations(put(returnValue)));
    return returnValue;
}
...
{
    check_hresult(shim()->abi_SetParent(get(peer)));
}
...
{
    check_hresult(shim()->abi_RaiseTextEditTextChangedEvent(automationTextEditChangeType, get(changedData)));
}

template <typename D> int32_t impl_IAutomationPeer3<D>::GetPositionInSet() const
{
    int32_t returnValue {};
    check_hresult(shim()->abi_GetPositionInSet(&returnValue));
    return returnValue;
}
...
{
    int32_t returnValue {};
    check_hresult(shim()->abi_GetSizeOfSet(&returnValue));
    return returnValue;
}
...
{
    int32_t returnValue {};
    check_hresult(shim()->abi_GetLevel(&returnValue));
    return returnValue;
}
...
{
    check_hresult(shim()->abi_RaiseStructureChangedEvent(structureChangeType, get(child)));
}
...
{
    Windows::IInspectable returnValue;
    check_hresult(shim()->abi_NavigateCore(direction, put(returnValue)));
    return returnValue;
}
...
{
    Windows::IInspectable returnValue;
    check_hresult(shim()->abi_GetElementFromPointCore(get(pointInWindowCoordinates), put(returnValue)));
    return returnValue;
}
...
{
    Windows::IInspectable returnValue;
    check_hresult(shim()->abi_GetFocusedElementCore(put(returnValue)));
    return returnValue;
}
...
{
    Windows::Foundation::Collections::IVector<Windows::UI::Xaml::Automation::Peers::AutomationPeerAnnotation> returnValue;
    check_hresult(shim()->abi_GetAnnotationsCore(put(returnValue)));
    return returnValue;
}
...
{
    int32_t returnValue {};
    check_hresult(shim()->abi_GetPositionInSetCore(&returnValue));
    return returnValue;
}
...
{
    int32_t returnValue {};
    check_hresult(shim()->abi_GetSizeOfSetCore(&returnValue));
    return returnValue;
}
...
{
    int32_t returnValue {};
    check_hresult(shim()->abi_GetLevelCore(&returnValue));
    return returnValue;
}
...
template <typename D> Windows::UI::Xaml::Automation::Peers::RawElementProviderRuntimeId impl_IAutomationPeerStatics3<D>::GenerateRawElementProviderRuntimeId() const
{
    ...
    check_hresult(shim()->abi_GenerateRawElementProviderRuntimeId(put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::UI::Xaml::Automation::Peers::AutomationLandmarkType impl_IAutomationPeer4<D>::GetLandmarkType() const
{
    ...
    check_hresult(shim()->abi_GetLandmarkType(&returnValue));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetLocalizedLandmarkType(put(returnValue)));
    return returnValue;
}
...
{
    Windows::UI::Xaml::Automation::Peers::AutomationLandmarkType returnValue {};
    check_hresult(shim()->abi_GetLandmarkTypeCore(&returnValue));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetLocalizedLandmarkTypeCore(put(returnValue)));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsPeripheral(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsDataValidForForm(&returnValue));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetFullDescription(put(returnValue)));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsPeripheralCore(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_IsDataValidForFormCore(&returnValue));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetFullDescriptionCore(put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::Foundation::Collections::IIterable<Windows::UI::Xaml::Automation::Peers::AutomationPeer> impl_IAutomationPeerOverrides5<D>::GetDescribedByCore() const
{
    ...
    check_hresult(shim()->abi_GetDescribedByCore(put(returnValue)));
    return returnValue;
}
...
{
    Windows::Foundation::Collections::IIterable<Windows::UI::Xaml::Automation::Peers::AutomationPeer> returnValue;
    check_hresult(shim()->abi_GetFlowsToCore(put(returnValue)));
    return returnValue;
}
...
{
    Windows::Foundation::Collections::IIterable<Windows::UI::Xaml::Automation::Peers::AutomationPeer> returnValue;
    check_hresult(shim()->abi_GetFlowsFromCore(put(returnValue)));
    return returnValue;
}
...
{
    Windows::UI::Xaml::Automation::Peers::AutomationPeer value { nullptr };
    check_hresult(shim()->get_Peer(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_Peer(get(value)));
}
...
{
    Windows::UI::Xaml::DependencyProperty value { nullptr };
    check_hresult(shim()->get_PeerProperty(put(value)));
    return value;
}
...
{
    Windows::UI::Xaml::Automation::Peers::AutomationPeerAnnotation instance { nullptr };
    check_hresult(shim()->abi_CreateWithPeerParameter(type, get(peer), put(instance)));
    return instance;
}
...
{
    Windows::UI::Xaml::Automation::Peers::AutomationPeer returnValue { nullptr };
    check_hresult(shim()->abi_FromElement(get(element), put(returnValue)));
    return returnValue;
}
...
{
    Windows::UI::Xaml::Automation::Peers::AutomationPeer returnValue { nullptr };
    check_hresult(shim()->abi_CreatePeerForElement(get(element), put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::UI::Xaml::Automation::Peers::PivotItemDataAutomationPeer impl_IPivotItemDataAutomationPeerFactory<D>::CreateInstanceWithParentAndItem(const Windows::IInspectable & item, const Windows::UI::Xaml::Automation::Peers::PivotAutomationPeer & parent) const
{
    ...
    check_hresult(shim()->abi_CreateInstanceWithParentAndItem(get(item), get(parent), put(instance)));
    return instance;
}
