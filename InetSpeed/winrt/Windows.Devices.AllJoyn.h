...
{
    int32_t value {};
    check_hresult(shim()->get_Ok(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_Fail(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_OperationTimedOut(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_OtherEndClosed(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_ConnectionRefused(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_AuthenticationFailed(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_AuthenticationRejectedByUser(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_SslConnectFailed(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_SslIdentityVerificationFailed(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_InsufficientSecurity(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_InvalidArgument1(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_InvalidArgument2(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_InvalidArgument3(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_InvalidArgument4(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_InvalidArgument5(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_InvalidArgument6(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_InvalidArgument7(&value));
    return value;
}
...
{
    int32_t value {};
    check_hresult(shim()->get_InvalidArgument8(&value));
    return value;
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynAboutData impl_IAllJoynBusAttachment<D>::AboutData() const
{
    ...
    check_hresult(shim()->get_AboutData(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_ConnectionSpecification(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_UniqueName(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<int32_t> impl_IAllJoynBusAttachment<D>::PingAsync(hstring_ref uniqueName) const
{
    ...
    check_hresult(shim()->abi_PingAsync(get(uniqueName), put(operation)));
    return operation;
}

template <typename D> void impl_IAllJoynBusAttachment<D>::Connect() const
{
    check_hresult(shim()->abi_Connect());
}
...
template <typename D> Windows::Foundation::Collections::IVector<winrt::Windows::Devices::AllJoyn::AllJoynAuthenticationMechanism> impl_IAllJoynBusAttachment<D>::AuthenticationMechanisms() const
{
    ...
    check_hresult(shim()->get_AuthenticationMechanisms(put(value)));
    return value;
}
...
{
    event_token token {};
    check_hresult(shim()->add_CredentialsRequested(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_CredentialsRequested(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_CredentialsVerificationRequested(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_CredentialsVerificationRequested(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_AuthenticationComplete(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_AuthenticationComplete(token));
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Devices::AllJoyn::AllJoynAboutDataView> impl_IAllJoynBusAttachment2<D>::GetAboutDataAsync(const Windows::Devices::AllJoyn::AllJoynServiceInfo & serviceInfo) const
{
    ...
    check_hresult(shim()->abi_GetAboutDataAsync(get(serviceInfo), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Devices::AllJoyn::AllJoynAboutDataView> operation;
    check_hresult(shim()->abi_GetAboutDataWithLanguageAsync(get(serviceInfo), get(language), put(operation)));
    return operation;
}
...
{
    event_token token {};
    check_hresult(shim()->add_AcceptSessionJoinerRequested(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_AcceptSessionJoinerRequested(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_SessionJoined(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_SessionJoined(token));
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynBusAttachment impl_IAllJoynBusAttachmentStatics<D>::GetDefault() const
{
    ...
    check_hresult(shim()->abi_GetDefault(put(defaultBusAttachment)));
...
template <typename D> Windows::Devices::Enumeration::DeviceWatcher impl_IAllJoynBusAttachmentStatics<D>::GetWatcher(const Windows::Foundation::Collections::IIterable<hstring> & requiredInterfaces) const
{
    ...
    check_hresult(shim()->abi_GetWatcher(get(requiredInterfaces), put(deviceWatcher)));
...
template <typename D> Windows::Devices::AllJoyn::AllJoynAuthenticationMechanism impl_IAllJoynCredentials<D>::AuthenticationMechanism() const
{
    ...
    check_hresult(shim()->get_AuthenticationMechanism(&value));
    return value;
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynCredentials impl_IAllJoynCredentialsRequestedEventArgs<D>::Credentials() const
{
    ...
    check_hresult(shim()->get_Credentials(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_PeerUniqueName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_RequestedUserName(put(value)));
    return value;
}
...
{
    Windows::Security::Cryptography::Certificates::Certificate value { nullptr };
    check_hresult(shim()->get_PeerCertificate(put(value)));
    return value;
}
...
template <typename D> Windows::Networking::Sockets::SocketSslErrorSeverity impl_IAllJoynCredentialsVerificationRequestedEventArgs<D>::PeerCertificateErrorSeverity() const
{
    ...
    check_hresult(shim()->get_PeerCertificateErrorSeverity(&value));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<winrt::Windows::Security::Cryptography::Certificates::ChainValidationResult> impl_IAllJoynCredentialsVerificationRequestedEventArgs<D>::PeerCertificateErrors() const
{
    ...
    check_hresult(shim()->get_PeerCertificateErrors(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::Security::Cryptography::Certificates::Certificate> impl_IAllJoynCredentialsVerificationRequestedEventArgs<D>::PeerIntermediateCertificates() const
{
    ...
    check_hresult(shim()->get_PeerIntermediateCertificates(put(value)));
    return value;
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynBusAttachment impl_IAllJoynBusAttachmentFactory<D>::Create(hstring_ref connectionSpecification) const
{
    ...
    check_hresult(shim()->abi_Create(get(connectionSpecification), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<int32_t> operation;
    check_hresult(shim()->abi_RemoveMemberAsync(get(uniqueName), put(operation)));
    return operation;
}
...
{
    event_token token {};
    check_hresult(shim()->add_MemberAdded(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_MemberAdded(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_MemberRemoved(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_MemberRemoved(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_Lost(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_Lost(token));
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Devices::AllJoyn::AllJoynSession> impl_IAllJoynSessionStatics<D>::GetFromServiceInfoAsync(const Windows::Devices::AllJoyn::AllJoynServiceInfo & serviceInfo) const
{
    ...
    check_hresult(shim()->abi_GetFromServiceInfoAsync(get(serviceInfo), put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Devices::AllJoyn::AllJoynSession> operation;
    check_hresult(shim()->abi_GetFromServiceInfoAndBusAttachmentAsync(get(serviceInfo), get(busAttachment), put(operation)));
    return operation;
}
...
{
    check_hresult(shim()->abi_SetBusObject(get(busObject)));
}
...
{
    check_hresult(shim()->abi_AddProducer(get(producer)));
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynBusAttachment impl_IAllJoynBusObject<D>::BusAttachment() const
{
    ...
    check_hresult(shim()->get_BusAttachment(put(value)));
    return value;
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynBusObject impl_IAllJoynBusObjectFactory<D>::Create(hstring_ref objectPath) const
{
    ...
    check_hresult(shim()->abi_Create(get(objectPath), put(result)));
    return result;
}
...
{
    Windows::Devices::AllJoyn::AllJoynBusObject result { nullptr };
    check_hresult(shim()->abi_CreateWithBusAttachment(get(objectPath), get(busAttachment), put(result)));
    return result;
}
...
{
    hstring value;
    check_hresult(shim()->get_ObjectPath(put(value)));
    return value;
}
...
{
    uint16_t value {};
    check_hresult(shim()->get_SessionPort(&value));
    return value;
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynServiceInfo impl_IAllJoynServiceInfoFactory<D>::Create(hstring_ref uniqueName, hstring_ref objectPath, uint16_t sessionPort) const
{
    ...
    check_hresult(shim()->abi_Create(get(uniqueName), get(objectPath), sessionPort, put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Devices::AllJoyn::AllJoynAboutDataView> operation;
    check_hresult(shim()->abi_GetDataBySessionPortAsync(get(uniqueName), get(busAttachment), sessionPort, put(operation)));
    return operation;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Devices::AllJoyn::AllJoynAboutDataView> operation;
    check_hresult(shim()->abi_GetDataBySessionPortWithLanguageAsync(get(uniqueName), get(busAttachment), sessionPort, get(language), put(operation)));
    return operation;
}
...
{
    hstring value;
    check_hresult(shim()->get_AJSoftwareVersion(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IReference<Windows::Foundation::DateTime> impl_IAllJoynAboutDataView<D>::DateOfManufacture() const
{
    ...
    check_hresult(shim()->get_DateOfManufacture(put(value)));
    return value;
}
...
template <typename D> Windows::Globalization::Language impl_IAllJoynAboutDataView<D>::DefaultLanguage() const
{
    ...
    check_hresult(shim()->get_DefaultLanguage(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_HardwareVersion(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_ModelNumber(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_SoftwareVersion(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<Windows::Globalization::Language> impl_IAllJoynAboutDataView<D>::SupportedLanguages() const
{
    ...
    check_hresult(shim()->get_SupportedLanguages(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Uri impl_IAllJoynAboutDataView<D>::SupportUrl() const
{
    ...
    check_hresult(shim()->get_SupportUrl(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_DeviceName(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_DefaultAppName(put(value)));
    return value;
}

template <typename D> void impl_IAllJoynAboutData<D>::DefaultAppName(hstring_ref value) const
{
    check_hresult(shim()->put_DefaultAppName(get(value)));
}
...
template <typename D> Windows::Foundation::Collections::IMap<hstring, hstring> impl_IAllJoynAboutData<D>::AppNames() const
{
    ...
    check_hresult(shim()->get_AppNames(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_ModelNumber(get(value)));
}
...
{
    check_hresult(shim()->put_SoftwareVersion(get(value)));
}
...
{
    check_hresult(shim()->put_SupportUrl(get(value)));
}
...
{
    check_hresult(shim()->put_AppId(value));
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynTrafficType impl_IAllJoynAcceptSessionJoinerEventArgs<D>::TrafficType() const
{
    ...
    check_hresult(shim()->get_TrafficType(&value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_SamePhysicalNode(&value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_SameNetwork(&value));
    return value;
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynAcceptSessionJoinerEventArgs impl_IAllJoynAcceptSessionJoinerEventArgsFactory<D>::Create(hstring_ref uniqueName, uint16_t sessionPort, Windows::Devices::AllJoyn::AllJoynTrafficType trafficType, uint8_t proximity, const Windows::Devices::AllJoyn::IAllJoynAcceptSessionJoiner & acceptSessionJoiner) const
{
    ...
    check_hresult(shim()->abi_Create(get(uniqueName), sessionPort, trafficType, proximity, get(acceptSessionJoiner), put(result)));
    return result;
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs impl_IAllJoynSessionMemberAddedEventArgsFactory<D>::Create(hstring_ref uniqueName) const
{
    ...
    check_hresult(shim()->abi_Create(get(uniqueName), put(result)));
    return result;
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynSessionJoinedEventArgs impl_IAllJoynSessionJoinedEventArgsFactory<D>::Create(const Windows::Devices::AllJoyn::AllJoynSession & session) const
{
    ...
    check_hresult(shim()->abi_Create(get(session), put(result)));
    return result;
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs impl_IAllJoynSessionLostEventArgsFactory<D>::Create(Windows::Devices::AllJoyn::AllJoynSessionLostReason reason) const
{
    ...
    check_hresult(shim()->abi_Create(reason, put(result)));
    return result;
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs impl_IAllJoynProducerStoppedEventArgsFactory<D>::Create(int32_t status) const
{
    ...
    check_hresult(shim()->abi_Create(status, put(result)));
    return result;
}
...
{
    hstring value;
    check_hresult(shim()->get_SenderUniqueName(put(value)));
    return value;
}
...
template <typename D> Windows::Devices::AllJoyn::AllJoynMessageInfo impl_IAllJoynMessageInfoFactory<D>::Create(hstring_ref senderUniqueName) const
{
    ...
    check_hresult(shim()->abi_Create(get(senderUniqueName), put(result)));
    return result;
}
