...
struct consume_Windows_UI_Xaml_Markup_IXamlBindingHelperStatics
{
    ...
    void SetPropertyFromChar16(Windows::Foundation::IInspectable const& dependencyObject, Windows::UI::Xaml::DependencyProperty const& propertyToSet, wchar_t value) const;
...
template <> struct abi<Windows::UI::Xaml::Markup::IXamlBindingHelperStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall SetPropertyFromChar16(::IUnknown* dependencyObject, ::IUnknown* propertyToSet, wchar_t value) = 0;
