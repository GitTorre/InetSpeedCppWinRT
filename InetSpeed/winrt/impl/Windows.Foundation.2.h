...
struct PropertyValue
{
    ...
    static Windows::Foundation::IInspectable CreateChar16(wchar_t value);
    ...
    static Windows::Foundation::IInspectable CreateChar16Array(array_view<wchar_t const> value);
