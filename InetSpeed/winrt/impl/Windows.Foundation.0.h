...
struct consume_Windows_Foundation_IPropertyValueStatics
{
    ...
    Windows::Foundation::IInspectable CreateChar16(wchar_t value) const;
    ...
    Windows::Foundation::IInspectable CreateChar16Array(array_view<wchar_t const> value) const;
...
template <> struct abi<Windows::Foundation::IPropertyValue>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall GetChar16(wchar_t* value) = 0;
    ...
    virtual HRESULT __stdcall GetChar16Array(uint32_t* __valueSize, wchar_t** value) = 0;
...
template <> struct abi<Windows::Foundation::IPropertyValueStatics>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall CreateChar16(wchar_t value, ::IUnknown** propertyValue) = 0;
    ...
    virtual HRESULT __stdcall CreateChar16Array(uint32_t __valueSize, wchar_t* value, ::IUnknown** propertyValue) = 0;
