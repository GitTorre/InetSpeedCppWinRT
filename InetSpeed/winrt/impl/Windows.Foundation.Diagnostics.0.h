...
struct consume_Windows_Foundation_Diagnostics_ILoggingFields
{
    ...
    void AddChar16(param::hstring const& name, wchar_t value) const;
    void AddChar16(param::hstring const& name, wchar_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat const& format) const;
    void AddChar16(param::hstring const& name, wchar_t value, Windows::Foundation::Diagnostics::LoggingFieldFormat const& format, int32_t tags) const;
    void AddChar16Array(param::hstring const& name, array_view<wchar_t const> value) const;
    void AddChar16Array(param::hstring const& name, array_view<wchar_t const> value, Windows::Foundation::Diagnostics::LoggingFieldFormat const& format) const;
    void AddChar16Array(param::hstring const& name, array_view<wchar_t const> value, Windows::Foundation::Diagnostics::LoggingFieldFormat const& format, int32_t tags) const;
...
template <> struct abi<Windows::Foundation::Diagnostics::ILoggingFields>{ struct type : ::IInspectable
{
    ...
    virtual HRESULT __stdcall AddChar16(HSTRING name, wchar_t value) = 0;
    virtual HRESULT __stdcall AddChar16WithFormat(HSTRING name, wchar_t value, abi_t<Windows::Foundation::Diagnostics::LoggingFieldFormat> format) = 0;
    virtual HRESULT __stdcall AddChar16WithFormatAndTags(HSTRING name, wchar_t value, abi_t<Windows::Foundation::Diagnostics::LoggingFieldFormat> format, int32_t tags) = 0;
    virtual HRESULT __stdcall AddChar16Array(HSTRING name, uint32_t __valueSize, wchar_t* value) = 0;
    virtual HRESULT __stdcall AddChar16ArrayWithFormat(HSTRING name, uint32_t __valueSize, wchar_t* value, abi_t<Windows::Foundation::Diagnostics::LoggingFieldFormat> format) = 0;
    virtual HRESULT __stdcall AddChar16ArrayWithFormatAndTags(HSTRING name, uint32_t __valueSize, wchar_t* value, abi_t<Windows::Foundation::Diagnostics::LoggingFieldFormat> format, int32_t tags) = 0;
