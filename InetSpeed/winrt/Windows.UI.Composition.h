...
template <typename D> Windows::UI::Composition::CompositionColorSpace impl_IColorKeyFrameAnimation<D>::InterpolationColorSpace() const
{
    ...
    check_hresult(shim()->get_InterpolationColorSpace(&value));
    return value;
}
...
{
    check_hresult(shim()->put_InterpolationColorSpace(value));
}
...
{
    check_hresult(shim()->abi_InsertKeyFrame(normalizedProgressKey, get(value)));
}
...
{
    check_hresult(shim()->abi_InsertKeyFrameWithEasingFunction(normalizedProgressKey, get(value), get(easingFunction)));
}

template <typename D> void impl_ICompositionAnimation<D>::ClearAllParameters() const
{
    check_hresult(shim()->abi_ClearAllParameters());
}

template <typename D> void impl_ICompositionAnimation<D>::ClearParameter(hstring_ref key) const
{
    check_hresult(shim()->abi_ClearParameter(get(key)));
}
...
{
    check_hresult(shim()->abi_SetColorParameter(get(key), get(value)));
}
...
{
    check_hresult(shim()->abi_SetMatrix3x2Parameter(get(key), get(value)));
}
...
{
    check_hresult(shim()->abi_SetMatrix4x4Parameter(get(key), get(value)));
}
...
{
    check_hresult(shim()->abi_SetQuaternionParameter(get(key), get(value)));
}
...
{
    check_hresult(shim()->abi_SetReferenceParameter(get(key), get(compositionObject)));
}

template <typename D> void impl_ICompositionAnimation<D>::SetScalarParameter(hstring_ref key, float value) const
{
    check_hresult(shim()->abi_SetScalarParameter(get(key), value));
}
...
{
    check_hresult(shim()->abi_SetVector2Parameter(get(key), get(value)));
}
...
{
    check_hresult(shim()->abi_SetVector3Parameter(get(key), get(value)));
}
...
{
    check_hresult(shim()->abi_SetVector4Parameter(get(key), get(value)));
}

template <typename D> void impl_ICompositionAnimation2<D>::SetBooleanParameter(hstring_ref key, bool value) const
{
    check_hresult(shim()->abi_SetBooleanParameter(get(key), value));
}
...
{
    bool value {};
    check_hresult(shim()->get_IsEnded(&value));
    return value;
}
...
template <typename D> Windows::Graphics::DirectX::DirectXAlphaMode impl_ICompositionDrawingSurface<D>::AlphaMode() const
{
    ...
    check_hresult(shim()->get_AlphaMode(&value));
    return value;
}
...
template <typename D> Windows::Graphics::DirectX::DirectXPixelFormat impl_ICompositionDrawingSurface<D>::PixelFormat() const
{
    ...
    check_hresult(shim()->get_PixelFormat(&value));
    return value;
}
...
template <typename D> Windows::UI::Composition::CompositionBrush impl_ICompositionEffectBrush<D>::GetSourceParameter(hstring_ref name) const
{
    ...
    check_hresult(shim()->abi_GetSourceParameter(get(name), put(result)));
    return result;
}
...
{
    check_hresult(shim()->abi_SetSourceParameter(get(name), get(source)));
}
...
template <typename D> Windows::UI::Composition::CompositionEffectBrush impl_ICompositionEffectFactory<D>::CreateBrush() const
{
    ...
    check_hresult(shim()->abi_CreateBrush(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CompositionEffectFactoryLoadStatus impl_ICompositionEffectFactory<D>::LoadStatus() const
{
    ...
    check_hresult(shim()->get_LoadStatus(&value));
    return value;
}
...
template <typename D> Windows::UI::Composition::CompositionEffectSourceParameter impl_ICompositionEffectSourceParameterFactory<D>::Create(hstring_ref name) const
{
    ...
    check_hresult(shim()->abi_Create(get(name), put(instance)));
    return instance;
}
...
template <typename D> Windows::UI::Composition::CompositionDrawingSurface impl_ICompositionGraphicsDevice<D>::CreateDrawingSurface(const Windows::Foundation::Size & sizePixels, Windows::Graphics::DirectX::DirectXPixelFormat pixelFormat, Windows::Graphics::DirectX::DirectXAlphaMode alphaMode) const
{
    ...
    check_hresult(shim()->abi_CreateDrawingSurface(get(sizePixels), pixelFormat, alphaMode, put(result)));
    return result;
}
...
{
    event_token token {};
    check_hresult(shim()->add_RenderingDeviceReplaced(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_RenderingDeviceReplaced(token));
}
...
template <typename D> Windows::UI::Composition::VisualUnorderedCollection impl_ICompositionLight<D>::Targets() const
{
    ...
    check_hresult(shim()->get_Targets(put(value)));
    return value;
}
...
{
    check_hresult(shim()->abi_SetInsetScalesWithValues(left, top, right, bottom));
}
...
{
    check_hresult(shim()->abi_StartAnimation(get(propertyName), get(animation)));
}

template <typename D> void impl_ICompositionObject<D>::StopAnimation(hstring_ref propertyName) const
{
    check_hresult(shim()->abi_StopAnimation(get(propertyName)));
}
...
template <typename D> Windows::UI::Composition::ImplicitAnimationCollection impl_ICompositionObject2<D>::ImplicitAnimations() const
{
    ...
    check_hresult(shim()->get_ImplicitAnimations(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_ImplicitAnimations(get(value)));
}
...
{
    check_hresult(shim()->abi_StartAnimationGroup(get(value)));
}
...
{
    check_hresult(shim()->abi_StopAnimationGroup(get(value)));
}
...
{
    check_hresult(shim()->abi_InsertColor(get(propertyName), get(value)));
}
...
{
    check_hresult(shim()->abi_InsertMatrix3x2(get(propertyName), get(value)));
}
...
{
    check_hresult(shim()->abi_InsertMatrix4x4(get(propertyName), get(value)));
}
...
{
    check_hresult(shim()->abi_InsertQuaternion(get(propertyName), get(value)));
}

template <typename D> void impl_ICompositionPropertySet<D>::InsertScalar(hstring_ref propertyName, float value) const
{
    check_hresult(shim()->abi_InsertScalar(get(propertyName), value));
}
...
{
    check_hresult(shim()->abi_InsertVector2(get(propertyName), get(value)));
}
...
{
    check_hresult(shim()->abi_InsertVector3(get(propertyName), get(value)));
}
...
{
    check_hresult(shim()->abi_InsertVector4(get(propertyName), get(value)));
}
...
template <typename D> Windows::UI::Composition::CompositionGetValueStatus impl_ICompositionPropertySet<D>::TryGetColor(hstring_ref propertyName, Windows::UI::Color & value) const
{
    ...
    check_hresult(shim()->abi_TryGetColor(get(propertyName), put(value), &result));
    return result;
}
...
{
    Windows::UI::Composition::CompositionGetValueStatus result {};
    check_hresult(shim()->abi_TryGetMatrix3x2(get(propertyName), put(value), &result));
    return result;
}
...
{
    Windows::UI::Composition::CompositionGetValueStatus result {};
    check_hresult(shim()->abi_TryGetMatrix4x4(get(propertyName), put(value), &result));
    return result;
}
...
{
    Windows::UI::Composition::CompositionGetValueStatus result {};
    check_hresult(shim()->abi_TryGetQuaternion(get(propertyName), put(value), &result));
    return result;
}
...
{
    Windows::UI::Composition::CompositionGetValueStatus result {};
    check_hresult(shim()->abi_TryGetScalar(get(propertyName), &value, &result));
    return result;
}
...
{
    Windows::UI::Composition::CompositionGetValueStatus result {};
    check_hresult(shim()->abi_TryGetVector2(get(propertyName), put(value), &result));
    return result;
}
...
{
    Windows::UI::Composition::CompositionGetValueStatus result {};
    check_hresult(shim()->abi_TryGetVector3(get(propertyName), put(value), &result));
    return result;
}
...
{
    Windows::UI::Composition::CompositionGetValueStatus result {};
    check_hresult(shim()->abi_TryGetVector4(get(propertyName), put(value), &result));
    return result;
}

template <typename D> void impl_ICompositionPropertySet2<D>::InsertBoolean(hstring_ref propertyName, bool value) const
{
    check_hresult(shim()->abi_InsertBoolean(get(propertyName), value));
}
...
{
    Windows::UI::Composition::CompositionGetValueStatus result {};
    check_hresult(shim()->abi_TryGetBoolean(get(propertyName), &value, &result));
    return result;
}
...
{
    check_hresult(shim()->abi_Suspend());
}
...
template <typename D> Windows::UI::Composition::CompositionBitmapInterpolationMode impl_ICompositionSurfaceBrush<D>::BitmapInterpolationMode() const
{
    ...
    check_hresult(shim()->get_BitmapInterpolationMode(&value));
    return value;
}
...
template <typename D> Windows::UI::Composition::ICompositionSurface impl_ICompositionSurfaceBrush<D>::Surface() const
{
    ...
    check_hresult(shim()->get_Surface(put(value)));
    return value;
}
...
template <typename D> Windows::UI::Composition::ColorKeyFrameAnimation impl_ICompositor<D>::CreateColorKeyFrameAnimation() const
{
    ...
    check_hresult(shim()->abi_CreateColorKeyFrameAnimation(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CompositionColorBrush impl_ICompositor<D>::CreateColorBrush() const
{
    ...
    check_hresult(shim()->abi_CreateColorBrush(put(result)));
    return result;
}
...
{
    Windows::UI::Composition::CompositionColorBrush result { nullptr };
    check_hresult(shim()->abi_CreateColorBrushWithColor(get(color), put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::ContainerVisual impl_ICompositor<D>::CreateContainerVisual() const
{
    ...
    check_hresult(shim()->abi_CreateContainerVisual(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CubicBezierEasingFunction impl_ICompositor<D>::CreateCubicBezierEasingFunction(const Windows::Foundation::Numerics::float2 & controlPoint1, const Windows::Foundation::Numerics::float2 & controlPoint2) const
{
    ...
    check_hresult(shim()->abi_CreateCubicBezierEasingFunction(get(controlPoint1), get(controlPoint2), put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CompositionEffectFactory impl_ICompositor<D>::CreateEffectFactory(const Windows::Graphics::Effects::IGraphicsEffect & graphicsEffect) const
{
    ...
    check_hresult(shim()->abi_CreateEffectFactory(get(graphicsEffect), put(result)));
    return result;
}
...
{
    Windows::UI::Composition::CompositionEffectFactory result { nullptr };
    check_hresult(shim()->abi_CreateEffectFactoryWithProperties(get(graphicsEffect), get(animatableProperties), put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::ExpressionAnimation impl_ICompositor<D>::CreateExpressionAnimation() const
{
    ...
    check_hresult(shim()->abi_CreateExpressionAnimation(put(result)));
    return result;
}
...
{
    Windows::UI::Composition::ExpressionAnimation result { nullptr };
    check_hresult(shim()->abi_CreateExpressionAnimationWithExpression(get(expression), put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::InsetClip impl_ICompositor<D>::CreateInsetClip() const
{
    ...
    check_hresult(shim()->abi_CreateInsetClip(put(result)));
    return result;
}
...
{
    Windows::UI::Composition::InsetClip result { nullptr };
    check_hresult(shim()->abi_CreateInsetClipWithInsets(leftInset, topInset, rightInset, bottomInset, put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::LinearEasingFunction impl_ICompositor<D>::CreateLinearEasingFunction() const
{
    ...
    check_hresult(shim()->abi_CreateLinearEasingFunction(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CompositionPropertySet impl_ICompositor<D>::CreatePropertySet() const
{
    ...
    check_hresult(shim()->abi_CreatePropertySet(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::QuaternionKeyFrameAnimation impl_ICompositor<D>::CreateQuaternionKeyFrameAnimation() const
{
    ...
    check_hresult(shim()->abi_CreateQuaternionKeyFrameAnimation(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::ScalarKeyFrameAnimation impl_ICompositor<D>::CreateScalarKeyFrameAnimation() const
{
    ...
    check_hresult(shim()->abi_CreateScalarKeyFrameAnimation(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CompositionScopedBatch impl_ICompositor<D>::CreateScopedBatch(Windows::UI::Composition::CompositionBatchTypes batchType) const
{
    ...
    check_hresult(shim()->abi_CreateScopedBatch(batchType, put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::SpriteVisual impl_ICompositor<D>::CreateSpriteVisual() const
{
    ...
    check_hresult(shim()->abi_CreateSpriteVisual(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CompositionSurfaceBrush impl_ICompositor<D>::CreateSurfaceBrush() const
{
    ...
    check_hresult(shim()->abi_CreateSurfaceBrush(put(result)));
    return result;
}
...
{
    Windows::UI::Composition::CompositionSurfaceBrush result { nullptr };
    check_hresult(shim()->abi_CreateSurfaceBrushWithSurface(get(surface), put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CompositionTarget impl_ICompositor<D>::CreateTargetForCurrentView() const
{
    ...
    check_hresult(shim()->abi_CreateTargetForCurrentView(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::Vector2KeyFrameAnimation impl_ICompositor<D>::CreateVector2KeyFrameAnimation() const
{
    ...
    check_hresult(shim()->abi_CreateVector2KeyFrameAnimation(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::Vector3KeyFrameAnimation impl_ICompositor<D>::CreateVector3KeyFrameAnimation() const
{
    ...
    check_hresult(shim()->abi_CreateVector3KeyFrameAnimation(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::Vector4KeyFrameAnimation impl_ICompositor<D>::CreateVector4KeyFrameAnimation() const
{
    ...
    check_hresult(shim()->abi_CreateVector4KeyFrameAnimation(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CompositionCommitBatch impl_ICompositor<D>::GetCommitBatch(Windows::UI::Composition::CompositionBatchTypes batchType) const
{
    ...
    check_hresult(shim()->abi_GetCommitBatch(batchType, put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::AmbientLight impl_ICompositor2<D>::CreateAmbientLight() const
{
    ...
    check_hresult(shim()->abi_CreateAmbientLight(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CompositionAnimationGroup impl_ICompositor2<D>::CreateAnimationGroup() const
{
    ...
    check_hresult(shim()->abi_CreateAnimationGroup(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CompositionBackdropBrush impl_ICompositor2<D>::CreateBackdropBrush() const
{
    ...
    check_hresult(shim()->abi_CreateBackdropBrush(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::DistantLight impl_ICompositor2<D>::CreateDistantLight() const
{
    ...
    check_hresult(shim()->abi_CreateDistantLight(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::DropShadow impl_ICompositor2<D>::CreateDropShadow() const
{
    ...
    check_hresult(shim()->abi_CreateDropShadow(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::ImplicitAnimationCollection impl_ICompositor2<D>::CreateImplicitAnimationCollection() const
{
    ...
    check_hresult(shim()->abi_CreateImplicitAnimationCollection(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::LayerVisual impl_ICompositor2<D>::CreateLayerVisual() const
{
    ...
    check_hresult(shim()->abi_CreateLayerVisual(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CompositionMaskBrush impl_ICompositor2<D>::CreateMaskBrush() const
{
    ...
    check_hresult(shim()->abi_CreateMaskBrush(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::CompositionNineGridBrush impl_ICompositor2<D>::CreateNineGridBrush() const
{
    ...
    check_hresult(shim()->abi_CreateNineGridBrush(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::PointLight impl_ICompositor2<D>::CreatePointLight() const
{
    ...
    check_hresult(shim()->abi_CreatePointLight(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::SpotLight impl_ICompositor2<D>::CreateSpotLight() const
{
    ...
    check_hresult(shim()->abi_CreateSpotLight(put(result)));
    return result;
}
...
template <typename D> Windows::UI::Composition::StepEasingFunction impl_ICompositor2<D>::CreateStepEasingFunction() const
{
    ...
    check_hresult(shim()->abi_CreateStepEasingFunction(put(result)));
    return result;
}
...
{
    Windows::UI::Composition::StepEasingFunction result { nullptr };
    check_hresult(shim()->abi_CreateStepEasingFunctionWithStepCount(stepCount, put(result)));
    return result;
}
...
{
    Windows::Foundation::Numerics::float2 value {};
    check_hresult(shim()->get_ControlPoint1(put(value)));
    return value;
}
...
{
    Windows::Foundation::Numerics::float2 value {};
    check_hresult(shim()->get_ControlPoint2(put(value)));
    return value;
}
...
{
    float value {};
    check_hresult(shim()->get_BlurRadius(&value));
    return value;
}

template <typename D> void impl_IDropShadow<D>::BlurRadius(float value) const
{
    check_hresult(shim()->put_BlurRadius(value));
}
...
template <typename D> Windows::UI::Composition::AnimationIterationBehavior impl_IKeyFrameAnimation<D>::IterationBehavior() const
{
    ...
    check_hresult(shim()->get_IterationBehavior(&value));
    return value;
}
...
{
    check_hresult(shim()->put_IterationBehavior(value));
}
...
{
    check_hresult(shim()->put_IterationCount(value));
}

template <typename D> int32_t impl_IKeyFrameAnimation<D>::KeyFrameCount() const
{
    int32_t value {};
    check_hresult(shim()->get_KeyFrameCount(&value));
    return value;
}
...
{
    check_hresult(shim()->abi_InsertExpressionKeyFrame(normalizedProgressKey, get(value)));
}
...
{
    check_hresult(shim()->abi_InsertExpressionKeyFrameWithEasingFunction(normalizedProgressKey, get(value), get(easingFunction)));
}
...
{
    float value {};
    check_hresult(shim()->get_ConstantAttenuation(&value));
    return value;
}

template <typename D> void impl_IPointLight<D>::ConstantAttenuation(float value) const
{
    check_hresult(shim()->put_ConstantAttenuation(value));
}
...
{
    float value {};
    check_hresult(shim()->get_LinearAttenuation(&value));
    return value;
}

template <typename D> void impl_IPointLight<D>::LinearAttenuation(float value) const
{
    check_hresult(shim()->put_LinearAttenuation(value));
}
...
{
    float value {};
    check_hresult(shim()->get_QuadraticAttenuation(&value));
    return value;
}

template <typename D> void impl_IPointLight<D>::QuadraticAttenuation(float value) const
{
    check_hresult(shim()->put_QuadraticAttenuation(value));
}
...
{
    check_hresult(shim()->abi_InsertKeyFrameWithEasingFunction(normalizedProgressKey, value, get(easingFunction)));
}
...
template <typename D> Windows::UI::Composition::CompositionBackfaceVisibility impl_IVisual<D>::BackfaceVisibility() const
{
    ...
    check_hresult(shim()->get_BackfaceVisibility(&value));
    return value;
}
...
{
    check_hresult(shim()->put_BackfaceVisibility(value));
}
