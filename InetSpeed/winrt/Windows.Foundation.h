...
template <typename D> wchar_t consume_Windows_Foundation_IPropertyValue<D>::GetChar16() const
{
    wchar_t value{};
...
template <typename D> void consume_Windows_Foundation_IPropertyValue<D>::GetChar16Array(com_array<wchar_t>& value) const
{
...
template <typename D> Windows::Foundation::IInspectable consume_Windows_Foundation_IPropertyValueStatics<D>::CreateChar16(wchar_t value) const
{
    Windows::Foundation::IInspectable propertyValue{ nullptr };
...
template <typename D> Windows::Foundation::IInspectable consume_Windows_Foundation_IPropertyValueStatics<D>::CreateChar16Array(array_view<wchar_t const> value) const
{
    Windows::Foundation::IInspectable propertyValue{ nullptr };
...
struct produce<D, Windows::Foundation::IPropertyValue> : produce_base<D, Windows::Foundation::IPropertyValue>
{
    ...
    HRESULT __stdcall GetChar16(wchar_t* value) noexcept override
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall GetChar16Array(uint32_t* __valueSize, wchar_t** value) noexcept override
    {
        try
        {
            typename D::abi_guard guard(this->shim());
...
struct produce<D, Windows::Foundation::IPropertyValueStatics> : produce_base<D, Windows::Foundation::IPropertyValueStatics>
{
    ...
    HRESULT __stdcall CreateChar16(wchar_t value, ::IUnknown** propertyValue) noexcept override
    {
        try
        {
            typename D::abi_guard guard(this->shim());
    ...
    HRESULT __stdcall CreateChar16Array(uint32_t __valueSize, wchar_t* value, ::IUnknown** propertyValue) noexcept override
    {
        try
        {
            typename D::abi_guard guard(this->shim());
            *propertyValue = detach_abi(this->shim().CreateChar16Array(array_view<wchar_t const>(reinterpret_cast<wchar_t const *>(value), reinterpret_cast<wchar_t const *>(value) + __valueSize)));
            return S_OK;
        }
        catch (...)
        {
...
inline Windows::Foundation::IInspectable PropertyValue::CreateChar16Array(array_view<wchar_t const> value)
{
