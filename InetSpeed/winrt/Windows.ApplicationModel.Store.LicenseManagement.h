...
template <typename D> Windows::Foundation::Collections::IMapView<hstring, Windows::ApplicationModel::Store::LicenseManagement::LicenseSatisfactionInfo> impl_ILicenseSatisfactionResult<D>::LicenseSatisfactionInfos() const
{
    ...
    check_hresult(shim()->get_LicenseSatisfactionInfos(put(value)));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_SatisfiedByDevice(&value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_SatisfiedByOpenLicense(&value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_SatisfiedByTrial(&value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_SatisfiedByPass(&value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_SatisfiedByInstallMedia(&value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_SatisfiedBySignedInUser(&value));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_IsSatisfied(&value));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncAction impl_ILicenseManagerStatics<D>::AddLicenseAsync(const Windows::Storage::Streams::IBuffer & license) const
{
    ...
    check_hresult(shim()->abi_AddLicenseAsync(get(license), put(action)));
    return action;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::ApplicationModel::Store::LicenseManagement::LicenseSatisfactionResult> impl_ILicenseManagerStatics<D>::GetSatisfactionInfosAsync(const Windows::Foundation::Collections::IIterable<hstring> & contentIds, const Windows::Foundation::Collections::IIterable<hstring> & keyIds) const
{
    ...
    check_hresult(shim()->abi_GetSatisfactionInfosAsync(get(contentIds), get(keyIds), put(operation)));
    return operation;
}
