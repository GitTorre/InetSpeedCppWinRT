...
{
    bool value {};
    check_hresult(shim()->get_PhotoConfirmationSupported(&value));
    return value;
}
...
template <typename D> Windows::Media::Devices::Core::FrameFlashCapabilities impl_IFrameControlCapabilities2<D>::Flash() const
{
    ...
    check_hresult(shim()->get_Flash(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IReference<bool> impl_IFrameController<D>::PhotoConfirmationEnabled() const
{
    ...
    check_hresult(shim()->get_PhotoConfirmationEnabled(put(value)));
    return value;
}
...
{
    check_hresult(shim()->put_PhotoConfirmationEnabled(get(value)));
}
...
template <typename D> Windows::Media::Devices::Core::FrameControlCapabilities impl_IVariablePhotoSequenceController<D>::FrameCapabilities() const
{
    ...
    check_hresult(shim()->get_FrameCapabilities(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::Collections::IVector<Windows::Media::Devices::Core::FrameController> impl_IVariablePhotoSequenceController<D>::DesiredFrameControllers() const
{
    ...
    check_hresult(shim()->get_DesiredFrameControllers(put(items)));
    return items;
}
...
template <typename D> Windows::Media::Devices::Core::CameraIntrinsics impl_ICameraIntrinsicsFactory<D>::Create(const Windows::Foundation::Numerics::float2 & focalLength, const Windows::Foundation::Numerics::float2 & principalPoint, const Windows::Foundation::Numerics::float3 & radialDistortion, const Windows::Foundation::Numerics::float2 & tangentialDistortion, uint32_t imageWidth, uint32_t imageHeight) const
{
    ...
    check_hresult(shim()->abi_Create(get(focalLength), get(principalPoint), get(radialDistortion), get(tangentialDistortion), imageWidth, imageHeight, put(result)));
    return result;
}
...
{
    uint32_t value {};
    check_hresult(shim()->get_ImageWidth(&value));
    return value;
}
...
{
    uint32_t value {};
    check_hresult(shim()->get_ImageHeight(&value));
    return value;
}
...
template <typename D> Windows::Foundation::Point impl_ICameraIntrinsics<D>::ProjectOntoFrame(const Windows::Foundation::Numerics::float3 & coordinate) const
{
    ...
    check_hresult(shim()->abi_ProjectOntoFrame(get(coordinate), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::Numerics::float2 impl_ICameraIntrinsics<D>::UnprojectAtUnitDepth(const Windows::Foundation::Point & pixelCoordinate) const
{
    ...
    check_hresult(shim()->abi_UnprojectAtUnitDepth(get(pixelCoordinate), put(result)));
    return result;
}
...
{
    check_hresult(shim()->abi_ProjectManyOntoFrame(coordinates.size(), get(coordinates), results.size(), get(results)));
}
...
{
    check_hresult(shim()->abi_UnprojectPixelsAtUnitDepth(pixelCoordinates.size(), get(pixelCoordinates), results.size(), get(results)));
}
...
template <typename D> Windows::Foundation::Numerics::float4x4 impl_ICameraIntrinsics2<D>::UndistortedProjectionTransform() const
{
    ...
    check_hresult(shim()->get_UndistortedProjectionTransform(put(value)));
    return value;
}
...
{
    Windows::Foundation::Point result {};
    check_hresult(shim()->abi_DistortPoint(get(input), put(result)));
    return result;
}
...
{
    check_hresult(shim()->abi_DistortPoints(inputs.size(), get(inputs), results.size(), get(results)));
}
...
{
    Windows::Foundation::Point result {};
    check_hresult(shim()->abi_UndistortPoint(get(input), put(result)));
    return result;
}
...
{
    check_hresult(shim()->abi_UndistortPoints(inputs.size(), get(inputs), results.size(), get(results)));
}
...
template <typename D> Windows::Foundation::Numerics::float3 impl_IDepthCorrelatedCoordinateMapper<D>::UnprojectPoint(const Windows::Foundation::Point & sourcePoint, const Windows::Perception::Spatial::SpatialCoordinateSystem & targetCoordinateSystem) const
{
    ...
    check_hresult(shim()->abi_UnprojectPoint(get(sourcePoint), get(targetCoordinateSystem), put(result)));
    return result;
}
...
{
    check_hresult(shim()->abi_UnprojectPoints(sourcePoints.size(), get(sourcePoints), get(targetCoordinateSystem), results.size(), get(results)));
}
...
{
    Windows::Foundation::Point result {};
    check_hresult(shim()->abi_MapPoint(get(sourcePoint), get(targetCoordinateSystem), get(targetCameraIntrinsics), put(result)));
    return result;
}
...
{
    check_hresult(shim()->abi_MapPoints(sourcePoints.size(), get(sourcePoints), get(targetCoordinateSystem), get(targetCameraIntrinsics), results.size(), get(results)));
}
