...
template <typename D> Windows::Data::Json::JsonValueType impl_IJsonValue<D>::ValueType() const
{
    ...
    check_hresult(shim()->get_ValueType(&value));
    return value;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_Stringify(put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetString(put(returnValue)));
    return returnValue;
}
...
{
    double returnValue {};
    check_hresult(shim()->abi_GetNumber(&returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_GetBoolean(&returnValue));
    return returnValue;
}
...
template <typename D> Windows::Data::Json::JsonArray impl_IJsonValue<D>::GetArray() const
{
    ...
    check_hresult(shim()->abi_GetArray(put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::Data::Json::JsonObject impl_IJsonValue<D>::GetObject() const
{
    ...
    check_hresult(shim()->abi_GetObject(put(returnValue)));
    return returnValue;
}
...
template <typename D> Windows::Data::Json::JsonValue impl_IJsonValueStatics<D>::Parse(hstring_ref input) const
{
    ...
    check_hresult(shim()->abi_Parse(get(input), put(jsonValue)));
    return jsonValue;
}
...
{
    bool succeeded {};
    check_hresult(shim()->abi_TryParse(get(input), put(result), &succeeded));
    return succeeded;
}
...
{
    Windows::Data::Json::JsonValue jsonValue { nullptr };
    check_hresult(shim()->abi_CreateBooleanValue(input, put(jsonValue)));
    return jsonValue;
}
...
{
    Windows::Data::Json::JsonValue jsonValue { nullptr };
    check_hresult(shim()->abi_CreateNumberValue(input, put(jsonValue)));
    return jsonValue;
}
...
{
    Windows::Data::Json::JsonValue jsonValue { nullptr };
    check_hresult(shim()->abi_CreateStringValue(get(input), put(jsonValue)));
    return jsonValue;
}
...
{
    Windows::Data::Json::JsonValue jsonValue { nullptr };
    check_hresult(shim()->abi_CreateNullValue(put(jsonValue)));
    return jsonValue;
}
...
template <typename D> Windows::Data::Json::JsonValue impl_IJsonObject<D>::GetNamedValue(hstring_ref name) const
{
    ...
    check_hresult(shim()->abi_GetNamedValue(get(name), put(returnValue)));
    return returnValue;
}
...
{
    check_hresult(shim()->abi_SetNamedValue(get(name), get(value)));
}

template <typename D> Windows::Data::Json::JsonObject impl_IJsonObject<D>::GetNamedObject(hstring_ref name) const
{
    Windows::Data::Json::JsonObject returnValue { nullptr };
    check_hresult(shim()->abi_GetNamedObject(get(name), put(returnValue)));
    return returnValue;
}
...
{
    Windows::Data::Json::JsonArray returnValue { nullptr };
    check_hresult(shim()->abi_GetNamedArray(get(name), put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetNamedString(get(name), put(returnValue)));
    return returnValue;
}
...
{
    double returnValue {};
    check_hresult(shim()->abi_GetNamedNumber(get(name), &returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_GetNamedBoolean(get(name), &returnValue));
    return returnValue;
}
...
{
    Windows::Data::Json::JsonValue returnValue { nullptr };
    check_hresult(shim()->abi_GetNamedValueOrDefault(get(name), get(defaultValue), put(returnValue)));
    return returnValue;
}
...
{
    Windows::Data::Json::JsonObject returnValue { nullptr };
    check_hresult(shim()->abi_GetNamedObjectOrDefault(get(name), get(defaultValue), put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetNamedStringOrDefault(get(name), get(defaultValue), put(returnValue)));
    return returnValue;
}
...
{
    Windows::Data::Json::JsonArray returnValue { nullptr };
    check_hresult(shim()->abi_GetNamedArrayOrDefault(get(name), get(defaultValue), put(returnValue)));
    return returnValue;
}
...
{
    double returnValue {};
    check_hresult(shim()->abi_GetNamedNumberOrDefault(get(name), defaultValue, &returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_GetNamedBooleanOrDefault(get(name), defaultValue, &returnValue));
    return returnValue;
}
...
template <typename D> Windows::Data::Json::JsonObject impl_IJsonObjectStatics<D>::Parse(hstring_ref input) const
{
    ...
    check_hresult(shim()->abi_Parse(get(input), put(jsonObject)));
    return jsonObject;
}
...
{
    Windows::Data::Json::JsonObject returnValue { nullptr };
    check_hresult(shim()->abi_GetObjectAt(index, put(returnValue)));
    return returnValue;
}
...
{
    Windows::Data::Json::JsonArray returnValue { nullptr };
    check_hresult(shim()->abi_GetArrayAt(index, put(returnValue)));
    return returnValue;
}
...
{
    hstring returnValue;
    check_hresult(shim()->abi_GetStringAt(index, put(returnValue)));
    return returnValue;
}
...
{
    double returnValue {};
    check_hresult(shim()->abi_GetNumberAt(index, &returnValue));
    return returnValue;
}
...
{
    bool returnValue {};
    check_hresult(shim()->abi_GetBooleanAt(index, &returnValue));
    return returnValue;
}
...
template <typename D> Windows::Data::Json::JsonArray impl_IJsonArrayStatics<D>::Parse(hstring_ref input) const
{
    ...
    check_hresult(shim()->abi_Parse(get(input), put(jsonArray)));
    return jsonArray;
}
...
template <typename D> Windows::Data::Json::JsonErrorStatus impl_IJsonErrorStatics2<D>::GetJsonStatus(int32_t hresult) const
{
    ...
    check_hresult(shim()->abi_GetJsonStatus(hresult, &status));
    return status;
}
