...
template <typename D> wchar_t consume_Windows_UI_Text_ITextRange<D>::Character() const
{
    wchar_t value{};
...
template <typename D> void consume_Windows_UI_Text_ITextRange<D>::Character(wchar_t value) const
{
