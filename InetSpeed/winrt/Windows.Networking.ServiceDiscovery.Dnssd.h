...
{
    bool value {};
    check_hresult(shim()->get_HasInstanceNameChanged(&value));
    return value;
}
...
template <typename D> Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceInstance impl_IDnssdServiceInstanceFactory<D>::Create(hstring_ref dnssdServiceInstanceName, const Windows::Networking::HostName & hostName, uint16_t port) const
{
    ...
    check_hresult(shim()->abi_Create(get(dnssdServiceInstanceName), get(hostName), port, put(result)));
    return result;
}
...
{
    hstring value;
    check_hresult(shim()->get_DnssdServiceInstanceName(put(value)));
    return value;
}

template <typename D> void impl_IDnssdServiceInstance<D>::DnssdServiceInstanceName(hstring_ref value) const
{
    check_hresult(shim()->put_DnssdServiceInstanceName(get(value)));
}
...
{
    check_hresult(shim()->put_HostName(get(value)));
}
...
{
    check_hresult(shim()->put_Port(value));
}
...
template <typename D> Windows::Foundation::Collections::IMap<hstring, hstring> impl_IDnssdServiceInstance<D>::TextAttributes() const
{
    ...
    check_hresult(shim()->get_TextAttributes(put(value)));
    return value;
}
...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::Networking::ServiceDiscovery::Dnssd::DnssdRegistrationResult> impl_IDnssdServiceInstance<D>::RegisterStreamSocketListenerAsync(const Windows::Networking::Sockets::StreamSocketListener & socket) const
{
    ...
    check_hresult(shim()->abi_RegisterStreamSocketListenerAsync1(get(socket), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Networking::ServiceDiscovery::Dnssd::DnssdRegistrationResult> result;
    check_hresult(shim()->abi_RegisterStreamSocketListenerAsync2(get(socket), get(adapter), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Networking::ServiceDiscovery::Dnssd::DnssdRegistrationResult> result;
    check_hresult(shim()->abi_RegisterDatagramSocketAsync1(get(socket), put(result)));
    return result;
}
...
{
    Windows::Foundation::IAsyncOperation<Windows::Networking::ServiceDiscovery::Dnssd::DnssdRegistrationResult> result;
    check_hresult(shim()->abi_RegisterDatagramSocketAsync2(get(socket), get(adapter), put(result)));
    return result;
}
