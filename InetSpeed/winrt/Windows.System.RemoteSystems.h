...
template <typename D> Windows::Foundation::IAsyncOperation<Windows::System::RemoteSystems::RemoteSystem> impl_IRemoteSystemStatics<D>::FindByHostNameAsync(const Windows::Networking::HostName & hostName) const
{
    ...
    check_hresult(shim()->abi_FindByHostNameAsync(get(hostName), put(operation)));
    return operation;
}
...
template <typename D> Windows::System::RemoteSystems::RemoteSystemWatcher impl_IRemoteSystemStatics<D>::CreateWatcher() const
{
    ...
    check_hresult(shim()->abi_CreateWatcher(put(result)));
    return result;
}
...
{
    Windows::System::RemoteSystems::RemoteSystemWatcher result { nullptr };
    check_hresult(shim()->abi_CreateWatcherWithFilters(get(filters), put(result)));
    return result;
}
...
{
    hstring value;
    check_hresult(shim()->get_Kind(put(value)));
    return value;
}
...
{
    bool value {};
    check_hresult(shim()->get_IsAvailableByProximity(&value));
    return value;
}
...
{
    event_token token {};
    check_hresult(shim()->add_RemoteSystemAdded(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_RemoteSystemAdded(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_RemoteSystemUpdated(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_RemoteSystemUpdated(token));
}
...
{
    event_token token {};
    check_hresult(shim()->add_RemoteSystemRemoved(get(handler), &token));
    return token;
}
...
{
    check_hresult(shim()->remove_RemoteSystemRemoved(token));
}
...
template <typename D> Windows::System::RemoteSystems::RemoteSystem impl_IRemoteSystemAddedEventArgs<D>::RemoteSystem() const
{
    ...
    check_hresult(shim()->get_RemoteSystem(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_RemoteSystemId(put(value)));
    return value;
}
...
template <typename D> Windows::System::RemoteSystems::RemoteSystemConnectionRequest impl_IRemoteSystemConnectionRequestFactory<D>::Create(const Windows::System::RemoteSystems::RemoteSystem & remoteSystem) const
{
    ...
    check_hresult(shim()->abi_Create(get(remoteSystem), put(result)));
    return result;
}
...
{
    hstring value;
    check_hresult(shim()->get_Phone(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_Hub(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_Holographic(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_Desktop(put(value)));
    return value;
}
...
{
    hstring value;
    check_hresult(shim()->get_Xbox(put(value)));
    return value;
}
...
template <typename D> Windows::System::RemoteSystems::RemoteSystemKindFilter impl_IRemoteSystemKindFilterFactory<D>::Create(const Windows::Foundation::Collections::IIterable<hstring> & remoteSystemKinds) const
{
    ...
    check_hresult(shim()->abi_Create(get(remoteSystemKinds), put(result)));
    return result;
}
...
template <typename D> Windows::Foundation::Collections::IVectorView<hstring> impl_IRemoteSystemKindFilter<D>::RemoteSystemKinds() const
{
    ...
    check_hresult(shim()->get_RemoteSystemKinds(put(value)));
    return value;
}
...
template <typename D> Windows::System::RemoteSystems::RemoteSystemDiscoveryTypeFilter impl_IRemoteSystemDiscoveryTypeFilterFactory<D>::Create(Windows::System::RemoteSystems::RemoteSystemDiscoveryType discoveryType) const
{
    ...
    check_hresult(shim()->abi_Create(discoveryType, put(result)));
    return result;
}
...
template <typename D> Windows::System::RemoteSystems::RemoteSystemDiscoveryType impl_IRemoteSystemDiscoveryTypeFilter<D>::RemoteSystemDiscoveryType() const
{
    ...
    check_hresult(shim()->get_RemoteSystemDiscoveryType(&value));
    return value;
}
...
template <typename D> Windows::System::RemoteSystems::RemoteSystemStatusTypeFilter impl_IRemoteSystemStatusTypeFilterFactory<D>::Create(Windows::System::RemoteSystems::RemoteSystemStatusType remoteSystemStatusType) const
{
    ...
    check_hresult(shim()->abi_Create(remoteSystemStatusType, put(result)));
    return result;
}
...
template <typename D> Windows::System::RemoteSystems::RemoteSystemStatusType impl_IRemoteSystemStatusTypeFilter<D>::RemoteSystemStatusType() const
{
    ...
    check_hresult(shim()->get_RemoteSystemStatusType(&value));
    return value;
}
